import{d as f,c,r as u,n as M,o as i,a as K,t as T,b,w as m,T as cn,e as g,_ as y,u as $n,i as Un,f as Jn,g as un,h as S,j as p,k as s,l as $,m as Mn,p as N,q as Wn,s as pn,v as Bn,x as w,y as Y,z as O,A as mn,B as gn,C as G,D as Z,E as Cn,F as Dn,G as R,H,I as U,J as h,K as L,L as Hn,M as j,N as nn,O as fn,P as Gn,Q as zn,R as hn,S as _n,U as Xn,V as En,W as Vn,X as Qn,Y as Yn,Z as Zn,$ as Ln,a0 as ne,a1 as ee,a2 as te,a3 as oe,a4 as Tn}from"./framework.Dp-6g2cw.js";const re=f({__name:"VPBadge",props:{text:{},type:{default:"tip"}},setup(n){return(e,t)=>(i(),c("span",{class:M(["VPBadge",n.type])},[u(e.$slots,"default",{},()=>[K(T(n.text),1)])],2))}}),ie={key:0,class:"VPBackdrop"},le=f({__name:"VPBackdrop",props:{show:{type:Boolean}},setup(n){return(e,t)=>(i(),b(cn,{name:"fade"},{default:m(()=>[n.show?(i(),c("div",ie)):g("",!0)]),_:1}))}}),se=y(le,[["__scopeId","data-v-54a304ca"]]),k=$n;function ae(n,e){let t,o=!1;return()=>{t&&clearTimeout(t),o?t=setTimeout(n,e):(n(),(o=!0)&&setTimeout(()=>o=!1,e))}}function rn(n){return n.startsWith("/")?n:`/${n}`}function bn(n){const{pathname:e,search:t,hash:o,protocol:r}=new URL(n,"http://a.com");if(Un(n)||n.startsWith("#")||!r.startsWith("http")||!Jn(e))return n;const{site:l}=k(),d=e.endsWith("/")||e.endsWith(".html")?n:n.replace(/(?:(^\.+)\/)?.*$/,`$1${e.replace(/(\.md)?$/,l.value.cleanUrls?"":".html")}${t}${o}`);return un(d)}function z({correspondingLink:n=!1}={}){const{site:e,localeIndex:t,page:o,theme:r,hash:l}=k(),d=S(()=>({label:e.value.locales[t.value]?.label,link:e.value.locales[t.value]?.link||(t.value==="root"?"/":`/${t.value}/`)}));return{localeLinks:S(()=>Object.entries(e.value.locales).flatMap(([v,P])=>d.value.label===P.label?[]:{text:P.label,link:de(P.link||(v==="root"?"/":`/${v}/`),r.value.i18nRouting!==!1&&n,o.value.relativePath.slice(d.value.link.length-1),!e.value.cleanUrls)+l.value})),currentLang:d}}function de(n,e,t,o){return e?n.replace(/\/$/,"")+rn(t.replace(/(^|\/)index\.md$/,"$1").replace(/\.md$/,o?".html":"")):n}const ce={class:"NotFound"},ue={class:"code"},pe={class:"title"},me={class:"quote"},ge={class:"action"},fe=["href","aria-label"],he=f({__name:"NotFound",setup(n){const{theme:e}=k(),{currentLang:t}=z();return(o,r)=>(i(),c("div",ce,[p("p",ue,T(s(e).notFound?.code??"404"),1),p("h1",pe,T(s(e).notFound?.title??"PAGE NOT FOUND"),1),r[0]||(r[0]=p("div",{class:"divider"},null,-1)),p("blockquote",me,T(s(e).notFound?.quote??"But if you don't change your direction, and if you keep looking, you may end up where you are heading."),1),p("div",ge,[p("a",{class:"link",href:s(un)(s(e).notFound?.link??s(t).link),"aria-label":s(e).notFound?.linkLabel??"go to home"},T(s(e).notFound?.linkText??"Take me home"),9,fe)])]))}}),be=y(he,[["__scopeId","data-v-b0126292"]]);function An(n,e){if(Array.isArray(n))return X(n);if(n==null)return[];e=rn(e);const t=Object.keys(n).sort((r,l)=>l.split("/").length-r.split("/").length).find(r=>e.startsWith(rn(r))),o=t?n[t]:[];return Array.isArray(o)?X(o):X(o.items,o.base)}function ve(n){const e=[];let t=0;for(const o in n){const r=n[o];if(r.items){t=e.push(r);continue}e[t]||e.push({items:[]}),e[t].items.push(r)}return e}function ye(n){const e=[];function t(o){for(const r of o)r.text&&r.link&&e.push({text:r.text,link:r.link,docFooterText:r.docFooterText}),r.items&&t(r.items)}return t(n),e}function ln(n,e){return Array.isArray(e)?e.some(t=>ln(n,t)):$(n,e.link)?!0:e.items?ln(n,e.items):!1}function X(n,e){return[...n].map(t=>{const o={...t},r=o.base||e;return r&&o.link&&(o.link=r+o.link.replace(/^\//,r.endsWith("/")?"":"/")),o.items&&(o.items=X(o.items,r)),o})}function Se(){const{hasSidebar:n}=q(),e=Mn("(min-width: 960px)"),t=Mn("(min-width: 1280px)");return{isAsideEnabled:S(()=>!t.value&&!e.value?!1:n.value?t.value:e.value)}}const ke=/\b(?:VPBadge|header-anchor|footnote-ref|ignore-header)\b/,sn=[];function On(n){return typeof n.outline=="object"&&!Array.isArray(n.outline)&&n.outline.label||n.outlineTitle||"On this page"}function we(n){const e=[...document.querySelectorAll(".VPDoc :where(h1,h2,h3,h4,h5,h6)")].filter(t=>t.id&&t.hasChildNodes()).map(t=>{const o=Number(t.tagName[1]);return{element:t,title:Pe(t),link:"#"+t.id,level:o}});return Me(e,n)}function Pe(n){let e="";for(const t of n.childNodes)if(t.nodeType===1){if(ke.test(t.className))continue;e+=t.textContent}else t.nodeType===3&&(e+=t.textContent);return e.trim()}function Me(n,e){if(e===!1)return[];const t=(typeof e=="object"&&!Array.isArray(e)?e.level:e)||2,[o,r]=typeof t=="number"?[t,t]:t==="deep"?[2,6]:t;return xe(n,o,r)}function Ce(n,e){const{isAsideEnabled:t}=Se(),o=ae(l,100);let r=null;N(()=>{requestAnimationFrame(l),window.addEventListener("scroll",o)}),Wn(()=>{d(location.hash)}),pn(()=>{window.removeEventListener("scroll",o)});function l(){if(!t.value)return;const a=window.scrollY,v=window.innerHeight,P=document.body.offsetHeight,C=Math.abs(a+v-P)<1,x=sn.map(({element:_,link:I})=>({link:I,top:Te(_)})).filter(({top:_})=>!Number.isNaN(_)).sort((_,I)=>_.top-I.top);if(!x.length){d(null);return}if(a<1){d(null);return}if(C){d(x[x.length-1].link);return}let D=null;for(const{link:_,top:I}of x){if(I>a+Bn()+4)break;D=_}d(D)}function d(a){r&&r.classList.remove("active"),a==null?r=null:r=n.value.querySelector(`a[href="${decodeURIComponent(a)}"]`);const v=r;v?(v.classList.add("active"),e.value.style.top=v.offsetTop+39+"px",e.value.style.opacity="1"):(e.value.style.top="33px",e.value.style.opacity="0")}}function Te(n){let e=0;for(;n!==document.body;){if(n===null)return NaN;e+=n.offsetTop,n=n.offsetParent}return e}function xe(n,e,t){sn.length=0;const o=[],r=[];return n.forEach(l=>{const d={...l,children:[]};let a=r[r.length-1];for(;a&&a.level>=d.level;)r.pop(),a=r[r.length-1];if(d.element.classList.contains("ignore-header")||a&&"shouldIgnore"in a){r.push({level:d.level,shouldIgnore:!0});return}d.level>t||d.level<e||(sn.push({element:d.element,link:d.link}),a?a.children.push(d):o.push(d),r.push(d))}),o}const J=w(!1);function Re(n){let e;Y(()=>{e=J.value?document.activeElement:void 0}),N(()=>{window.addEventListener("keyup",t)}),pn(()=>{window.removeEventListener("keyup",t)});function t(o){o.key==="Escape"&&J.value&&(n(),e?.focus())}}function Ie(){function n(){J.value=!0}function e(){J.value=!1}function t(){J.value?e():n()}return{isOpen:J,open:n,close:e,toggle:t}}function De(n){const{page:e,hash:t}=k(),o=w(!1),r=S(()=>n.value.collapsed!=null),l=S(()=>!!n.value.link),d=w(!1),a=()=>{d.value=$(e.value.relativePath,n.value.link)};O([e,n,t],a),N(a);const v=S(()=>d.value?!0:n.value.items?ln(e.value.relativePath,n.value.items):!1),P=S(()=>!!(n.value.items&&n.value.items.length));Y(()=>{o.value=!!(r.value&&n.value.collapsed)}),mn(()=>{(d.value||v.value)&&(o.value=!1)});function C(){r.value&&(o.value=!o.value)}return{collapsed:o,collapsible:r,isLink:l,isActiveLink:d,hasActiveLink:v,hasChildren:P,toggle:C}}const an=gn([]),B=gn([]),dn=gn(!1);function q(){const{frontmatter:n,theme:e}=k(),t=S(()=>!!(n.value.isHome??n.value.layout==="home")),o=S(()=>n.value.sidebar!==!1&&B.value.length>0&&!t.value),r=S(()=>o.value&&dn.value),l=S(()=>o.value?ve(B.value):[]),d=S(()=>t.value?!1:n.value.aside!=null?!!n.value.aside:e.value.aside!==!1),a=S(()=>d.value?n.value.aside==null?e.value.aside==="left":n.value.aside==="left":!1),v=S(()=>an.value.length>0);return{isHome:t,sidebar:Cn(B),sidebarGroups:l,hasSidebar:o,isSidebarEnabled:r,hasAside:d,leftAside:a,headers:Cn(an),hasLocalNav:v}}function He({closeSidebar:n}){const{frontmatter:e,page:t,theme:o}=k();O(()=>[t.value.relativePath,o.value.sidebar],([l,d])=>{const a=d?An(d,l):[];JSON.stringify(a)!==JSON.stringify(B.value)&&(B.value=a)},{immediate:!0,deep:!0,flush:"sync"}),Dn(()=>{an.value=we(e.value.outline??o.value.outline)}),G&&(dn.value=window.innerWidth>=960,window.addEventListener("resize",()=>{dn.value=window.innerWidth>=960},{passive:!0}));const r=Z();O(()=>r.path,n),Re(n)}const Fn=Symbol("layout-info"),_e=["href","title"],Ee=f({__name:"VPDocOutlineItem",props:{headers:{},root:{type:Boolean}},setup(n){function e({target:t}){const o=t.href.split("#")[1];document.getElementById(decodeURIComponent(o))?.focus({preventScroll:!0})}return(t,o)=>{const r=U("VPDocOutlineItem",!0);return i(),c("ul",{class:M(["VPDocOutlineItem",n.root?"root":"nested"])},[(i(!0),c(R,null,H(n.headers,({children:l,link:d,title:a})=>(i(),c("li",null,[p("a",{class:"outline-link",href:d,onClick:e,title:a},T(a),9,_e),l?.length?(i(),b(r,{key:0,headers:l},null,8,["headers"])):g("",!0)]))),256))],2)}}}),qn=y(Ee,[["__scopeId","data-v-b7d7ef80"]]),Ve={class:"content"},Le={"aria-level":"2",class:"outline-title",id:"doc-outline-aria-label",role:"heading"},Ae=f({__name:"VPDocAsideOutline",setup(n){const{theme:e}=k(),t=w(),o=w(),{headers:r,hasLocalNav:l}=q();return Ce(t,o),(d,a)=>(i(),c("nav",{"aria-labelledby":"doc-outline-aria-label",class:M(["VPDocAsideOutline",{"has-outline":s(l)}]),ref_key:"container",ref:t},[p("div",Ve,[p("div",{class:"outline-marker",ref_key:"marker",ref:o},null,512),p("div",Le,T(s(On)(s(e))),1),h(qn,{headers:s(r),root:!0},null,8,["headers"])])],2))}}),Oe=y(Ae,[["__scopeId","data-v-c8b19031"]]),Fe={class:"VPDocAsideCarbonAds"},qe=f({__name:"VPDocAsideCarbonAds",props:{carbonAds:{}},setup(n){const e=()=>null;return(t,o)=>(i(),c("div",Fe,[h(s(e),{"carbon-ads":n.carbonAds},null,8,["carbon-ads"])]))}}),je={class:"VPDocAside"},Ke=f({__name:"VPDocAside",setup(n){const{theme:e}=k();return(t,o)=>(i(),c("div",je,[u(t.$slots,"aside-top",{},void 0,!0),u(t.$slots,"aside-outline-before",{},void 0,!0),h(Oe),u(t.$slots,"aside-outline-after",{},void 0,!0),o[0]||(o[0]=p("div",{class:"spacer"},null,-1)),u(t.$slots,"aside-ads-before",{},void 0,!0),s(e).carbonAds?(i(),b(qe,{key:0,"carbon-ads":s(e).carbonAds},null,8,["carbon-ads"])):g("",!0),u(t.$slots,"aside-ads-after",{},void 0,!0),u(t.$slots,"aside-bottom",{},void 0,!0)]))}}),Ne=y(Ke,[["__scopeId","data-v-cb998dce"]]);function $e(){const{theme:n,page:e}=k();return S(()=>{const{text:t="Edit this page",pattern:o=""}=n.value.editLink||{};let r;return typeof o=="function"?r=o(e.value):r=o.replace(/:path/g,e.value.filePath),{url:r,text:t}})}function Ue(){const{page:n,theme:e,frontmatter:t}=k();return S(()=>{const o=An(e.value.sidebar,n.value.relativePath),r=ye(o),l=Je(r,P=>P.link.replace(/[?#].*$/,"")),d=l.findIndex(P=>$(n.value.relativePath,P.link)),a=e.value.docFooter?.prev===!1&&!t.value.prev||t.value.prev===!1,v=e.value.docFooter?.next===!1&&!t.value.next||t.value.next===!1;return{prev:a?void 0:{text:(typeof t.value.prev=="string"?t.value.prev:typeof t.value.prev=="object"?t.value.prev.text:void 0)??l[d-1]?.docFooterText??l[d-1]?.text,link:(typeof t.value.prev=="object"?t.value.prev.link:void 0)??l[d-1]?.link},next:v?void 0:{text:(typeof t.value.next=="string"?t.value.next:typeof t.value.next=="object"?t.value.next.text:void 0)??l[d+1]?.docFooterText??l[d+1]?.text,link:(typeof t.value.next=="object"?t.value.next.link:void 0)??l[d+1]?.link}}})}function Je(n,e){const t=new Set;return n.filter(o=>{const r=e(o);return t.has(r)?!1:t.add(r)})}const A=f({__name:"VPLink",props:{tag:{},href:{},noIcon:{type:Boolean},target:{},rel:{}},setup(n){const e=n,t=S(()=>e.tag??(e.href?"a":"span")),o=S(()=>e.href&&Hn.test(e.href)||e.target==="_blank");return(r,l)=>(i(),b(L(t.value),{class:M(["VPLink",{link:n.href,"vp-external-link-icon":o.value,"no-icon":n.noIcon}]),href:n.href?s(bn)(n.href):void 0,target:n.target??(o.value?"_blank":void 0),rel:n.rel??(o.value?"noreferrer":void 0)},{default:m(()=>[u(r.$slots,"default")]),_:3},8,["class","href","target","rel"]))}}),We={class:"VPLastUpdated"},Be=["datetime"],Ge=f({__name:"VPDocFooterLastUpdated",setup(n){const{theme:e,page:t,lang:o}=k(),r=S(()=>new Date(t.value.lastUpdated)),l=S(()=>r.value.toISOString()),d=w("");return N(()=>{Y(()=>{d.value=new Intl.DateTimeFormat(e.value.lastUpdated?.formatOptions?.forceLocale?o.value:void 0,e.value.lastUpdated?.formatOptions??{dateStyle:"short",timeStyle:"short"}).format(r.value)})}),(a,v)=>(i(),c("p",We,[K(T(s(e).lastUpdated?.text||s(e).lastUpdatedText||"Last updated")+": ",1),p("time",{datetime:l.value},T(d.value),9,Be)]))}}),ze=y(Ge,[["__scopeId","data-v-1bb0c8a8"]]),Xe={key:0,class:"VPDocFooter"},Qe={key:0,class:"edit-info"},Ye={key:0,class:"edit-link"},Ze={key:1,class:"last-updated"},nt={key:1,class:"prev-next","aria-labelledby":"doc-footer-aria-label"},et={class:"pager"},tt=["innerHTML"],ot=["innerHTML"],rt={class:"pager"},it=["innerHTML"],lt=["innerHTML"],st=f({__name:"VPDocFooter",setup(n){const{theme:e,page:t,frontmatter:o}=k(),r=$e(),l=Ue(),d=S(()=>e.value.editLink&&o.value.editLink!==!1),a=S(()=>t.value.lastUpdated),v=S(()=>d.value||a.value||l.value.prev||l.value.next);return(P,C)=>v.value?(i(),c("footer",Xe,[u(P.$slots,"doc-footer-before",{},void 0,!0),d.value||a.value?(i(),c("div",Qe,[d.value?(i(),c("div",Ye,[h(A,{class:"edit-link-button",href:s(r).url,"no-icon":!0},{default:m(()=>[C[0]||(C[0]=p("span",{class:"vpi-square-pen edit-link-icon"},null,-1)),K(" "+T(s(r).text),1)]),_:1},8,["href"])])):g("",!0),a.value?(i(),c("div",Ze,[h(ze)])):g("",!0)])):g("",!0),s(l).prev?.link||s(l).next?.link?(i(),c("nav",nt,[C[1]||(C[1]=p("span",{class:"visually-hidden",id:"doc-footer-aria-label"},"Pager",-1)),p("div",et,[s(l).prev?.link?(i(),b(A,{key:0,class:"pager-link prev",href:s(l).prev.link},{default:m(()=>[p("span",{class:"desc",innerHTML:s(e).docFooter?.prev||"Previous page"},null,8,tt),p("span",{class:"title",innerHTML:s(l).prev.text},null,8,ot)]),_:1},8,["href"])):g("",!0)]),p("div",rt,[s(l).next?.link?(i(),b(A,{key:0,class:"pager-link next",href:s(l).next.link},{default:m(()=>[p("span",{class:"desc",innerHTML:s(e).docFooter?.next||"Next page"},null,8,it),p("span",{class:"title",innerHTML:s(l).next.text},null,8,lt)]),_:1},8,["href"])):g("",!0)])])):g("",!0)])):g("",!0)}}),at=y(st,[["__scopeId","data-v-1bcd8184"]]),dt={class:"container"},ct={class:"aside-container"},ut={class:"aside-content"},pt={class:"content"},mt={class:"content-container"},gt={class:"main"},ft=f({__name:"VPDoc",setup(n){const{theme:e}=k(),t=Z(),{hasSidebar:o,hasAside:r,leftAside:l}=q(),d=S(()=>t.path.replace(/[./]+/g,"_").replace(/_html$/,""));return(a,v)=>{const P=U("Content");return i(),c("div",{class:M(["VPDoc",{"has-sidebar":s(o),"has-aside":s(r)}])},[u(a.$slots,"doc-top",{},void 0,!0),p("div",dt,[s(r)?(i(),c("div",{key:0,class:M(["aside",{"left-aside":s(l)}])},[v[0]||(v[0]=p("div",{class:"aside-curtain"},null,-1)),p("div",ct,[p("div",ut,[h(Ne,null,{"aside-top":m(()=>[u(a.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":m(()=>[u(a.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":m(()=>[u(a.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":m(()=>[u(a.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":m(()=>[u(a.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":m(()=>[u(a.$slots,"aside-ads-after",{},void 0,!0)]),_:3})])])],2)):g("",!0),p("div",pt,[p("div",mt,[u(a.$slots,"doc-before",{},void 0,!0),p("main",gt,[h(P,{class:M(["vp-doc",[d.value,s(e).externalLinkIcon&&"external-link-icon-enabled"]])},null,8,["class"])]),h(at,null,{"doc-footer-before":m(()=>[u(a.$slots,"doc-footer-before",{},void 0,!0)]),_:3}),u(a.$slots,"doc-after",{},void 0,!0)])])]),u(a.$slots,"doc-bottom",{},void 0,!0)],2)}}}),ht=y(ft,[["__scopeId","data-v-d668f7cc"]]),bt=f({__name:"VPButton",props:{tag:{},size:{default:"medium"},theme:{default:"brand"},text:{},href:{},target:{},rel:{}},setup(n){const e=n,t=S(()=>e.href&&Hn.test(e.href)),o=S(()=>e.tag||(e.href?"a":"button"));return(r,l)=>(i(),b(L(o.value),{class:M(["VPButton",[n.size,n.theme]]),href:n.href?s(bn)(n.href):void 0,target:e.target??(t.value?"_blank":void 0),rel:e.rel??(t.value?"noreferrer":void 0)},{default:m(()=>[u(r.$slots,"default",{},()=>[K(T(n.text),1)],!0)]),_:3},8,["class","href","target","rel"]))}}),vt=y(bt,[["__scopeId","data-v-58d3b43b"]]),yt=["src","alt"],St=f({inheritAttrs:!1,__name:"VPImage",props:{image:{},alt:{}},setup(n){return(e,t)=>{const o=U("VPImage",!0);return n.image?(i(),c(R,{key:0},[typeof n.image=="string"||"src"in n.image?(i(),c("img",j({key:0,class:"VPImage"},typeof n.image=="string"?e.$attrs:{...n.image,...e.$attrs},{src:s(un)(typeof n.image=="string"?n.image:n.image.src),alt:n.alt??(typeof n.image=="string"?"":n.image.alt||"")}),null,16,yt)):(i(),c(R,{key:1},[h(o,j({class:"dark",image:n.image.dark,alt:n.image.alt},e.$attrs),null,16,["image","alt"]),h(o,j({class:"light",image:n.image.light,alt:n.image.alt},e.$attrs),null,16,["image","alt"])],64))],64)):g("",!0)}}}),Q=y(St,[["__scopeId","data-v-ab19afbb"]]),kt={class:"container"},wt={class:"main"},Pt={class:"heading"},Mt=["innerHTML"],Ct=["innerHTML"],Tt=["innerHTML"],xt={key:0,class:"actions"},Rt={key:0,class:"image"},It={class:"image-container"},Dt=f({__name:"VPHero",props:{name:{},text:{},tagline:{},image:{},actions:{}},setup(n){const{heroImageSlotExists:e}=nn(Fn);return(t,o)=>(i(),c("div",{class:M(["VPHero",{"has-image":n.image||s(e)}])},[p("div",kt,[p("div",wt,[u(t.$slots,"home-hero-info-before",{},void 0,!0),u(t.$slots,"home-hero-info",{},()=>[p("h1",Pt,[n.name?(i(),c("span",{key:0,innerHTML:n.name,class:"name clip"},null,8,Mt)):g("",!0),n.text?(i(),c("span",{key:1,innerHTML:n.text,class:"text"},null,8,Ct)):g("",!0)]),n.tagline?(i(),c("p",{key:0,innerHTML:n.tagline,class:"tagline"},null,8,Tt)):g("",!0)],!0),u(t.$slots,"home-hero-info-after",{},void 0,!0),n.actions?(i(),c("div",xt,[(i(!0),c(R,null,H(n.actions,r=>(i(),c("div",{key:r.link,class:"action"},[h(vt,{tag:"a",size:"medium",theme:r.theme,text:r.text,href:r.link,target:r.target,rel:r.rel},null,8,["theme","text","href","target","rel"])]))),128))])):g("",!0),u(t.$slots,"home-hero-actions-after",{},void 0,!0)]),n.image||s(e)?(i(),c("div",Rt,[p("div",It,[o[0]||(o[0]=p("div",{class:"image-bg"},null,-1)),u(t.$slots,"home-hero-image",{},()=>[n.image?(i(),b(Q,{key:0,class:"image-src",image:n.image},null,8,["image"])):g("",!0)],!0)])])):g("",!0)])],2))}}),Ht=y(Dt,[["__scopeId","data-v-a4190d00"]]),_t=f({__name:"VPHomeHero",setup(n){const{frontmatter:e}=k();return(t,o)=>s(e).hero?(i(),b(Ht,{key:0,class:"VPHomeHero",name:s(e).hero.name,text:s(e).hero.text,tagline:s(e).hero.tagline,image:s(e).hero.image,actions:s(e).hero.actions},{"home-hero-info-before":m(()=>[u(t.$slots,"home-hero-info-before")]),"home-hero-info":m(()=>[u(t.$slots,"home-hero-info")]),"home-hero-info-after":m(()=>[u(t.$slots,"home-hero-info-after")]),"home-hero-actions-after":m(()=>[u(t.$slots,"home-hero-actions-after")]),"home-hero-image":m(()=>[u(t.$slots,"home-hero-image")]),_:3},8,["name","text","tagline","image","actions"])):g("",!0)}}),Et={class:"box"},Vt={key:0,class:"icon"},Lt=["innerHTML"],At=["innerHTML"],Ot=["innerHTML"],Ft={key:4,class:"link-text"},qt={class:"link-text-value"},jt=f({__name:"VPFeature",props:{icon:{},title:{},details:{},link:{},linkText:{},rel:{},target:{}},setup(n){return(e,t)=>(i(),b(A,{class:"VPFeature",href:n.link,rel:n.rel,target:n.target,"no-icon":!0,tag:n.link?"a":"div"},{default:m(()=>[p("article",Et,[typeof n.icon=="object"&&n.icon.wrap?(i(),c("div",Vt,[h(Q,{image:n.icon,alt:n.icon.alt,height:n.icon.height||48,width:n.icon.width||48},null,8,["image","alt","height","width"])])):typeof n.icon=="object"?(i(),b(Q,{key:1,image:n.icon,alt:n.icon.alt,height:n.icon.height||48,width:n.icon.width||48},null,8,["image","alt","height","width"])):n.icon?(i(),c("div",{key:2,class:"icon",innerHTML:n.icon},null,8,Lt)):g("",!0),p("h2",{class:"title",innerHTML:n.title},null,8,At),n.details?(i(),c("p",{key:3,class:"details",innerHTML:n.details},null,8,Ot)):g("",!0),n.linkText?(i(),c("div",Ft,[p("p",qt,[K(T(n.linkText)+" ",1),t[0]||(t[0]=p("span",{class:"vpi-arrow-right link-text-icon"},null,-1))])])):g("",!0)])]),_:1},8,["href","rel","target","tag"]))}}),Kt=y(jt,[["__scopeId","data-v-02d1074d"]]),Nt={key:0,class:"VPFeatures"},$t={class:"container"},Ut={class:"items"},Jt=f({__name:"VPFeatures",props:{features:{}},setup(n){const e=n,t=S(()=>{const o=e.features.length;if(o){if(o===2)return"grid-2";if(o===3)return"grid-3";if(o%3===0)return"grid-6";if(o>3)return"grid-4"}else return});return(o,r)=>n.features?(i(),c("div",Nt,[p("div",$t,[p("div",Ut,[(i(!0),c(R,null,H(n.features,l=>(i(),c("div",{key:l.title,class:M(["item",[t.value]])},[h(Kt,{icon:l.icon,title:l.title,details:l.details,link:l.link,"link-text":l.linkText,rel:l.rel,target:l.target},null,8,["icon","title","details","link","link-text","rel","target"])],2))),128))])])])):g("",!0)}}),Wt=y(Jt,[["__scopeId","data-v-b1eea84a"]]),Bt=f({__name:"VPHomeFeatures",setup(n){const{frontmatter:e}=k();return(t,o)=>s(e).features?(i(),b(Wt,{key:0,class:"VPHomeFeatures",features:s(e).features},null,8,["features"])):g("",!0)}}),Gt=f({__name:"VPHomeContent",setup(n){const{width:e}=Gn({initialWidth:0,includeScrollbar:!1});return(t,o)=>(i(),c("div",{class:"vp-doc container",style:fn(s(e)?{"--vp-offset":`calc(50% - ${s(e)/2}px)`}:{})},[u(t.$slots,"default",{},void 0,!0)],4))}}),zt=y(Gt,[["__scopeId","data-v-c141a4bd"]]),Xt=f({__name:"VPHome",setup(n){const{frontmatter:e,theme:t}=k();return(o,r)=>{const l=U("Content");return i(),c("div",{class:M(["VPHome",{"external-link-icon-enabled":s(t).externalLinkIcon}])},[u(o.$slots,"home-hero-before",{},void 0,!0),h(_t,null,{"home-hero-info-before":m(()=>[u(o.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":m(()=>[u(o.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":m(()=>[u(o.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":m(()=>[u(o.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":m(()=>[u(o.$slots,"home-hero-image",{},void 0,!0)]),_:3}),u(o.$slots,"home-hero-after",{},void 0,!0),u(o.$slots,"home-features-before",{},void 0,!0),h(Bt),u(o.$slots,"home-features-after",{},void 0,!0),s(e).markdownStyles!==!1?(i(),b(zt,{key:0},{default:m(()=>[h(l)]),_:1})):(i(),b(l,{key:1}))],2)}}}),Qt=y(Xt,[["__scopeId","data-v-e07eaea7"]]),Yt={},Zt={class:"VPPage"};function no(n,e){const t=U("Content");return i(),c("div",Zt,[u(n.$slots,"page-top"),h(t),u(n.$slots,"page-bottom")])}const eo=y(Yt,[["render",no]]),to=f({__name:"VPContent",setup(n){const{page:e,frontmatter:t}=k(),{isHome:o,hasSidebar:r}=q();return(l,d)=>(i(),c("div",{class:M(["VPContent",{"has-sidebar":s(r),"is-home":s(o)}]),id:"VPContent"},[s(e).isNotFound?u(l.$slots,"not-found",{key:0},()=>[h(be)],!0):s(t).layout==="page"?(i(),b(eo,{key:1},{"page-top":m(()=>[u(l.$slots,"page-top",{},void 0,!0)]),"page-bottom":m(()=>[u(l.$slots,"page-bottom",{},void 0,!0)]),_:3})):s(t).layout==="home"?(i(),b(Qt,{key:2},{"home-hero-before":m(()=>[u(l.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":m(()=>[u(l.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":m(()=>[u(l.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":m(()=>[u(l.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":m(()=>[u(l.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":m(()=>[u(l.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":m(()=>[u(l.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":m(()=>[u(l.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":m(()=>[u(l.$slots,"home-features-after",{},void 0,!0)]),_:3})):s(t).layout&&s(t).layout!=="doc"?(i(),b(L(s(t).layout),{key:3})):(i(),b(ht,{key:4},{"doc-top":m(()=>[u(l.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":m(()=>[u(l.$slots,"doc-bottom",{},void 0,!0)]),"doc-footer-before":m(()=>[u(l.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":m(()=>[u(l.$slots,"doc-before",{},void 0,!0)]),"doc-after":m(()=>[u(l.$slots,"doc-after",{},void 0,!0)]),"aside-top":m(()=>[u(l.$slots,"aside-top",{},void 0,!0)]),"aside-outline-before":m(()=>[u(l.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":m(()=>[u(l.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":m(()=>[u(l.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":m(()=>[u(l.$slots,"aside-ads-after",{},void 0,!0)]),"aside-bottom":m(()=>[u(l.$slots,"aside-bottom",{},void 0,!0)]),_:3}))],2))}}),oo=y(to,[["__scopeId","data-v-2652e39a"]]),ro={class:"container"},io=["innerHTML"],lo=["innerHTML"],so=f({__name:"VPFooter",setup(n){const{theme:e,frontmatter:t}=k(),{hasSidebar:o}=q();return(r,l)=>s(e).footer&&s(t).footer!==!1?(i(),c("footer",{key:0,class:M(["VPFooter",{"has-sidebar":s(o)}])},[p("div",ro,[s(e).footer.message?(i(),c("p",{key:0,class:"message",innerHTML:s(e).footer.message},null,8,io)):g("",!0),s(e).footer.copyright?(i(),c("p",{key:1,class:"copyright",innerHTML:s(e).footer.copyright},null,8,lo)):g("",!0)])],2)):g("",!0)}}),ao=y(so,[["__scopeId","data-v-5b9946f5"]]),co={class:"menu-text"},uo={class:"header"},po={class:"outline"},mo=f({__name:"VPLocalNavOutlineDropdown",props:{headers:{},navHeight:{}},setup(n){const e=n,{theme:t}=k(),o=w(!1),r=w(0),l=w(),d=w();function a(x){l.value?.contains(x.target)||(o.value=!1)}O(o,x=>{if(x){document.addEventListener("click",a);return}document.removeEventListener("click",a)}),zn("Escape",()=>{o.value=!1}),Dn(()=>{o.value=!1});function v(){o.value=!o.value,r.value=window.innerHeight+Math.min(window.scrollY-e.navHeight,0)}function P(x){x.target.classList.contains("outline-link")&&(d.value&&(d.value.style.transition="none"),hn(()=>{o.value=!1}))}function C(){o.value=!1,window.scrollTo({top:0,left:0,behavior:"smooth"})}return(x,D)=>(i(),c("div",{class:"VPLocalNavOutlineDropdown",style:fn({"--vp-vh":r.value+"px"}),ref_key:"main",ref:l},[n.headers.length>0?(i(),c("button",{key:0,onClick:v,class:M({open:o.value})},[p("span",co,T(s(On)(s(t))),1),D[0]||(D[0]=p("span",{class:"vpi-chevron-right icon"},null,-1))],2)):(i(),c("button",{key:1,onClick:C},T(s(t).returnToTopLabel||"Return to top"),1)),h(cn,{name:"flyout"},{default:m(()=>[o.value?(i(),c("div",{key:0,ref_key:"items",ref:d,class:"items",onClick:P},[p("div",uo,[p("a",{class:"top-link",href:"#",onClick:C},T(s(t).returnToTopLabel||"Return to top"),1)]),p("div",po,[h(qn,{headers:n.headers},null,8,["headers"])])],512)):g("",!0)]),_:1})],4))}}),go=y(mo,[["__scopeId","data-v-e28a51a6"]]),fo={class:"container"},ho=["aria-expanded"],bo={class:"menu-text"},vo=f({__name:"VPLocalNav",props:{open:{type:Boolean}},emits:["open-menu"],setup(n){const{theme:e}=k(),{isHome:t,hasSidebar:o,headers:r,hasLocalNav:l}=q(),{y:d}=_n(),a=w(0);N(()=>{a.value=parseInt(getComputedStyle(document.documentElement).getPropertyValue("--vp-nav-height"))});const v=S(()=>({VPLocalNav:!0,"has-sidebar":o.value,empty:!l.value,fixed:!l.value&&!o.value}));return(P,C)=>!s(t)&&(s(l)||s(o)||s(d)>=a.value)?(i(),c("div",{key:0,class:M(v.value)},[p("div",fo,[s(o)?(i(),c("button",{key:0,class:"menu","aria-expanded":n.open,"aria-controls":"VPSidebarNav",onClick:C[0]||(C[0]=x=>P.$emit("open-menu"))},[C[1]||(C[1]=p("span",{class:"vpi-align-left menu-icon"},null,-1)),p("span",bo,T(s(e).sidebarMenuLabel||"Menu"),1)],8,ho)):g("",!0),h(go,{headers:s(r),navHeight:a.value},null,8,["headers","navHeight"])])],2)):g("",!0)}}),yo=y(vo,[["__scopeId","data-v-5ae341c6"]]);function So(){const n=w(!1);function e(){n.value=!0,window.addEventListener("resize",r)}function t(){n.value=!1,window.removeEventListener("resize",r)}function o(){n.value?t():e()}function r(){window.outerWidth>=768&&t()}const l=Z();return O(()=>l.path,t),{isScreenOpen:n,openScreen:e,closeScreen:t,toggleScreen:o}}const vn=Symbol("nav"),ko={},wo={class:"VPSwitch",type:"button",role:"switch"},Po={class:"check"},Mo={key:0,class:"icon"};function Co(n,e){return i(),c("button",wo,[p("span",Po,[n.$slots.default?(i(),c("span",Mo,[u(n.$slots,"default",{},void 0,!0)])):g("",!0)])])}const To=y(ko,[["render",Co],["__scopeId","data-v-b4ccac88"]]),xo=f({__name:"VPSwitchAppearance",setup(n){const{isDark:e,theme:t}=k(),o=nn("toggle-appearance",()=>{e.value=!e.value}),r=w("");return mn(()=>{r.value=e.value?t.value.lightModeSwitchTitle||"Switch to light theme":t.value.darkModeSwitchTitle||"Switch to dark theme"}),(l,d)=>(i(),b(To,{title:r.value,class:"VPSwitchAppearance","aria-checked":s(e),onClick:s(o)},{default:m(()=>[...d[0]||(d[0]=[p("span",{class:"vpi-sun sun"},null,-1),p("span",{class:"vpi-moon moon"},null,-1)])]),_:1},8,["title","aria-checked","onClick"]))}}),yn=y(xo,[["__scopeId","data-v-be9742d9"]]),Ro={key:0,class:"VPNavBarAppearance"},Io=f({__name:"VPNavBarAppearance",setup(n){const{site:e}=k();return(t,o)=>s(e).appearance&&s(e).appearance!=="force-dark"&&s(e).appearance!=="force-auto"?(i(),c("div",Ro,[h(yn)])):g("",!0)}}),Do=y(Io,[["__scopeId","data-v-3f90c1a5"]]),Sn=w();let jn=!1,tn=0;function Ho(n){const e=w(!1);if(G){!jn&&_o(),tn++;const t=O(Sn,o=>{o===n.el.value||n.el.value?.contains(o)?(e.value=!0,n.onFocus?.()):(e.value=!1,n.onBlur?.())});pn(()=>{t(),tn--,tn||Eo()})}return Xn(e)}function _o(){document.addEventListener("focusin",Kn),jn=!0,Sn.value=document.activeElement}function Eo(){document.removeEventListener("focusin",Kn)}function Kn(){Sn.value=document.activeElement}const Vo={class:"VPMenuLink"},Lo=["innerHTML"],Ao=f({__name:"VPMenuLink",props:{item:{}},setup(n){const{page:e}=k();return(t,o)=>(i(),c("div",Vo,[h(A,{class:M({active:s($)(s(e).relativePath,n.item.activeMatch||n.item.link,!!n.item.activeMatch)}),href:n.item.link,target:n.item.target,rel:n.item.rel,"no-icon":n.item.noIcon},{default:m(()=>[p("span",{innerHTML:n.item.text},null,8,Lo)]),_:1},8,["class","href","target","rel","no-icon"])]))}}),en=y(Ao,[["__scopeId","data-v-f2aefde6"]]),Oo={class:"VPMenuGroup"},Fo={key:0,class:"title"},qo=f({__name:"VPMenuGroup",props:{text:{},items:{}},setup(n){return(e,t)=>(i(),c("div",Oo,[n.text?(i(),c("p",Fo,T(n.text),1)):g("",!0),(i(!0),c(R,null,H(n.items,o=>(i(),c(R,{key:JSON.stringify(o)},["link"in o?(i(),b(en,{key:0,item:o},null,8,["item"])):g("",!0)],64))),128))]))}}),jo=y(qo,[["__scopeId","data-v-5474bd6a"]]),Ko={class:"VPMenu"},No={key:0,class:"items"},$o=f({__name:"VPMenu",props:{items:{}},setup(n){return(e,t)=>(i(),c("div",Ko,[n.items?(i(),c("div",No,[(i(!0),c(R,null,H(n.items,o=>(i(),c(R,{key:JSON.stringify(o)},["link"in o?(i(),b(en,{key:0,item:o},null,8,["item"])):"component"in o?(i(),b(L(o.component),j({key:1,ref_for:!0},o.props),null,16)):(i(),b(jo,{key:2,text:o.text,items:o.items},null,8,["text","items"]))],64))),128))])):g("",!0),u(e.$slots,"default",{},void 0,!0)]))}}),Uo=y($o,[["__scopeId","data-v-fcd1d7a8"]]),Jo=["aria-expanded","aria-label"],Wo={key:0,class:"text"},Bo=["innerHTML"],Go={key:1,class:"vpi-more-horizontal icon"},zo={class:"menu"},Xo=f({__name:"VPFlyout",props:{icon:{},button:{},label:{},items:{}},setup(n){const e=w(!1),t=w();Ho({el:t,onBlur:o});function o(){e.value=!1}return(r,l)=>(i(),c("div",{class:"VPFlyout",ref_key:"el",ref:t,onMouseenter:l[1]||(l[1]=d=>e.value=!0),onMouseleave:l[2]||(l[2]=d=>e.value=!1)},[p("button",{type:"button",class:"button","aria-haspopup":"true","aria-expanded":e.value,"aria-label":n.label,onClick:l[0]||(l[0]=d=>e.value=!e.value)},[n.button||n.icon?(i(),c("span",Wo,[n.icon?(i(),c("span",{key:0,class:M([n.icon,"option-icon"])},null,2)):g("",!0),n.button?(i(),c("span",{key:1,innerHTML:n.button},null,8,Bo)):g("",!0),l[3]||(l[3]=p("span",{class:"vpi-chevron-down text-icon"},null,-1))])):(i(),c("span",Go))],8,Jo),p("div",zo,[h(Uo,{items:n.items},{default:m(()=>[u(r.$slots,"default",{},void 0,!0)]),_:3},8,["items"])])],544))}}),kn=y(Xo,[["__scopeId","data-v-d8fae6e2"]]),Qo=["href","aria-label","rel","innerHTML"],Yo=f({__name:"VPSocialLink",props:{icon:{},link:{},ariaLabel:{},me:{type:Boolean}},setup(n){const e=n,t=w();N(async()=>{await hn();const r=t.value?.children[0];r instanceof HTMLElement&&r.className.startsWith("vpi-social-")&&(getComputedStyle(r).maskImage||getComputedStyle(r).webkitMaskImage)==="none"&&r.style.setProperty("--icon",`url('https://api.iconify.design/simple-icons/${e.icon}.svg')`)});const o=S(()=>typeof e.icon=="object"?e.icon.svg:`<span class="vpi-social-${e.icon}"></span>`);return(r,l)=>(i(),c("a",{ref_key:"el",ref:t,class:"VPSocialLink no-icon",href:n.link,"aria-label":n.ariaLabel??(typeof n.icon=="string"?n.icon:""),target:"_blank",rel:n.me?"me noopener":"noopener",innerHTML:o.value},null,8,Qo))}}),Zo=y(Yo,[["__scopeId","data-v-32d78712"]]),nr={class:"VPSocialLinks"},er=f({__name:"VPSocialLinks",props:{links:{},me:{type:Boolean,default:!0}},setup(n){return(e,t)=>(i(),c("div",nr,[(i(!0),c(R,null,H(n.links,({link:o,icon:r,ariaLabel:l})=>(i(),b(Zo,{key:o,icon:r,link:o,ariaLabel:l,me:n.me},null,8,["icon","link","ariaLabel","me"]))),128))]))}}),wn=y(er,[["__scopeId","data-v-a1a7286e"]]),tr={key:0,class:"group translations"},or={class:"trans-title"},rr={key:1,class:"group"},ir={class:"item appearance"},lr={class:"label"},sr={class:"appearance-action"},ar={key:2,class:"group"},dr={class:"item social-links"},cr=f({__name:"VPNavBarExtra",setup(n){const{site:e,theme:t}=k(),{localeLinks:o,currentLang:r}=z({correspondingLink:!0}),l=S(()=>o.value.length&&r.value.label||e.value.appearance||t.value.socialLinks);return(d,a)=>l.value?(i(),b(kn,{key:0,class:"VPNavBarExtra",label:"extra navigation"},{default:m(()=>[s(o).length&&s(r).label?(i(),c("div",tr,[p("p",or,T(s(r).label),1),(i(!0),c(R,null,H(s(o),v=>(i(),b(en,{key:v.link,item:v},null,8,["item"]))),128))])):g("",!0),s(e).appearance&&s(e).appearance!=="force-dark"&&s(e).appearance!=="force-auto"?(i(),c("div",rr,[p("div",ir,[p("p",lr,T(s(t).darkModeSwitchLabel||"Appearance"),1),p("div",sr,[h(yn)])])])):g("",!0),s(t).socialLinks?(i(),c("div",ar,[p("div",dr,[h(wn,{class:"social-links-list",links:s(t).socialLinks},null,8,["links"])])])):g("",!0)]),_:1})):g("",!0)}}),ur=y(cr,[["__scopeId","data-v-f953d92f"]]),pr=["aria-expanded"],mr=f({__name:"VPNavBarHamburger",props:{active:{type:Boolean}},emits:["click"],setup(n){return(e,t)=>(i(),c("button",{type:"button",class:M(["VPNavBarHamburger",{active:n.active}]),"aria-label":"mobile navigation","aria-expanded":n.active,"aria-controls":"VPNavScreen",onClick:t[0]||(t[0]=o=>e.$emit("click"))},[...t[1]||(t[1]=[p("span",{class:"container"},[p("span",{class:"top"}),p("span",{class:"middle"}),p("span",{class:"bottom"})],-1)])],10,pr))}}),gr=y(mr,[["__scopeId","data-v-6bee1efd"]]),fr=["innerHTML"],hr=f({__name:"VPNavBarMenuLink",props:{item:{}},setup(n){const{page:e}=k();return(t,o)=>(i(),b(A,{class:M({VPNavBarMenuLink:!0,active:s($)(s(e).relativePath,n.item.activeMatch||n.item.link,!!n.item.activeMatch)}),href:n.item.link,target:n.item.target,rel:n.item.rel,"no-icon":n.item.noIcon,tabindex:"0"},{default:m(()=>[p("span",{innerHTML:n.item.text},null,8,fr)]),_:1},8,["class","href","target","rel","no-icon"]))}}),br=y(hr,[["__scopeId","data-v-815115f5"]]),vr=f({__name:"VPNavBarMenuGroup",props:{item:{}},setup(n){const e=n,{page:t}=k(),o=l=>"component"in l?!1:"link"in l?$(t.value.relativePath,l.link,!!e.item.activeMatch):l.items.some(o),r=S(()=>o(e.item));return(l,d)=>(i(),b(kn,{class:M({VPNavBarMenuGroup:!0,active:s($)(s(t).relativePath,n.item.activeMatch,!!n.item.activeMatch)||r.value}),button:n.item.text,items:n.item.items},null,8,["class","button","items"]))}}),yr={key:0,"aria-labelledby":"main-nav-aria-label",class:"VPNavBarMenu"},Sr=f({__name:"VPNavBarMenu",setup(n){const{theme:e}=k();return(t,o)=>s(e).nav?(i(),c("nav",yr,[o[0]||(o[0]=p("span",{id:"main-nav-aria-label",class:"visually-hidden"}," Main Navigation ",-1)),(i(!0),c(R,null,H(s(e).nav,r=>(i(),c(R,{key:JSON.stringify(r)},["link"in r?(i(),b(br,{key:0,item:r},null,8,["item"])):"component"in r?(i(),b(L(r.component),j({key:1,ref_for:!0},r.props),null,16)):(i(),b(vr,{key:2,item:r},null,8,["item"]))],64))),128))])):g("",!0)}}),kr=y(Sr,[["__scopeId","data-v-020be4db"]]);function wr(n){const{localeIndex:e,theme:t}=k();function o(r){const l=r.split("."),d=t.value.search?.options,a=d&&typeof d=="object",v=a&&d.locales?.[e.value]?.translations||null,P=a&&d.translations||null;let C=v,x=P,D=n;const _=l.pop();for(const I of l){let E=null;const F=D?.[I];F&&(E=D=F);const V=x?.[I];V&&(E=x=V);const W=C?.[I];W&&(E=C=W),F||(D=E),V||(x=E),W||(C=E)}return C?.[_]??x?.[_]??D?.[_]??""}return o}const Pr=["aria-label"],Mr={class:"DocSearch-Button-Container"},Cr={class:"DocSearch-Button-Placeholder"},xn=f({__name:"VPNavBarSearchButton",setup(n){const t=wr({button:{buttonText:"Search",buttonAriaLabel:"Search"}});return(o,r)=>(i(),c("button",{type:"button","aria-label":s(t)("button.buttonAriaLabel"),"aria-keyshortcuts":"/ control+k meta+k",class:"DocSearch DocSearch-Button"},[p("span",Mr,[r[0]||(r[0]=p("span",{class:"vpi-search DocSearch-Search-Icon"},null,-1)),p("span",Cr,T(s(t)("button.buttonText")),1)]),r[1]||(r[1]=p("span",{class:"DocSearch-Button-Keys"},[p("kbd",{class:"DocSearch-Button-Key"}),p("kbd",{class:"DocSearch-Button-Key"})],-1))],8,Pr))}}),Tr={class:"VPNavBarSearch"},xr={id:"local-search"},Rr={key:1,id:"docsearch"},Ir=f({__name:"VPNavBarSearch",setup(n){const e=()=>null,t=()=>null,{theme:o}=k(),r=w(!1),l=w(!1);N(()=>{});function d(){r.value||(r.value=!0,setTimeout(a,16))}function a(){const C=new Event("keydown");C.key="k",C.metaKey=!0,window.dispatchEvent(C),setTimeout(()=>{document.querySelector(".DocSearch-Modal")||a()},16)}const v=w(!1),P="";return(C,x)=>(i(),c("div",Tr,[s(P)==="local"?(i(),c(R,{key:0},[v.value?(i(),b(s(e),{key:0,onClose:x[0]||(x[0]=D=>v.value=!1)})):g("",!0),p("div",xr,[h(xn,{onClick:x[1]||(x[1]=D=>v.value=!0)})])],64)):s(P)==="algolia"?(i(),c(R,{key:1},[r.value?(i(),b(s(t),{key:0,algolia:s(o).search?.options??s(o).algolia,onVnodeBeforeMount:x[2]||(x[2]=D=>l.value=!0)},null,8,["algolia"])):g("",!0),l.value?g("",!0):(i(),c("div",Rr,[h(xn,{onClick:d})]))],64)):g("",!0)]))}}),Dr=f({__name:"VPNavBarSocialLinks",setup(n){const{theme:e}=k();return(t,o)=>s(e).socialLinks?(i(),b(wn,{key:0,class:"VPNavBarSocialLinks",links:s(e).socialLinks},null,8,["links"])):g("",!0)}}),Hr=y(Dr,[["__scopeId","data-v-ef6192dc"]]),_r=["href","rel","target"],Er=["innerHTML"],Vr={key:2},Lr=f({__name:"VPNavBarTitle",setup(n){const{site:e,theme:t}=k(),{hasSidebar:o}=q(),{currentLang:r}=z(),l=S(()=>typeof t.value.logoLink=="string"?t.value.logoLink:t.value.logoLink?.link),d=S(()=>typeof t.value.logoLink=="string"?void 0:t.value.logoLink?.rel),a=S(()=>typeof t.value.logoLink=="string"?void 0:t.value.logoLink?.target);return(v,P)=>(i(),c("div",{class:M(["VPNavBarTitle",{"has-sidebar":s(o)}])},[p("a",{class:"title",href:l.value??s(bn)(s(r).link),rel:d.value,target:a.value},[u(v.$slots,"nav-bar-title-before",{},void 0,!0),s(t).logo?(i(),b(Q,{key:0,class:"logo",image:s(t).logo},null,8,["image"])):g("",!0),s(t).siteTitle?(i(),c("span",{key:1,innerHTML:s(t).siteTitle},null,8,Er)):s(t).siteTitle===void 0?(i(),c("span",Vr,T(s(e).title),1)):g("",!0),u(v.$slots,"nav-bar-title-after",{},void 0,!0)],8,_r)],2))}}),Ar=y(Lr,[["__scopeId","data-v-d4488dd0"]]),Or={class:"items"},Fr={class:"title"},qr=f({__name:"VPNavBarTranslations",setup(n){const{theme:e}=k(),{localeLinks:t,currentLang:o}=z({correspondingLink:!0});return(r,l)=>s(t).length&&s(o).label?(i(),b(kn,{key:0,class:"VPNavBarTranslations",icon:"vpi-languages",label:s(e).langMenuLabel||"Change language"},{default:m(()=>[p("div",Or,[p("p",Fr,T(s(o).label),1),(i(!0),c(R,null,H(s(t),d=>(i(),b(en,{key:d.link,item:d},null,8,["item"]))),128))])]),_:1},8,["label"])):g("",!0)}}),jr=y(qr,[["__scopeId","data-v-acee064b"]]),Kr={class:"wrapper"},Nr={class:"container"},$r={class:"title"},Ur={class:"content"},Jr={class:"content-body"},Wr=f({__name:"VPNavBar",props:{isScreenOpen:{type:Boolean}},emits:["toggle-screen"],setup(n){const e=n,{y:t}=_n(),{isHome:o,hasSidebar:r}=q(),l=w({});return mn(()=>{l.value={"has-sidebar":r.value,home:o.value,top:t.value===0,"screen-open":e.isScreenOpen}}),(d,a)=>(i(),c("div",{class:M(["VPNavBar",l.value])},[p("div",Kr,[p("div",Nr,[p("div",$r,[h(Ar,null,{"nav-bar-title-before":m(()=>[u(d.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":m(()=>[u(d.$slots,"nav-bar-title-after",{},void 0,!0)]),_:3})]),p("div",Ur,[p("div",Jr,[u(d.$slots,"nav-bar-content-before",{},void 0,!0),h(Ir,{class:"search"}),h(kr,{class:"menu"}),h(jr,{class:"translations"}),h(Do,{class:"appearance"}),h(Hr,{class:"social-links"}),h(ur,{class:"extra"}),u(d.$slots,"nav-bar-content-after",{},void 0,!0),h(gr,{class:"hamburger",active:n.isScreenOpen,onClick:a[0]||(a[0]=v=>d.$emit("toggle-screen"))},null,8,["active"])])])])]),a[1]||(a[1]=p("div",{class:"divider"},[p("div",{class:"divider-line"})],-1))],2))}}),Br=y(Wr,[["__scopeId","data-v-8eab0e6d"]]),Gr={key:0,class:"VPNavScreenAppearance"},zr={class:"text"},Xr=f({__name:"VPNavScreenAppearance",setup(n){const{site:e,theme:t}=k();return(o,r)=>s(e).appearance&&s(e).appearance!=="force-dark"&&s(e).appearance!=="force-auto"?(i(),c("div",Gr,[p("p",zr,T(s(t).darkModeSwitchLabel||"Appearance"),1),h(yn)])):g("",!0)}}),Qr=y(Xr,[["__scopeId","data-v-a3e2920d"]]),Yr=["innerHTML"],Zr=f({__name:"VPNavScreenMenuLink",props:{item:{}},setup(n){const{closeScreen:e}=nn(vn);return(t,o)=>(i(),b(A,{class:"VPNavScreenMenuLink",href:n.item.link,target:n.item.target,rel:n.item.rel,"no-icon":n.item.noIcon,onClick:s(e)},{default:m(()=>[p("span",{innerHTML:n.item.text},null,8,Yr)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),ni=y(Zr,[["__scopeId","data-v-0c441e57"]]),ei=["innerHTML"],ti=f({__name:"VPNavScreenMenuGroupLink",props:{item:{}},setup(n){const{closeScreen:e}=nn(vn);return(t,o)=>(i(),b(A,{class:"VPNavScreenMenuGroupLink",href:n.item.link,target:n.item.target,rel:n.item.rel,"no-icon":n.item.noIcon,onClick:s(e)},{default:m(()=>[p("span",{innerHTML:n.item.text},null,8,ei)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),Nn=y(ti,[["__scopeId","data-v-37ed8a9a"]]),oi={class:"VPNavScreenMenuGroupSection"},ri={key:0,class:"title"},ii=f({__name:"VPNavScreenMenuGroupSection",props:{text:{},items:{}},setup(n){return(e,t)=>(i(),c("div",oi,[n.text?(i(),c("p",ri,T(n.text),1)):g("",!0),(i(!0),c(R,null,H(n.items,o=>(i(),b(Nn,{key:o.text,item:o},null,8,["item"]))),128))]))}}),li=y(ii,[["__scopeId","data-v-7dfe209c"]]),si=["aria-controls","aria-expanded"],ai=["innerHTML"],di=["id"],ci={key:0,class:"item"},ui={key:1,class:"item"},pi={key:2,class:"group"},mi=f({__name:"VPNavScreenMenuGroup",props:{text:{},items:{}},setup(n){const e=n,t=w(!1),o=S(()=>`NavScreenGroup-${e.text.replace(" ","-").toLowerCase()}`);function r(){t.value=!t.value}return(l,d)=>(i(),c("div",{class:M(["VPNavScreenMenuGroup",{open:t.value}])},[p("button",{class:"button","aria-controls":o.value,"aria-expanded":t.value,onClick:r},[p("span",{class:"button-text",innerHTML:n.text},null,8,ai),d[0]||(d[0]=p("span",{class:"vpi-plus button-icon"},null,-1))],8,si),p("div",{id:o.value,class:"items"},[(i(!0),c(R,null,H(n.items,a=>(i(),c(R,{key:JSON.stringify(a)},["link"in a?(i(),c("div",ci,[h(Nn,{item:a},null,8,["item"])])):"component"in a?(i(),c("div",ui,[(i(),b(L(a.component),j({ref_for:!0},a.props,{"screen-menu":""}),null,16))])):(i(),c("div",pi,[h(li,{text:a.text,items:a.items},null,8,["text","items"])]))],64))),128))],8,di)],2))}}),gi=y(mi,[["__scopeId","data-v-d3547da8"]]),fi={key:0,class:"VPNavScreenMenu"},hi=f({__name:"VPNavScreenMenu",setup(n){const{theme:e}=k();return(t,o)=>s(e).nav?(i(),c("nav",fi,[(i(!0),c(R,null,H(s(e).nav,r=>(i(),c(R,{key:JSON.stringify(r)},["link"in r?(i(),b(ni,{key:0,item:r},null,8,["item"])):"component"in r?(i(),b(L(r.component),j({key:1,ref_for:!0},r.props,{"screen-menu":""}),null,16)):(i(),b(gi,{key:2,text:r.text||"",items:r.items},null,8,["text","items"]))],64))),128))])):g("",!0)}}),bi=f({__name:"VPNavScreenSocialLinks",setup(n){const{theme:e}=k();return(t,o)=>s(e).socialLinks?(i(),b(wn,{key:0,class:"VPNavScreenSocialLinks",links:s(e).socialLinks},null,8,["links"])):g("",!0)}}),vi={class:"list"},yi=f({__name:"VPNavScreenTranslations",setup(n){const{localeLinks:e,currentLang:t}=z({correspondingLink:!0}),o=w(!1);function r(){o.value=!o.value}return(l,d)=>s(e).length&&s(t).label?(i(),c("div",{key:0,class:M(["VPNavScreenTranslations",{open:o.value}])},[p("button",{class:"title",onClick:r},[d[0]||(d[0]=p("span",{class:"vpi-languages icon lang"},null,-1)),K(" "+T(s(t).label)+" ",1),d[1]||(d[1]=p("span",{class:"vpi-chevron-down icon chevron"},null,-1))]),p("ul",vi,[(i(!0),c(R,null,H(s(e),a=>(i(),c("li",{key:a.link,class:"item"},[h(A,{class:"link",href:a.link},{default:m(()=>[K(T(a.text),1)]),_:2},1032,["href"])]))),128))])],2)):g("",!0)}}),Si=y(yi,[["__scopeId","data-v-516e4bc3"]]),ki={class:"container"},wi=f({__name:"VPNavScreen",props:{open:{type:Boolean}},setup(n){const e=w(null),t=En(G?document.body:null);return(o,r)=>(i(),b(cn,{name:"fade",onEnter:r[0]||(r[0]=l=>t.value=!0),onAfterLeave:r[1]||(r[1]=l=>t.value=!1)},{default:m(()=>[n.open?(i(),c("div",{key:0,class:"VPNavScreen",ref_key:"screen",ref:e,id:"VPNavScreen"},[p("div",ki,[u(o.$slots,"nav-screen-content-before",{},void 0,!0),h(hi,{class:"menu"}),h(Si,{class:"translations"}),h(Qr,{class:"appearance"}),h(bi,{class:"social-links"}),u(o.$slots,"nav-screen-content-after",{},void 0,!0)])],512)):g("",!0)]),_:3}))}}),Pi=y(wi,[["__scopeId","data-v-2dd6d0c7"]]),Mi={key:0,class:"VPNav"},Ci=f({__name:"VPNav",setup(n){const{isScreenOpen:e,closeScreen:t,toggleScreen:o}=So(),{frontmatter:r}=k(),l=S(()=>r.value.navbar!==!1);return Vn(vn,{closeScreen:t}),Y(()=>{G&&document.documentElement.classList.toggle("hide-nav",!l.value)}),(d,a)=>l.value?(i(),c("header",Mi,[h(Br,{"is-screen-open":s(e),onToggleScreen:s(o)},{"nav-bar-title-before":m(()=>[u(d.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":m(()=>[u(d.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":m(()=>[u(d.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":m(()=>[u(d.$slots,"nav-bar-content-after",{},void 0,!0)]),_:3},8,["is-screen-open","onToggleScreen"]),h(Pi,{open:s(e)},{"nav-screen-content-before":m(()=>[u(d.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":m(()=>[u(d.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3},8,["open"])])):g("",!0)}}),Ti=y(Ci,[["__scopeId","data-v-d5bf7c8e"]]),xi=["role","tabindex"],Ri={key:1,class:"items"},Ii=f({__name:"VPSidebarItem",props:{item:{},depth:{}},setup(n){const e=n,{collapsed:t,collapsible:o,isLink:r,isActiveLink:l,hasActiveLink:d,hasChildren:a,toggle:v}=De(S(()=>e.item)),P=S(()=>a.value?"section":"div"),C=S(()=>r.value?"a":"div"),x=S(()=>a.value?e.depth+2===7?"p":`h${e.depth+2}`:"p"),D=S(()=>r.value?void 0:"button"),_=S(()=>[[`level-${e.depth}`],{collapsible:o.value},{collapsed:t.value},{"is-link":r.value},{"is-active":l.value},{"has-active":d.value}]);function I(F){"key"in F&&F.key!=="Enter"||!e.item.link&&v()}function E(){e.item.link&&v()}return(F,V)=>{const W=U("VPSidebarItem",!0);return i(),b(L(P.value),{class:M(["VPSidebarItem",_.value])},{default:m(()=>[n.item.text?(i(),c("div",j({key:0,class:"item",role:D.value},Qn(n.item.items?{click:I,keydown:I}:{},!0),{tabindex:n.item.items&&0}),[V[1]||(V[1]=p("div",{class:"indicator"},null,-1)),n.item.link?(i(),b(A,{key:0,tag:C.value,class:"link",href:n.item.link,rel:n.item.rel,target:n.item.target},{default:m(()=>[(i(),b(L(x.value),{class:"text",innerHTML:n.item.text},null,8,["innerHTML"]))]),_:1},8,["tag","href","rel","target"])):(i(),b(L(x.value),{key:1,class:"text",innerHTML:n.item.text},null,8,["innerHTML"])),n.item.collapsed!=null&&n.item.items&&n.item.items.length?(i(),c("div",{key:2,class:"caret",role:"button","aria-label":"toggle section",onClick:E,onKeydown:Yn(E,["enter"]),tabindex:"0"},[...V[0]||(V[0]=[p("span",{class:"vpi-chevron-right caret-icon"},null,-1)])],32)):g("",!0)],16,xi)):g("",!0),n.item.items&&n.item.items.length?(i(),c("div",Ri,[n.depth<5?(i(!0),c(R,{key:0},H(n.item.items,Pn=>(i(),b(W,{key:Pn.text,item:Pn,depth:n.depth+1},null,8,["item","depth"]))),128)):g("",!0)])):g("",!0)]),_:1},8,["class"])}}}),Di=y(Ii,[["__scopeId","data-v-6b36a2fd"]]),Hi=f({__name:"VPSidebarGroup",props:{items:{}},setup(n){const e=w(!0);let t=null;return N(()=>{t=setTimeout(()=>{t=null,e.value=!1},300)}),Zn(()=>{t!=null&&(clearTimeout(t),t=null)}),(o,r)=>(i(!0),c(R,null,H(n.items,l=>(i(),c("div",{key:l.text,class:M(["group",{"no-transition":e.value}])},[h(Di,{item:l,depth:0},null,8,["item"])],2))),128))}}),_i=y(Hi,[["__scopeId","data-v-a84b7c21"]]),Ei={class:"nav",id:"VPSidebarNav","aria-labelledby":"sidebar-aria-label",tabindex:"-1"},Vi=f({__name:"VPSidebar",props:{open:{type:Boolean}},setup(n){const{sidebarGroups:e,hasSidebar:t}=q(),o=n,r=w(null),l=En(G?document.body:null);O([o,r],()=>{o.open?(l.value=!0,r.value?.focus()):l.value=!1},{immediate:!0,flush:"post"});const d=w(0);return O(e,()=>{d.value+=1},{deep:!0}),(a,v)=>s(t)?(i(),c("aside",{key:0,class:M(["VPSidebar",{open:n.open}]),ref_key:"navEl",ref:r,onClick:v[0]||(v[0]=Ln(()=>{},["stop"]))},[v[2]||(v[2]=p("div",{class:"curtain"},null,-1)),p("nav",Ei,[v[1]||(v[1]=p("span",{class:"visually-hidden",id:"sidebar-aria-label"}," Sidebar Navigation ",-1)),u(a.$slots,"sidebar-nav-before",{},void 0,!0),(i(),b(_i,{items:s(e),key:d.value},null,8,["items"])),u(a.$slots,"sidebar-nav-after",{},void 0,!0)])],2)):g("",!0)}}),Li=y(Vi,[["__scopeId","data-v-e0eef791"]]),Ai=f({__name:"VPSkipLink",setup(n){const{theme:e}=k(),t=Z(),o=w();O(()=>t.path,()=>o.value.focus());function r({target:l}){const d=document.getElementById(decodeURIComponent(l.hash).slice(1));if(d){const a=()=>{d.removeAttribute("tabindex"),d.removeEventListener("blur",a)};d.setAttribute("tabindex","-1"),d.addEventListener("blur",a),d.focus(),window.scrollTo(0,0)}}return(l,d)=>(i(),c(R,null,[p("span",{ref_key:"backToTop",ref:o,tabindex:"-1"},null,512),p("a",{href:"#VPContent",class:"VPSkipLink visually-hidden",onClick:r},T(s(e).skipToContentLabel||"Skip to content"),1)],64))}}),Oi=y(Ai,[["__scopeId","data-v-fcbfc0e0"]]),Fi=f({__name:"Layout",setup(n){const{isOpen:e,open:t,close:o}=Ie();He({closeSidebar:o});const{frontmatter:r}=k(),l=ne(),d=S(()=>!!l["home-hero-image"]);return Vn(Fn,{heroImageSlotExists:d}),(a,v)=>{const P=U("Content");return s(r).layout!==!1?(i(),c("div",{key:0,class:M(["Layout",s(r).pageClass])},[u(a.$slots,"layout-top",{},void 0,!0),h(Oi),h(se,{class:"backdrop",show:s(e),onClick:s(o)},null,8,["show","onClick"]),h(Ti,null,{"nav-bar-title-before":m(()=>[u(a.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":m(()=>[u(a.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":m(()=>[u(a.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":m(()=>[u(a.$slots,"nav-bar-content-after",{},void 0,!0)]),"nav-screen-content-before":m(()=>[u(a.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":m(()=>[u(a.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3}),h(yo,{open:s(e),onOpenMenu:s(t)},null,8,["open","onOpenMenu"]),h(Li,{open:s(e)},{"sidebar-nav-before":m(()=>[u(a.$slots,"sidebar-nav-before",{},void 0,!0)]),"sidebar-nav-after":m(()=>[u(a.$slots,"sidebar-nav-after",{},void 0,!0)]),_:3},8,["open"]),h(oo,null,{"page-top":m(()=>[u(a.$slots,"page-top",{},void 0,!0)]),"page-bottom":m(()=>[u(a.$slots,"page-bottom",{},void 0,!0)]),"not-found":m(()=>[u(a.$slots,"not-found",{},void 0,!0)]),"home-hero-before":m(()=>[u(a.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":m(()=>[u(a.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":m(()=>[u(a.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":m(()=>[u(a.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":m(()=>[u(a.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":m(()=>[u(a.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":m(()=>[u(a.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":m(()=>[u(a.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":m(()=>[u(a.$slots,"home-features-after",{},void 0,!0)]),"doc-footer-before":m(()=>[u(a.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":m(()=>[u(a.$slots,"doc-before",{},void 0,!0)]),"doc-after":m(()=>[u(a.$slots,"doc-after",{},void 0,!0)]),"doc-top":m(()=>[u(a.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":m(()=>[u(a.$slots,"doc-bottom",{},void 0,!0)]),"aside-top":m(()=>[u(a.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":m(()=>[u(a.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":m(()=>[u(a.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":m(()=>[u(a.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":m(()=>[u(a.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":m(()=>[u(a.$slots,"aside-ads-after",{},void 0,!0)]),_:3}),h(ao),u(a.$slots,"layout-bottom",{},void 0,!0)],2)):(i(),b(P,{key:1}))}}}),qi=y(Fi,[["__scopeId","data-v-304c8b69"]]),Rn={Layout:qi,enhanceApp:({app:n})=>{n.component("Badge",re)}},ji={class:"vp-collapse"},Ki=f({__name:"Collapse",setup(n){const e=w(!1),t=w(null),o=w({});function r(){e.value=!e.value}return O(e,async l=>{await hn();const d=t.value;if(d)if(l){const a=d.scrollHeight;o.value={height:"0px",overflow:"hidden"},d.offsetHeight,o.value={height:a+"px",overflow:"hidden"},setTimeout(()=>{e.value&&(o.value={height:"auto"})},300)}else{const a=d.clientHeight;o.value={height:a+"px",overflow:"hidden"},d.offsetHeight,o.value={height:"0px",overflow:"hidden"}}}),(l,d)=>(i(),c("div",ji,[p("div",{class:M(["vp-collapse__summary",{"vp-collapse__summary--open":e.value}]),onClick:r},[u(l.$slots,"summary",{},()=>[K(T(e.value?"▼":"►")+" "+T(e.value?"折叠":"展开"),1)],!0)],2),ee(p("div",{class:"vp-collapse__content",ref_key:"contentRef",ref:t,style:fn(o.value)},[u(l.$slots,"default",{},void 0,!0)],4),[[te,e.value]])]))}}),Ni=y(Ki,[["__scopeId","data-v-4585a904"]]),on=[{id:1,question:"AI Agent  是啥?",answer:["AI Agent（智能代理） 是一个能够 **感知环境、做决策、执行动作** 的系统。是能够感知环境、做决策并执行动作的智能系统，其复杂度从简单规则反应型到学习型智能体不等。","AI Agent 的代码生成、辅助编程工具和提示工程 (Prompt Engineering) 工具","AI Agent 是能够感知环境、基于目标和策略做决策并执行动作的智能系统，现代应用多结合 LLM，实现自动化任务、多步推理和上下文增强。"],answerHtml:["<p>AI Agent（智能代理） 是一个能够 <strong>感知环境、做决策、执行动作</strong> 的系统。是能够感知环境、做决策并执行动作的智能系统，其复杂度从简单规则反应型到学习型智能体不等。</p>","<p>AI Agent 的代码生成、辅助编程工具和提示工程 (Prompt Engineering) 工具</p>","<p>AI Agent 是能够感知环境、基于目标和策略做决策并执行动作的智能系统，现代应用多结合 LLM，实现自动化任务、多步推理和上下文增强。</p>"],reference:"/myKMS/ai/index#_1-ai-agent-是啥",source:"/myKMS/ai/index"},{id:2,question:"MCP 是啥",answer:[`ai mcp 是啥: 
...
\`\`\``],answerHtml:["<p><strong>是一条从上下文收集 → 语言模型推断 → 候选生成与重排 → 约束与安全 → 呈现与学习的工程流水线</strong></p>",`<div class="language-swift"><button title="Copy Code" class="copy"></button><span class="lang">swift</span><pre><!--::markdown-it-async::6eqy8zpko6ny0p878a8d2i::--><code>键入 → 触发条件命中
   → 上下文构建（prefix+suffix+符号/RAG+工程规则）
     → 模型解码（FIM/自回归，KV cache，限长/停用符）
       → 生成多候选（不同温度/窗口）
         → 重排（可编性/风格/相似度/历史采纳）
...
</div>`],reference:"/myKMS/ai/index#_8-ai-ide-中-tab-补全模型及其原理",source:"/myKMS/ai/index"},{id:9,question:"有Agent 应该够了吧, 为什么要向量知识库呢",answer:["就算有 Agent，也离不开“知识来源”——把静态资料做成向量库，其实就是把药品说明、库存策略等内容塞进一个“可检索的数据库”，Agent 在需要时可以即时查到准确原文，而不是凭记忆或胡编。这样有几个好处：",`- 解决“模型记不住细节”的问题
  - 纯 LLM 只靠参数记忆，很难覆盖你医院或药房的私有数据；有了向量库，Agent 能随时检索最新的药品说明、库存规则并引用，避免幻觉。`,`- 支持实时更新
  - 药品库存、使用指引会频繁变化，维护一份向量知识库（或接入真实 DB）就能随时更新，而不用每次都重新训练模型。`,`- 提高可追溯性
  - Agent 调用 drug_rag_search 时，我们能记录它引用了哪些文档、哪些药品，方便追踪和解释“回答依据”。`,`- 便于扩展场景
  - 未来要加入更多药品、政策、指南，只需往知识库里追加文档，Agent 立即可以使用，不用改 prompt 或模型。`,"因此，Agent 和向量库是互补关系：Agent 负责“读问题、决定流程”，向量库负责“提供准确知识”；两者配合才能在真实医院环境里给出可信、可审计的答案。"],answerHtml:["<p>就算有 Agent，也离不开“知识来源”——把静态资料做成向量库，其实就是把药品说明、库存策略等内容塞进一个“可检索的数据库”，Agent 在需要时可以即时查到准确原文，而不是凭记忆或胡编。这样有几个好处：</p>",`<ul>
<li>解决“模型记不住细节”的问题
<ul>
<li>纯 LLM 只靠参数记忆，很难覆盖你医院或药房的私有数据；有了向量库，Agent 能随时检索最新的药品说明、库存规则并引用，避免幻觉。</li>
</ul>
</li>
</ul>`,`<ul>
<li>支持实时更新
<ul>
<li>药品库存、使用指引会频繁变化，维护一份向量知识库（或接入真实 DB）就能随时更新，而不用每次都重新训练模型。</li>
</ul>
</li>
</ul>`,`<ul>
<li>提高可追溯性
<ul>
<li>Agent 调用 drug_rag_search 时，我们能记录它引用了哪些文档、哪些药品，方便追踪和解释“回答依据”。</li>
</ul>
</li>
</ul>`,`<ul>
<li>便于扩展场景
<ul>
<li>未来要加入更多药品、政策、指南，只需往知识库里追加文档，Agent 立即可以使用，不用改 prompt 或模型。</li>
</ul>
</li>
</ul>`,"<p>因此，Agent 和向量库是互补关系：Agent 负责“读问题、决定流程”，向量库负责“提供准确知识”；两者配合才能在真实医院环境里给出可信、可审计的答案。</p>"],reference:"/myKMS/ai/index#_9-有agent-应该够了吧-为什么要向量知识库呢",source:"/myKMS/ai/index"},{id:10,question:"排序算法",answer:["排序算法分类:",`| 分类         | 特点               | 示例                 |
| ---------- | ---------------- | ------------------ |
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::2ep3os2ztb2vkgf6va7cqf::--><code>
function bubbleSort(arr) {
  for (let i = 0; i &lt; arr.length - 1; i++) {
    for (let j = 0; j &lt; arr.length - 1 - i; j++) {
      if (arr[j] &gt; arr[j + 1]) {
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::ftq2olyh83igh39im2op6g::--><code>function selectionSort(arr) {
  for (let i = 0; i &lt; arr.length; i++) {
    let min = i;
    for (let j = i + 1; j &lt; arr.length; j++) {
      if (arr[j] &lt; arr[min]) min = j;
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::jcpziztyyqazd1untck9gk::--><code>function insertionSort(arr) {
  for (let i = 1; i &lt; arr.length; i++) {
    let key = arr[i];
    let j = i - 1;
    while (j &gt;= 0 &amp;&amp; arr[j] &gt; key) {
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::iiw5lsg1hbjeyisl5e78eu::--><code>function quickSort(arr) {
  if (arr.length &lt;= 1) return arr;
  const pivot = arr[arr.length &gt;&gt; 1];
  const left = arr.filter(x =&gt; x &lt; pivot);
  const mid = arr.filter(x =&gt; x === pivot);
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::ewfhm5k1q1wnbbadmhf4f::--><code>
function mergeSort(arr) {
  if (arr.length &lt;= 1) return arr;
  const mid = Math.floor(arr.length / 2);
  const left = mergeSort(arr.slice(0, mid));
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::g1gsg43bti7e2e3jplsryr::--><code>function countingSort(arr, maxValue) {
  const count = new Array(maxValue + 1).fill(0);
  arr.forEach(v =&gt; count[v]++);
  const res = [];
  count.forEach((v, i) =&gt; { while (v--) res.push(i); });
...
</table>`],reference:"/myKMS/algorithm/index#_2-排序算法",source:"/myKMS/algorithm/index"},{id:11,question:"洗牌算法",answer:[`\`\`\`
...
\`\`\``],answerHtml:[`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::xgxh2nverbyh3o94fwcua::--><code>function shuffle(array) {
  let arr = array.slice(); // 拷贝一份，不修改原数组
  for (let i = arr.length - 1; i &gt; 0; i--) {
    const j = Math.floor(Math.random() * (i + 1)); // 随机索引 [0, i]
    [arr[i], arr[j]] = [arr[j], arr[i]]; // 交换
...
</div>`],reference:"/myKMS/algorithm/index#_3-洗牌算法",source:"/myKMS/algorithm/index"},{id:12,question:"字符串出现的不重复最长长度",answer:["我们可以用 双指针（left、right）+ 哈希表（Set 或 Map） 实现：","- 用一个窗口 [left, right) 表示当前不重复子串；","- 向右移动 right 扩大窗口；","- 若遇到重复字符，则移动 left 收缩窗口；","- 过程中记录窗口最大长度。",`\`\`\`js
...
<li>过程中记录窗口最大长度。</li>
</ul>`,`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::eehjl2vvbaqe3c0c0fgic::--><code>function lengthOfLongestSubstring(s) {
  let set = new Set();
  let left = 0, maxLen = 0;
...
</div>`],reference:"/myKMS/algorithm/index#_4-字符串出现的不重复最长长度",source:"/myKMS/algorithm/index"},{id:13,question:"react vue 有什么区别和相似",answer:["对比:","- vue 编译+运行时框架, react 运行时, 所以vue 再编译时能够做很多优化(如静态标记和动态提升), react 更注重运行时, react 19 也有 React Compiler 编译优化. (svelte 纯编译 )",`- React：UI 库（Library），专注于 视图层，其它路由/状态管理等靠社区生态（React Router、Redux）。
...
<li>都支持跨平台渲染</li>
</ul>`],reference:"/myKMS/interview/2025#_1-react-vue-有什么区别和相似",source:"/myKMS/interview/2025"},{id:14,question:"qiankun",answer:[`- js 隔离:
...
基于 ES6 Proxy 拦截子应用对全局对象的读写。每个子应用有一个独立的代理对象作为 window，实际访问 window.xxx 时，会优先读写子应用自己的代理上下文。多个子应用可并行运行，互不影响。</p>`,"<p>qiankun 默认在支持 Proxy 的浏览器下使用这个方案</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::xbueonx4g6lp5hmcw5mnl::--><code>const fakeWindow = {};
const proxy = new Proxy(window, {
        get(target, key) {
        return key in fakeWindow ? fakeWindow[key] : target[key];
},
...
</ol>`],reference:"/myKMS/interview/2025#_2-qiankun",source:"/myKMS/interview/2025"},{id:15,question:"vite 插件",answer:[`\`\`\`
...
\`\`\``],answerHtml:[`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::gswsuietr08t2g88h7q0a::--><code>import type { Plugin } from &#039;vite&#039;;
...
</div>`,"<p>// 替换模板的一个字</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::fes3wkk2p3tjaupbhsoa6n::--><code>export default function replaceTextPlugin(options = { search: &#039;FOO&#039;, replace: &#039;BAR&#039; }) {
  return {
    name: &#039;vite-plugin-replace-text&#039;,
    enforce: &#039;pre&#039;,
    transform(code, id) {
...
</div>`,"<p>// 统计TODO</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::4kn0esvyqkejhrw150pe8f::--><code>import fs from &#039;fs&#039;;
import path from &#039;path&#039;;
...
</div>`],reference:"/myKMS/interview/2025#_4-vite-插件",source:"/myKMS/interview/2025"},{id:16,question:"webpack 和 vite 的区别",answer:[`1. Webpack：老牌的 打包器，把所有依赖打包成一个或多个 bundle。
...
</ul>`],reference:"/myKMS/interview/2025#_6-react-fiber-架构",source:"/myKMS/interview/2025"},{id:18,question:"单点登录",answer:["用户在一个系统上登录后，就能无感知地访问其他关联系统，无需再次登录。",`- 统一身份认证中心（Identity Provider, IdP）
  - 用户只在认证中心登录一次。
...
</ul>`],reference:"/myKMS/interview/2025#_7-单点登录",source:"/myKMS/interview/2025"},{id:19,question:"状态管理redux mobx pinna 设计模式是啥？区别是啥",answer:[`| 维度          | Redux               | MobX                         | Pinia                       |
| ----------- | ------------------- | ---------------------------- | --------------------------- |
...
</ul>`],reference:"/myKMS/interview/2025#_8-状态管理redux-mobx-pinna-设计模式是啥-区别是啥",source:"/myKMS/interview/2025"},{id:20,question:"如果一个项目 使用了antd 组件库, 又使用了antd 2次开发组件库 会不会有问题",answer:[`1. 样式冲突, 可以通过修改命名前缀区分
2. ConfigProvider 全局化配置也可能会冲突`],answerHtml:[`<ol>
<li>样式冲突, 可以通过修改命名前缀区分</li>
<li>ConfigProvider 全局化配置也可能会冲突</li>
</ol>`],reference:"/myKMS/interview/2025#_9-如果一个项目-使用了antd-组件库-又使用了antd-2次开发组件库-会不会有问题",source:"/myKMS/interview/2025"},{id:21,question:"页面卡顿，内存泄露排查",answer:[`| 现象                   | 原因可能性                                       |
| -------------------- | ------------------------------------------- |
...
| **8️⃣ 持续监控**  | 监控上线表现       | 性能监控 SDK（如 Sentry、WebVitals）               | 采集 FPS / Heap / 页面耗时数据           | 长时间运行后趋势                              | 提前发现潜在泄漏          |`,"在 Chrome DevTools 的 Memory（内存）→ Heap snapshot 里：","- 浅层大小（Shallow Size）","- 保留大小（Retained Size）","都是针对“某个对象”算出来的两个不同概念。","可以直接把它们想成：",`- 浅层大小 = 这个对象自己有多大(对象本身占用的内存)
 - 保留大小 = 因为它还活着，连带导致不能被回收的那一整团对象有多大`,"**小技巧**: 在右上角 Filter 里输入 detached，可以快速找到“脱离 DOM 但还在内存里的节点”，这是内存泄漏常见来源（事件监听没解绑、闭包引用 DOM 等）"],answerHtml:[`<table tabindex="0">
<thead>
<tr>
<th>现象</th>
<th>原因可能性</th>
...
</table>`,"<p>在 Chrome DevTools 的 Memory（内存）→ Heap snapshot 里：</p>",`<ul>
<li>浅层大小（Shallow Size）</li>
</ul>`,`<ul>
<li>保留大小（Retained Size）</li>
</ul>`,"<p>都是针对“某个对象”算出来的两个不同概念。</p>","<p>可以直接把它们想成：</p>",`<ul>
<li>浅层大小 = 这个对象自己有多大(对象本身占用的内存)</li>
<li>保留大小 = 因为它还活着，连带导致不能被回收的那一整团对象有多大</li>
</ul>`,"<p><strong>小技巧</strong>: 在右上角 Filter 里输入 detached，可以快速找到“脱离 DOM 但还在内存里的节点”，这是内存泄漏常见来源（事件监听没解绑、闭包引用 DOM 等）</p>"],reference:"/myKMS/interview/2025#_10-页面卡顿-内存泄露排查",source:"/myKMS/interview/2025"},{id:22,question:"定位白屏的常见原因",answer:[`- 1.JavaScript 错误导致渲染中断
    - 症状：控制台报错，页面无法正常渲染。
    -  也可能接口返回异常数据或前端未兼容数据
- 2.关键资源加载失败
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::5phd27g8qvukjlhizellyg::--><code>function isElementRendered(sampleCount = 10) {
    let visibleCount = 0;
    for (let i = 0; i &lt; sampleCount; i++) {
        const x = Math.random() * window.innerWidth;
        const y = Math.random() * window.innerHeight;
...
</div>`],reference:"/myKMS/interview/2025#_11-定位白屏的常见原因",source:"/myKMS/interview/2025"},{id:23,question:"浏览器事件循环，网络请求是宏任务吗？",answer:["是的，浏览器中的网络请求（如使用 fetch 或 XMLHttpRequest）属于宏任务（macrotask）。",`调用栈（Call Stack）：执行同步代码。
...
<li>重复上述步骤</li>
</ul>`,"<p>宏任务 → 微任务 → ✅ 渲染 → 下一个宏任务</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::pvxq8nww1qe6sm3s0dkc::--><code>┌────────────────────────────┐
│       1. 取一个宏任务       │ (如 script, I/O, setTimeout 回调)
├────────────────────────────┤
│       2. 执行所有微任务     │ (Promise.then, MutationObserver)
├────────────────────────────┤
...
</div>`,"<p><strong>宏任务 → 微任务 → rAF → 渲染 → idle → 下一宏任务</strong></p>"],reference:"/myKMS/interview/2025#_12-浏览器事件循环-网络请求是宏任务吗",source:"/myKMS/interview/2025"},{id:24,question:"页面的线程",answer:[`| 线程名称                               | 职责                                      | 是否并行  | 示例说明                    |
| ---------------------------------- | --------------------------------------- | ----- | ----------------------- |
...
</table>`],reference:"/myKMS/interview/2025#_14-ts-type-interface",source:"/myKMS/interview/2025"},{id:26,question:"ts 泛型",answer:[`泛型（Generics） 是一种强大的特性，允许在定义函数、接口或类时不预先指定具体的类型，而在使用时再指定类型，从而实现类型的复用和灵活性。
...
</ul>`],reference:"/myKMS/interview/2025#_15-ts-泛型",source:"/myKMS/interview/2025"},{id:27,question:"从输入 URL 到页面渲染的完整流程, 说出自己的理解",answer:["当用户输入一个 URL 并回车，整个过程可以拆成 五个阶段：",`| 阶段        | 描述                                                        | 涉及层次  |
| --------- | --------------------------------------------------------- | ----- |
...
</table>`],reference:"/myKMS/interview/2025#_16-从输入-url-到页面渲染的完整流程-说出自己的理解",source:"/myKMS/interview/2025"},{id:28,question:"缓存",answer:["浏览器 / 缓存层（代理、CDN）会将服务器响应保存起来，当下次请求相同资源时可直接从缓存中返回，而不必到服务器取。这样可以减少网络延迟和服务器负荷。","- 新鲜度判断（Freshness） vs 验证（Validation）",`- 新鲜（Fresh）：在有效期内，缓存可直接返回给客户端。
...
</ul>`],reference:"/myKMS/interview/2025#_20-组件-key-改变和-props-改变有什么区别",source:"/myKMS/interview/2025"},{id:30,question:"react form 里面非受控组件 如何对应上值的改变",answer:["| 方式    | 数据存放        | 值变化的响应                       | 外部值改变时                             |\n| ----- | ----------- | ---------------------------- | ---------------------------------- |\n| 受控组件  | React state | `onChange` → setState → 重新渲染 | 直接受 state 驱动，值自动更新                 |\n| 非受控组件 | DOM 元素内部    | 通过 `ref` 读取                  | 需要用 `ref.current.value = ...` 手动更新 |","总结",`- 非受控组件默认不会随着 props 变化而更新。
- 如果想同步外部变化：
...
</ul>`],reference:"/myKMS/interview/2025#_26-react-form-里面非受控组件-如何对应上值的改变",source:"/myKMS/interview/2025"},{id:31,question:"antd form是如何控制内部组件的value的",answer:["基于 v4+ 分析","##### 总体设计思路","Antd Form 并不是简单地把 `<Form.Item>` 里的 `<Input>` 当作受控组件包一层，而是自己实现了一套 “表单状态管理 + 受控注入” 机制。\n核心：",`- Form 内部维护一个 FormStore（字段名 → 值 的状态）。
...
</ul>`,"<p>典型用法:</p>",`<div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre><!--::markdown-it-async::dpyve9716nk9qv449jah2s::--><code>&lt;Form form={form} initialValues={{ username: &#039;Tom&#039; }}&gt;
  &lt;Form.Item name=&quot;username&quot;&gt;
    &lt;Input /&gt;
  &lt;/Form.Item&gt;
&lt;/Form&gt;</code></pre>
</div>`,"<p>对应关系：</p>",`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::yyrzrh3sb327ho4stt5cx::--><code>&lt;Form&gt;           —— 维护 FormStore（字段状态）
   │
   └─&lt;FormContext.Provider&gt;  —— 提供 Store 和订阅方法
        │
        └─&lt;Form.Item name=&quot;username&quot;&gt; —— 注册字段
...
</ul>`,`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::fcayftcgubko73d9hrkdhk::--><code>    {
    value: store[name],
    onChange: (e) =&gt; {
      const newValue = e &amp;&amp; e.target ? e.target.value : e;
      store.setFieldValue(name, newValue);
...
</ul>`],reference:"/myKMS/interview/2025#_27-antd-form是如何控制内部组件的value的",source:"/myKMS/interview/2025"},{id:32,question:"数组转树",answer:[`\`\`\`js
const arr = [
  { id: 1, name: "i1" },
...
\`\`\``],answerHtml:[`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::ln8w47j2jxhfryp38auiw::--><code>const arr = [
  { id: 1, name: &quot;i1&quot; },
  { id: 2, name: &quot;i2&quot;, parentId: 1 },
  { id: 4, name: &quot;i4&quot;, parentId: 3 },
  { id: 3, name: &quot;i3&quot;, parentId: 2 },
...
</div>`],reference:"/myKMS/interview/code#_1-数组转树",source:"/myKMS/interview/code"},{id:33,question:"链式调用的任务调度器",answer:[`\`\`\`js
...
\`\`\``],answerHtml:[`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::qef2izq3gjmim1woscqtis::--><code>function arrange(name) {
  const queue = []
...
</div>`],reference:"/myKMS/interview/code#_2-链式调用的任务调度器",source:"/myKMS/interview/code"},{id:34,question:"从0到1新建一个React前端工程，并写一个页面，实现下面功能：上面有个2分钟的倒计时,倒计时下，有2个按钮，一个按钮可以暂停/恢复倒计时，另一个按钮可以减10秒倒计时,然后倒计时到0之后，出现一个秒杀新按钮. 进阶增加重新开始功能",answer:[`\`\`\`jsx
...
\`\`\``],answerHtml:[`<div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre><!--::markdown-it-async::muezo7lq5sfbh8iqe6qzqd::--><code>// 代码由github copilot 生成
...
</div>`],reference:"/myKMS/interview/code#_3-从0到1新建一个react前端工程-并写一个页面-实现下面功能-上面有个2分钟的倒计时-倒计时下-有2个按钮-一个按钮可以暂停-恢复倒计时-另一个按钮可以减10秒倒计时-然后倒计时到0之后-出现一个秒杀新按钮-进阶增加重新开始功能",source:"/myKMS/interview/code"},{id:35,question:"防抖（debounce）",answer:[`\`\`\`js
...
\`\`\``],answerHtml:[`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::onhw5gy77miko21hr9ovzl::--><code>
function debounce(fn, wait = 300) {
  let timer = null;
  return function(...args) {
    clearTimeout(timer);
...
</div>`],reference:"/myKMS/interview/code#_4-防抖-debounce",source:"/myKMS/interview/code"},{id:36,question:"节流（throttle）",answer:[`\`\`\`js
...
\`\`\``],answerHtml:[`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::6yi1dhdb5iy32t6x1m5tnn::--><code>
function throttle_timestamp(fn, wait) {
  let last = 0; // 上次执行时间（ms）
...
</div>`],reference:"/myKMS/interview/code#_5-节流-throttle",source:"/myKMS/interview/code"},{id:37,question:"手写 Promise",answer:[`\`\`\`js
class MyPromise {
...
\`\`\``],answerHtml:[`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::ufiec53yjbsqqkaaol0bfr::--><code>class MyPromise {
        static PENDING = &quot;pending&quot;;
        static RESOLVED = &quot;resolved&quot;;
        static REJECTED = &quot;rejected&quot;;
        constructor(executor) {
...
</div>`],reference:"/myKMS/interview/code#_5-手写-promise",source:"/myKMS/interview/code"},{id:38,question:"js bind 实现机制？手写一个 bind 方法？",answer:["bind的 作用: **返回一个新的函数，这个新函数在被调用时，其内部的 this 会永久绑定为你指定的对象。**","bind 做了三件事：",`- 绑定 this：返回一个新的函数，内部的 this 固定为传入的对象；
- 支持参数预置：可以提前绑定部分参数；
...
</ul>`,`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::2knnj2zupwmilc6mesra7::--><code>// 简单版
Function.prototype.myBind = function (context) {
  const fn = this; // 保存原函数
  return function () {
    return fn.apply(context);
...
</table>`,`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::8jhv0c0nqld9pwpo3s4nfa::--><code>function greet(g1, g2) {
  console.log(this.name, g1, g2);
}
...
</ul>`],reference:"/myKMS/interview/code#_6-js-bind-实现机制-手写一个-bind-方法",source:"/myKMS/interview/code"},{id:39,question:"图片查看器",answer:[`| 层级     | 功能模块                      | 描述          |
| ------ | ------------------------- | ----------- |
...
</table>`],reference:"/myKMS/interview/code#_7-图片查看器",source:"/myKMS/interview/code"},{id:40,question:"手写 instanceof 方法",answer:["instanceof 运算符用于判断构造函数的 prototype 属性是否出现在对象的原型链中的任何位置。",`实现步骤：
- 首先获取类型的原型
- 然后获得对象的原型
...
</ul>`,`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::z0drfr59hwifkddx51qac::--><code>function myInstanceof(left, right) {
  let proto = Object.getPrototypeOf(left), // 获取对象的原型
      prototype = right.prototype; // 获取构造函数的 prototype 对象
...
</div>`],reference:"/myKMS/interview/code#_8-手写-instanceof-方法",source:"/myKMS/interview/code"},{id:41,question:"手写 new 操作符",answer:["在调用 new 的过程中会发生以上四件事情：","（1）首先创建了一个新的空对象","（2）设置原型，将对象的原型设置为函数的 prototype 对象。","（3）让函数的 this 指向这个对象，执行构造函数的代码（为这个新对象添加属性）","（4）判断函数的返回值类型，如果是值类型，返回创建的对象。如果是引用类型，就返回这个引用类型的对象。",`\`\`\`js
...
\`\`\``],answerHtml:["<p>在调用 new 的过程中会发生以上四件事情：</p>","<p>（1）首先创建了一个新的空对象</p>","<p>（2）设置原型，将对象的原型设置为函数的 prototype 对象。</p>","<p>（3）让函数的 this 指向这个对象，执行构造函数的代码（为这个新对象添加属性）</p>","<p>（4）判断函数的返回值类型，如果是值类型，返回创建的对象。如果是引用类型，就返回这个引用类型的对象。</p>",`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::7bnyxyh1pn939wiv8zr3zt::--><code>
function myNew(constructor, ...args) {
  if (typeof constructor !== &quot;function&quot;) return
  let obj = {}
  obj.prototype = Object.create(constructor.prototype)
...
</div>`],reference:"/myKMS/interview/code#_9-手写-new-操作符",source:"/myKMS/interview/code"},{id:42,question:"函数柯里化",answer:["柯里化（Currying） 是把一个接受多个参数的函数，转换成一系列每次只接收一个参数的函数。","类比: “一次性买 3 个苹果”，变成 “一次买 1 个，买 3 次，最后结算”。",`\`\`\`
function add(a, b, c) {
  return a + b + c;
}
...
\`\`\``],answerHtml:["<p>柯里化（Currying） 是把一个接受多个参数的函数，转换成一系列每次只接收一个参数的函数。</p>","<p>类比: “一次性买 3 个苹果”，变成 “一次买 1 个，买 3 次，最后结算”。</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::x74pio2vq2i3nqugkr9m::--><code>function add(a, b, c) {
  return a + b + c;
}
...
<li>✅ 提升代码可读性和函数式风格</li>
</ul>`,`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::at94eoqgk68hp4oulqf0lm::--><code>
function curry(fn) {
  const curried = (...args) =&gt; {
    // 如果参数足够就执行，否则返回新函数继续收集
    return args.length &gt;= fn.length
...
</div>`],reference:"/myKMS/interview/code#_10-函数柯里化",source:"/myKMS/interview/code"},{id:43,question:"如何判断用户是否离开当前页面?",answer:["一、页面可见性 Page Visibility API","判断用户标签页是否可见（切换到后台/最小化浏览器）",`\`\`\`
...
\`\`\``],answerHtml:["<p>一、页面可见性 Page Visibility API</p>","<p>判断用户标签页是否可见（切换到后台/最小化浏览器）</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::t7h1yudnz2j6qgb8g5s5j::--><code>document.addEventListener(&#039;visibilitychange&#039;, () =&gt; {
  if (document.hidden) {
    console.log(&#039;用户离开页面（切换标签页或最小化）&#039;);
  } else {
    console.log(&#039;用户回到页面&#039;);
...
</div>`,"<p>二、窗口焦点（Focus / Blur）</p>","<p>检测窗口或 iframe 是否获得焦点</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::rry9ykf2lfr27ig9zo9818::--><code>window.addEventListener(&#039;blur&#039;, () =&gt; {
  console.log(&#039;用户离开了当前窗口/标签页&#039;);
});
...
</div>`,"<p>三、用户离开页面 / 卸载（beforeunload / unload）</p>","<p>检测用户关闭页面、刷新或跳转。</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::c482yoytk656yv2z47s4ma::--><code>window.addEventListener(&#039;beforeunload&#039;, (e) =&gt; {
  console.log(&#039;用户可能离开页面&#039;);
  // 阻止默认提示（可选）
  e.preventDefault();
  e.returnValue = &#039;&#039;;
...
</div>`,"<p>四、鼠标 / 用户交互检测</p>","<p>当用户长时间没有交互（鼠标、键盘、触屏），可推测用户离开</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::n1gqltedg788jaj44ul64y::--><code>let idleTimer;
function resetIdle() {
  clearTimeout(idleTimer);
  idleTimer = setTimeout(() =&gt; {
    console.log(&#039;用户可能离开或无操作&#039;);
...
</div>`,"<p>可以检测“用户不活跃”，用于自动登出、心跳等.</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::otwshq4lqxx2lytuq2u9o::--><code>let idleTimer;
function onUserIdle() { console.log(&#039;用户离开页面或长时间不操作&#039;); }
function resetIdle() {
  clearTimeout(idleTimer);
  idleTimer = setTimeout(onUserIdle, 30000);
...
</div>`],reference:"/myKMS/interview/index#_1-如何判断用户是否离开当前页面",source:"/myKMS/interview/index"},{id:44,question:"前端如何预览pdf?",answer:["一、直接使用浏览器内置 PDF 渲染\n    - `<iframe>` 嵌入\n    - `<embed>` 标签\n    - 新开标签页","二、使用 PDF.js\n    - PDF.js 是最常用的前端 PDF 渲染库，可以在 `<canvas>` 上渲染 PDF 页面。"],answerHtml:[`<p>一、直接使用浏览器内置 PDF 渲染
- <code>&lt;iframe&gt;</code> 嵌入
- <code>&lt;embed&gt;</code> 标签
- 新开标签页</p>`,`<p>二、使用 PDF.js
- PDF.js 是最常用的前端 PDF 渲染库，可以在 <code>&lt;canvas&gt;</code> 上渲染 PDF 页面。</p>`],reference:"/myKMS/interview/index#_2-前端如何预览pdf",source:"/myKMS/interview/index"},{id:45,question:"前端批量请求失败Toast重复弹窗怎么解决？",answer:[`- 全局标志拦截: 无论多少错误只弹出一个错误 
- Toast 自身防抖, 短时间内只弹一次
...
</ul>`],reference:"/myKMS/interview/index#_3-前端批量请求失败toast重复弹窗怎么解决",source:"/myKMS/interview/index"},{id:46,question:"如何解决页面接口请求大规模并发问题",answer:[`- 请求去重（防抖 + 节流 + 队列）
...
<li>缓存</li>
<li>优化请求时机</li>
</ul>`],reference:"/myKMS/interview/index#_4-如何解决页面接口请求大规模并发问题",source:"/myKMS/interview/index"},{id:47,question:"渲染元素很多, 如何保证页面不卡顿?",answer:["核心思想是 **只渲染用户可见的部分**","解决思路：**减少一次性渲染的 DOM 数量 + 批量更新 + GPU 加速 + 异步渲染**",`- 虚拟列表（Virtual List）
...
<li>框架优化</li>
</ul>`],reference:"/myKMS/interview/index#_5-渲染元素很多-如何保证页面不卡顿",source:"/myKMS/interview/index"},{id:48,question:"前端低代码平台表单联动如何实现",answer:[`1. 解析依赖关系
2. 构建观察者 / 订阅机制
3. 动态执行规则`,`\`\`\`
formFields = [
...
<li>构建观察者 / 订阅机制</li>
<li>动态执行规则</li>
</ol>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::p25ea3nsulybsgxbqzczi::--><code>formFields = [
  { field: &#039;province&#039;, type: &#039;select&#039; },
  { field: &#039;city&#039;, type: &#039;select&#039;, dependsOn: &#039;province&#039;, compute: (state) =&gt; cities[state.province] }
]
...
</div>`],reference:"/myKMS/interview/index#_6-前端低代码平台表单联动如何实现",source:"/myKMS/interview/index"},{id:49,question:"想象一下，如果项目上线前一天，测试团队发现一个严重bug，但修复可能导致发布延期，你会如何处理？",answer:[`第一步：冷静评估 —— 判断问题的性质与影响范围
- 影响范围
- 复现条件
...
</ul>`],reference:"/myKMS/interview/index#_8-想象一下-如果项目上线前一天-测试团队发现一个严重bug-但修复可能导致发布延期-你会如何处理",source:"/myKMS/interview/index"},{id:50,question:"请分享一个你通过优化前端性能提升用户体验的案例，具体用了哪些技术手段",answer:[`- 路由级 按需加载
...
<li>渲染分级</li>
<li>骨架屏 + 异步渲染</li>
</ul>`,"<p>比如: 旧项目 webpackChunkName 设置不和导致code slipt 基本没效果, 根据项目实际重新配置 webpackChunkName</p>"],reference:"/myKMS/interview/index#_9-请分享一个你通过优化前端性能提升用户体验的案例-具体用了哪些技术手段",source:"/myKMS/interview/index"},{id:51,question:"想象一下，如果你的团队在开发过程中遇到第三方库的严重漏洞，你会如何处理",answer:[`1️⃣ 立即评估风险
- 确认漏洞影响范围
- 确定漏洞严重性`,`2️⃣ 暂时缓解方案
如果漏洞立即可被利用：
...
<li>替换或隔离高风险库</li>
<li>增强 CI/CD 安全管控</li>
</ul>`],reference:"/myKMS/interview/index#_10-想象一下-如果你的团队在开发过程中遇到第三方库的严重漏洞-你会如何处理",source:"/myKMS/interview/index"},{id:52,question:"请求竞态如何处理?",answer:["竞态往往导致了 UI 显示错误的旧数据",`1. 请求标识（requestId + 比对）
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::5x2p54e4n3xlwhk0c3p2x::--><code>let lastRequestId = 0;
...
</ol>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::4ot026wb0wtm673dls8a4p::--><code>useEffect(() =&gt; {
  let canceled = false;
...
<li>要么 忽略旧响应；</li>
<li>或者 让库帮你管理一致性。</li>
</ul>`],reference:"/myKMS/interview/index#_11-请求竞态如何处理",source:"/myKMS/interview/index"},{id:53,question:"实现 从详情页返回列表页保存上次加载的数据和自动还原上次的浏览位置。",answer:[`| 方案                | 实现原理                                                | 适用场景       |
| ----------------- | --------------------------------------------------- | ---------- |
...
</table>`,"<p>Vue 3 自带了<code> &lt;KeepAlive&gt;</code> 组件</p>","<p>react 实现 keep-alive</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::yzw3vfegdmxxptqg80jjh::--><code>// KeepAlive.jsx 
import { useRef } from &#039;react&#039;;
import { useLocation } from &#039;react-router-dom&#039;;
...
</div>`],reference:"/myKMS/interview/index#_12-实现-从详情页返回列表页保存上次加载的数据和自动还原上次的浏览位置。",source:"/myKMS/interview/index"},{id:54,question:"设计一套全站页面加载耗时统计工具",answer:[`- 实时/离线监控页面加载体验（首屏、交互、资源、网络等）。
- 支持 SPA + MPA、移动端与桌面端。
...
</ul>`,"<p>js sdk</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::f8sua02ggs7j7jjgq815le::--><code>// perf-sdk.js (浏览器端核心逻辑, 精简示例)
(function (window) {
  const APP = {};
  const SEND_URL = &#039;/beacon/perf&#039;;
  const BATCH_MAX = 20;
...
</div>`],reference:"/myKMS/interview/index#_13-设计一套全站页面加载耗时统计工具",source:"/myKMS/interview/index"},{id:55,question:"H5 如何解决移动端适配问题",answer:["HTML`<meta viewport>`标签告诉浏览器页面的“逻辑宽度”和缩放比例。",'`<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">`',"- `width=device-width`：逻辑宽度等于设备宽度；","- `initial-scale=1.0`：不缩放；","- 禁止用户缩放，避免布局错乱。","- 使用 rem 适配 ;","- 使用  vw/vh 适配"],answerHtml:["<p>HTML<code>&lt;meta viewport&gt;</code>标签告诉浏览器页面的“逻辑宽度”和缩放比例。</p>","<p><code>&lt;meta name=&quot;viewport&quot; content=&quot;width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no&quot;&gt;</code></p>",`<ul>
...
<li>使用  vw/vh 适配</li>
</ul>`],reference:"/myKMS/interview/index#_14-h5-如何解决移动端适配问题",source:"/myKMS/interview/index"},{id:56,question:"函数式编程",answer:["函数式编程是一种编程范式，它强调使用函数进行计算，尽量避免可变状态和副作用。",`- **函数是一等公民：函数可以像变量一样传递、返回、赋值。**
...
</table>`],reference:"/myKMS/interview/index#_15-函数式编程",source:"/myKMS/interview/index"},{id:57,question:"js如何统计长任务时间、长任务执行次数",answer:["**当主线程（Main Thread）执行某个任务超过 50ms**，它就被标记为一个 “Long Task”。",'浏览器提供了 PerformanceObserver 接口，监听类型为 "longtask" 的性能条目。',`\`\`\`
...
\`\`\``],answerHtml:["<p><strong>当主线程（Main Thread）执行某个任务超过 50ms</strong>，它就被标记为一个 “Long Task”。</p>","<p>浏览器提供了 PerformanceObserver 接口，监听类型为 &quot;longtask&quot; 的性能条目。</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::i36g4ij23a8lxraavzrhy::--><code>
let longTaskCount = 0;
let totalLongTaskTime = 0;
...
</div>`],reference:"/myKMS/interview/index#_16-js如何统计长任务时间、长任务执行次数",source:"/myKMS/interview/index"},{id:58,question:"如何禁止别人调试自己的前端页面代码?",answer:["- 代码混淆 & 压缩 (obfuscation / minification)","- 不提供／禁用 source-map 在生产环境",`- 检测 DevTools 或控制台开启并做限制
...
</ul>`],reference:"/myKMS/interview/index#_18-如何禁止别人调试自己的前端页面代码",source:"/myKMS/interview/index"},{id:59,question:"web 系统里面， 如何对图片进行优化？",answer:[`总体目标: **以 最小的文件体积、最快的加载速度、最好的视觉质量 呈现图片。**
...
</table>`,"<p><strong>“新格式、小体积、延迟加载、缓存稳、动态转。”</strong> 即：WebP/AVIF + 压缩 + LazyLoad + CDN + 缓存。</p>"],reference:"/myKMS/interview/index#_19-web-系统里面-如何对图片进行优化",source:"/myKMS/interview/index"},{id:60,question:"后端一次性返回树形结构数据，数据量非常大, 前端该如何处理？",answer:["**“只渲染用户当前可见的部分 + 按需加载或异步展开 + 高效数据结构存取”**",`| 目标       | 核心思路         | 实现方式                                |
| -------- | ------------ | ----------------------------------- |
...
</ul>`,"<p><strong>“懒加载、虚拟化、扁平存、分片渲、后台解。”</strong></p>"],reference:"/myKMS/interview/index#_20-后端一次性返回树形结构数据-数据量非常大-前端该如何处理",source:"/myKMS/interview/index"},{id:61,question:"你认为组件封装的一些基本准则是什么？",answer:[`组件封装的一些基本准则包括：
...
</ol>`],reference:"/myKMS/interview/index#_21-你认为组件封装的一些基本准则是什么",source:"/myKMS/interview/index"},{id:62,question:"组件升级怎么让使用这个组件的人都知道。",answer:[`- 语义化版本, 安装依赖自动升级
- 对接机器人, 群通知, 邮件通知
...
<li>文档更新</li>
<li>当面通知</li>
</ul>`],reference:"/myKMS/interview/index#_22-组件升级怎么让使用这个组件的人都知道。",source:"/myKMS/interview/index"},{id:63,question:"如果让你设计项目自动设计组件升级，并且安全，你会怎么去设计",answer:[`\`\`\`
...
\`\`\``],answerHtml:[`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::p2wmte0oicngnm12bfnr6e::--><code>
组件库发布
   │
   ├─ 生成 CHANGELOG
   ├─ 更新远程版本记录
...
</div>`],reference:"/myKMS/interview/index#_23-如果让你设计项目自动设计组件升级-并且安全-你会怎么去设计",source:"/myKMS/interview/index"},{id:64,question:"前端 sourcemap原理",answer:["在现代前端构建后变成浏览器可执行的 压缩/混淆后的 JS、CSS 文件,如果出错，根本找不到源文件对应的行。于是引入 Source Map（源码映射文件） 来解决这个问题。","Source Map: **它本质上是一个 JSON 文件，记录了编译后代码和原始源码之间的 映射关系。**",`| 字段名                | 含义                         |
| ------------------ | -------------------------- |
...
</ul>`],reference:"/myKMS/interview/index#_24-前端-sourcemap原理",source:"/myKMS/interview/index"},{id:65,question:"摘要和加密?",answer:[`| 概念                 | 功能                     | 可逆性       |
| ------------------ | ---------------------- | --------- |
...
</table>`],reference:"/myKMS/interview/index#_25-摘要和加密",source:"/myKMS/interview/index"},{id:66,question:"Web 无障碍性",answer:["Web 无障碍性（Accessibility） 指的是：让所有用户（包括视障、听障、行动不便者等）都能平等访问网站内容和功能。",`就是：
...
</table>`,`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::f0avwtmfwx7am4quairgb::--><code>// 模块表（缓存）
const modules = {};      // 模块名 -&gt; 导出对象
const factories = {};    // 模块名 -&gt; 模块定义函数
const loading = {};      // 模块名 -&gt; 是否正在加载中
...
</div>`,`<div class="language-scss"><button title="Copy Code" class="copy"></button><span class="lang">scss</span><pre><!--::markdown-it-async::d1fpvxertiihaq015m39a::--><code>require(&#039;main&#039;)
   │
   ├─▶ 检查缓存
   │
   ├─▶ 找到定义 (factory)
...
</table>`],reference:"/myKMS/interview/index#_29-monorepo",source:"/myKMS/interview/index"},{id:70,question:"很多web前端框架里面会有约定式路由， 他们是如何实现的",answer:["约定式路由（Convention over Configuration，CoC）是现代前端框架（如 Next.js、Nuxt.js、VitePress 等）广泛采用的路由实现方式，其核心思想是**根据文件目录结构自动生成路由配置，无需手动编写冗长的路由表**。",`核心原理:
...
</ul>`],reference:"/myKMS/interview/index#_30-很多web前端框架里面会有约定式路由-他们是如何实现的",source:"/myKMS/interview/index"},{id:71,question:"前端代码中有太多的if 如何处理?",answer:[`- 使用 映射表（对象字典）
...
</table>`,"<p>实践中采用 OpenSeadragon 库</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::hgtfosirp2gxk98cueeej::--><code> ┌─────────────────────────────┐
 │         大图瓦片浏览器         │
 │                             │
 │  ┌──────────────┐            │
 │  │视窗视口(Viewport)│  ← 仅渲染屏幕内的瓦片 │
...
<li>1 双层/多层覆盖
<ul>
<li>先画低层 L(k+1) 覆盖整个视口（快速）</li>
<li>再逐块画当前层 L(k)（清晰）</li>
<li>低层瓦片不删，直到高清瓦片到齐</li>
<li>这样用户不会看到“空洞”。</li>
</ul>
</li>
</ul>`,`<ul>
<li>2 缓存（必做）
<ul>
<li>内存 LRU 缓存：最近看过的瓦片保留</li>
<li>并发控制：同一时间最多 N 个请求</li>
<li>取消过期请求：用户飞快拖动时，旧视口的请求回来要丢弃</li>
</ul>
</li>
</ul>`,`<ul>
<li>5.3 预取（体验加分）
<ul>
<li>预取视口周围一圈瓦片（扩大 rect）</li>
<li>放大时提前取更高一层中心区域</li>
</ul>
</li>
</ul>`],reference:"/myKMS/interview/index#_32-大图片瓦片机制",source:"/myKMS/interview/index"},{id:73,question:"vue 编译到小程序等原理",answer:["Vue 本身是一个 前端框架，它的运行环境是浏览器，依赖 DOM API。小程序环境（如微信小程序）是 非浏览器环境，没有 DOM，取而代之的是 小程序的组件体系（如 view, text, image 等）和 小程序 JS 运行环境（WXML + WXSS + JS）。","核心原理:",`1. 模板编译
...
</table>`],reference:"/myKMS/knowledge/base/css#_6-href-和-src",source:"/myKMS/knowledge/base/css"},{id:76,question:"JS 闭包，如何理解",answer:[`什么是闭包？
...
</ul>`,"<p>闭包本质上是：<strong>函数 + 其定义时的词法作用域（作用域链的引用）</strong></p>"],reference:"/myKMS/knowledge/base/js#_1-js-闭包-如何理解",source:"/myKMS/knowledge/base/js"},{id:77,question:"描述 Event Loop 运行机制",answer:[`1. 背景
...
- next task`,`不是每轮事件循环都渲染
- 浏览器一般按屏幕刷新率（比如 60Hz）渲染：
- 每 ~16.7ms 最多渲染一次
如果这一轮没有视觉更新、或还没到帧时间点，就可能跳过 render`,"**同步先执行，异步分队列；先宏后微，再渲染。**","Node.js：","- **process.nextTick 优先级高于 Promise 微任务**","```\n[宏任务/事件] → [微任务] → [rAF 回调] → [样式计算/布局/合成/绘制] → [空闲回调/下一轮]\n```","在 rAF 中写样式/改 DOM，浏览器会在同一帧随后进行样式计算与绘制。"],answerHtml:[`<ol>
<li>背景
JavaScript 是 单线程 的：同一时刻只能执行一个任务。但浏览器/Node 需要同时处理用户输入、网络请求、定时器、渲染等。
...
<li>渲染（浏览器）<strong>渲染永远在微任务之后</strong></li>
<li>开始下一轮循环</li>
</ul>`,"<p>顺序可认为是：</p>",`<ul>
<li>task</li>
<li>microtasks</li>
<li>rAF callbacks</li>
<li>render (layout/paint/composite)</li>
<li>next task</li>
</ul>`,`<p>不是每轮事件循环都渲染</p>
<ul>
<li>浏览器一般按屏幕刷新率（比如 60Hz）渲染：</li>
<li>每 ~16.7ms 最多渲染一次
如果这一轮没有视觉更新、或还没到帧时间点，就可能跳过 render</li>
</ul>`,"<p><strong>同步先执行，异步分队列；先宏后微，再渲染。</strong></p>","<p>Node.js：</p>",`<ul>
<li><strong>process.nextTick 优先级高于 Promise 微任务</strong></li>
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::6gdeexffjpbsec4scjemgl::--><code>[宏任务/事件] → [微任务] → [rAF 回调] → [样式计算/布局/合成/绘制] → [空闲回调/下一轮]</code></pre>
</div>`,"<p>在 rAF 中写样式/改 DOM，浏览器会在同一帧随后进行样式计算与绘制。</p>"],reference:"/myKMS/knowledge/base/js#_2-描述-event-loop-运行机制",source:"/myKMS/knowledge/base/js"},{id:78,question:"网页多标签页之间如何通讯？和 iframe 如何通讯？",answer:["| 特性        | `BroadcastChannel` | `localStorage` + `storage` 事件 | `postMessage` + iframe / worker |\n| --------- | ------------------ | ----------------------------- | ------------------------------- |\n| 是否需要刷新    | 否                  | 否                             | 否                               |\n| 是否支持多 Tab | ✅                  | ✅                             | 部分（需要 iframe/worker）            |\n| 是否易用      | ✅（直接发送消息）          | 中等（需要 JSON 序列化）               | 较复杂（需建立通道）                      |\n| 是否跨域      | ❌（只能同源）            | ❌                             | 可跨域（需正确设置 targetOrigin）         |\n| 性能        | 较好                 | 一般（依赖 storage 事件）             | 较好                              |"],answerHtml:[`<table tabindex="0">
<thead>
<tr>
<th>特性</th>
...
</table>`],reference:"/myKMS/knowledge/base/js#_3-网页多标签页之间如何通讯-和-iframe-如何通讯",source:"/myKMS/knowledge/base/js"},{id:79,question:"前端常见的设计模式有哪些？以及应用场景",answer:[`| 模式类型     | 设计模式              | 定义 / 核心思想                | 前端典型应用场景                               |
| -------- | ----------------- | ------------------------ | -------------------------------------- |
...
</table>`],reference:"/myKMS/knowledge/base/js#_4-前端常见的设计模式有哪些-以及应用场景",source:"/myKMS/knowledge/base/js"},{id:80,question:"从 0 搭建一个前端项目，需要考虑哪些方面",answer:["主要是框架/库, 工具链 和cicd 选择",`- 技术选型：框架、状态管理、工具链、UI 组件库
...
</ul>`],reference:"/myKMS/knowledge/base/js#_6-从-0-搭建一个前端项目-需要考虑哪些方面",source:"/myKMS/knowledge/base/js"},{id:81,question:"ajax 并发请求控制",answer:[`\`\`\`
...
\`\`\``],answerHtml:[`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::sz1y3epebhl1kbyr3g8q9t::--><code>async function batchRequestAllSettled(tasks, batchSize = 5) {
  const results = []
...
</div>`],reference:"/myKMS/knowledge/base/js#_7-ajax-并发请求控制",source:"/myKMS/knowledge/base/js"},{id:82,question:"线上出了严重 bug 你该如何解决？",answer:["**先止损 → 再排查 → 然后修复 → 最后复盘防再发**",`- 第一要务: **回滚，及时止损**
...
<li>在本地或测试环境复现 bug，查找原因</li>
<li>修复，测试，重新上线</li>
<li>开<strong>复盘会议</strong>，以后如何规避此类问题 —— 总结经验教训</li>
</ul>`],reference:"/myKMS/knowledge/base/js#_8-线上出了严重-bug-你该如何解决",source:"/myKMS/knowledge/base/js"},{id:83,question:"你如何保障代码质量？",answer:[`- 配置统一的 eslint 和 prettier 规则，规范代码格式
- 尽量组织 code review
...
</ul>`],reference:"/myKMS/knowledge/base/js#_9-你如何保障代码质量",source:"/myKMS/knowledge/base/js"},{id:84,question:"esm 与 CommonJS 的循环引用",answer:[`- CommonJS 模块规范在遇到循环引用时,Node 会返回当前已执行部分的 exports 对象.(Node 通过 require.cache 缓存机制避免了无限递归)
...
</ul>`],reference:"/myKMS/knowledge/base/js#_10-esm-与-commonjs-的循环引用",source:"/myKMS/knowledge/base/js"},{id:85,question:"esm 中 import 会发生什么?",answer:["ES Module (ESM) 的 import 是编译期就确定依赖关系;ESM 默认是 严格模式，并且是 异步加载",`**解析阶段（Parsing）=> 加载阶段 => 实例化阶段 => 执行阶段 => 缓存**    
...
</ul>`,"<p>import 导入的变量是 活引用（live binding），不是拷贝。</p>",`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::c59fh1ivrrppdjixl22tv::--><code>// counter.js
export let count = 0;
export function inc() { count++; }
...
</div>`],reference:"/myKMS/knowledge/base/js#_11-esm-中-import-会发生什么",source:"/myKMS/knowledge/base/js"},{id:86,question:"在 JS 代码中避免内存泄漏的方法?",answer:[`1. 释放不再需要的引用(把对象置 null 或者移除属性，就能让 GC 正常回收。)
2. 避免全局变量
...
<li>按需加载数据</li>
<li>及时释放 DOM 引用</li>
</ol>`],reference:"/myKMS/knowledge/base/js#_12-在-js-代码中避免内存泄漏的方法",source:"/myKMS/knowledge/base/js"},{id:87,question:"es6 “继承在前，实例在后”?",answer:[`- new 子类发生什么: 创建子类实例对象 => 设置原型 => 父类构造函数执行  => 调用子类构造函数 => 子类构造函数继续执行
...
</ul>`],reference:"/myKMS/knowledge/base/js#_13-es6-继承在前-实例在后",source:"/myKMS/knowledge/base/js"},{id:88,question:'script type="module" 是什么效果?',answer:['- `<script type="module">` 会 异步下载和解析，等 HTML 解析完成后执行，按依赖顺序执行模块代码，类似加了 defer 的普通脚本，但支持模块化特性。\n- `<script type="module" async>` 异步,下载完成立即执行,不保证顺序 (适合独立模块，不依赖 DOM，也不依赖其他模块执行顺序，比如统计脚本或广告脚本。)'],answerHtml:[`<ul>
...
</ul>`],reference:"/myKMS/knowledge/base/js#_14-script-type-module-是什么效果",source:"/myKMS/knowledge/base/js"},{id:89,question:"文件的软链接与硬链接?",answer:[`- 硬链接 = 同一份文件的不同名字, 删除源文件,不影响数据，数据依然可访问,
...
</ul>`],reference:"/myKMS/knowledge/base/js#_15-文件的软链接与硬链接",source:"/myKMS/knowledge/base/js"},{id:90,question:"js 原型链, 作用是什么?",answer:[`- 原型链？
...
</ul>`,"<p>原型链是 JS 实现继承的机制，通过逐层查找 [[Prototype]] 来实现属性/方法共享和复用。</p>"],reference:"/myKMS/knowledge/base/js#_16-js-原型链-作用是什么",source:"/myKMS/knowledge/base/js"},{id:91,question:"web components",answer:[`Web Components 是一套 浏览器原生的前端组件技术标准，让开发者能创建可复用、封装、独立于框架的组件
...
</ul>`],reference:"/myKMS/knowledge/base/js#_17-web-components",source:"/myKMS/knowledge/base/js"},{id:92,question:"ts 类型推断原理？",answer:["类型推断（Type Inference）指的是 —— 当开发者没有显式标注类型时，TypeScript 编译器自动根据上下文推导变量、参数、函数返回值的类型",`TypeScript 在编译阶段会：
- 扫描变量声明、赋值、函数签名、返回值；
...
<li>安全重构 / 版本演进</li>
<li>智能提示和自文档化</li>
</ul>`],reference:"/myKMS/knowledge/base/js#_18-ts-类型推断原理",source:"/myKMS/knowledge/base/js"},{id:93,question:"Canvas 与 SVG",answer:[`| 特性         | Canvas                                        | SVG                                 |
| ---------- | --------------------------------------------- | ----------------------------------- |
...
</table>`],reference:"/myKMS/knowledge/base/js#_20-git-pull-与-git-fetch",source:"/myKMS/knowledge/base/js"},{id:95,question:"git merge 与 git rebase",answer:[`| 对比项          | \`git merge\`              | \`git rebase\`                  |
| ------------ | ------------------------ | ----------------------------- |
...
</table>`],reference:"/myKMS/knowledge/base/js#_21-git-merge-与-git-rebase",source:"/myKMS/knowledge/base/js"},{id:96,question:"Node 中 require 时发生了什么?",answer:["路径解析 => 缓存检查 => 创建模块对象 => 读取与编译 => 执行模块代码 => 标记完成并返回",`require() 缓存检查顺序：
   - 1. 检查原生模块缓存; 
...
</ul>`],reference:"/myKMS/knowledge/base/nodejs#_1-node-中-require-时发生了什么",source:"/myKMS/knowledge/base/nodejs"},{id:97,question:"Node.js 事件循环机制",answer:[`六个阶段: 
...
</ol>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::lcrq0wongzol5ioh4m7968::--><code>每个阶段的宏任务执行完 →
    执行所有 nextTick 回调 →
    执行所有微任务 (Promise)
→ 进入下一个阶段</code></pre>
...
</ul>`],reference:"/myKMS/knowledge/base/nodejs#_2-node-js-事件循环机制",source:"/myKMS/knowledge/base/nodejs"},{id:98,question:"process.nextTick 与 setTimeout 的区别",answer:[`- process.nextTick 在当前事件循环结束时执行
...
</ul>`],reference:"/myKMS/knowledge/base/nodejs#_3-process-nexttick-与-settimeout-的区别",source:"/myKMS/knowledge/base/nodejs"},{id:99,question:"Koa 与 Express 的区别",answer:["1. 中间件机制",`- Express：单向流动，中间件通过 next() 线性执行，一旦响应结束就不能修改
...
</ul>`],reference:"/myKMS/knowledge/base/nodejs#_4-koa-与-express-的区别",source:"/myKMS/knowledge/base/nodejs"},{id:100,question:"JWT 如何自动更新 token",answer:[`采用JWT 双 Token 模式：Access Token + Refresh Token
| 类型                | 作用                  | 有效期          | 存储位置                          |
| ----------------- | ------------------- | ------------ | ----------------------------- |
...
</ol>`],reference:"/myKMS/knowledge/base/nodejs#_5-jwt-如何自动更新-token",source:"/myKMS/knowledge/base/nodejs"},{id:101,question:"扫描登录如何实现?",answer:["PC浏览器 <———> 服务器 <———> 手机App",`- 浏览器打开登录页
    - 前端请求后端生成一个 唯一的登录二维码
...
</ul>`],reference:"/myKMS/knowledge/base/nodejs#_6-扫描登录如何实现",source:"/myKMS/knowledge/base/nodejs"},{id:102,question:"http2的首部压缩",answer:[`- 为什么要压缩首部？
...
</table>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::n0eh84eh2aihf0e6i6ma3c::--><code>客户端 (Client)                             服务器 (Server)
------------------                          ------------------
...
谁主动关闭，谁就经历 TIME_WAIT。</p>`],reference:"/myKMS/knowledge/browser/http#_2-tcp-断开4次挥手",source:"/myKMS/knowledge/browser/http"},{id:104,question:"什么是队头阻塞",answer:["队头阻塞就是“队列第一个请求卡住，后面全被拖延”。HTTP/3 通过 QUIC 彻底缓解了这个问题。"],answerHtml:["<p>队头阻塞就是“队列第一个请求卡住，后面全被拖延”。HTTP/3 通过 QUIC 彻底缓解了这个问题。</p>"],reference:"/myKMS/knowledge/browser/http#_3-什么是队头阻塞",source:"/myKMS/knowledge/browser/http"},{id:105,question:"http 2 多路复用",answer:["HTTP/1.1 每个请求都必须建立在一个 TCP 连接上。虽然它支持“Keep-Alive”长连接，但仍然有两个性能瓶颈：",`- 队头阻塞（Head-of-Line Blocking）: 一个连接中，请求是串行执行的。前一个响应没回来，后面的请求必须等。
...
假设浏览器要加载三个资源：</p>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::c0fz0wyy31q5s0jgtt110e::--><code>index.html
style.css
main.js
</code></pre>
</div>`,"<p>HTTP/1.1：</p>",`<ul>
...
</ul>`,"<p>DNS 通常使用 UDP 53 端口（查询），TCP 用于传输大数据量（如区域传送）。</p>","<p>每条 DNS 记录都有一个 TTL（Time To Live） 值，比如 300 秒。</p>"],reference:"/myKMS/knowledge/browser/http#_5-dns-协议",source:"/myKMS/knowledge/browser/http"},{id:107,question:"html script defer 与async",answer:[`| 特性             | \`<script async> \`                                          | \`<script defer>\`                                                    |
| ---------------- | -------------------------------------------------------- | ------------------------------------------------------------------ |
...
</table>`],reference:"/myKMS/knowledge/browser/http#_6-html-script-defer-与async",source:"/myKMS/knowledge/browser/http"},{id:108,question:"HTTP/3",answer:["**HTTP/3 = HTTP/2 + QUIC(UDP)**","HTTP/3 是继 HTTP/2 之后的下一代超文本传输协议。它的核心变化是：**不再基于 TCP，而是基于 QUIC（UDP 之上的新协议）。**",`| 协议           | 传输层           | 特点            | 存在问题           |
| ------------ | ------------- | ------------- | -------------- |
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::wy8rvszka3n1yfkiizifc1::--><code>// HTTP/2
HTTP/2
  ↓
  TLS
  ↓
...
</div>`],reference:"/myKMS/knowledge/browser/http#_7-http-3",source:"/myKMS/knowledge/browser/http"},{id:109,question:"nginx proxy_pass 与location 结尾加不加 / 对路径的影响",answer:["**尾斜杠“决定路径拼接规则”** ,location 和 proxy_pass 的结尾 是否带 /，直接决定了 Nginx 如何拼接请求路径。","proxy_pass 加不加 /:",`- 不加 /：location 匹配的路径会被完整拼接到 proxy_pass 地址后（适合后端接口路径与前端请求路径完全一致的场景）。
...
</ol>`,`<div class="language-nginx"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre><!--::markdown-it-async::xu71otewjiil7tm6o9zwxk::--><code>http {
    # 开发环境（域名区分）
    server {
        listen 80;
        server_name dev.example.com;  # 开发环境域名
...
</div>`,"<p>同域名不同路径映射的重写问题及解决方案</p>","<p>当多个前端应用部署在同一域名的不同路径下（如 example.com/app1、example.com/app2），需要解决路径映射和资源引用的问题。</p>",`<div class="language-nginx"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre><!--::markdown-it-async::rm5lpn05ph4432x8hnjrl::--><code>server {
    listen 80;
    server_name example.com;
    root /var/www;  # 父目录
...
</ul>`],reference:"/myKMS/knowledge/browser/http#_10-websocket",source:"/myKMS/knowledge/browser/http"},{id:112,question:"短轮询、长轮询、SSE 和 WebSocket",answer:[`| 特性   | 短轮询    | 长轮询      | SSE                     | WebSocket        |
| ---- | ------ | -------- | ----------------------- | ---------------- |
...
</ul>`],reference:"/myKMS/knowledge/browser/http#_11-短轮询、长轮询、sse-和-websocket",source:"/myKMS/knowledge/browser/http"},{id:113,question:"TCP 和 UDP",answer:[`| 维度          | **TCP**                             | **UDP**                                 |
| ----------- | ----------------------------------- | --------------------------------------- |
...
</table>`],reference:"/myKMS/knowledge/browser/http#_12-osi-七层模型-tcp-ip-四层模型",source:"/myKMS/knowledge/browser/http"},{id:115,question:"常见的性能指标",answer:["Performance API 是浏览器提供的内置接口，用于测量网页的加载时间、资源性能和用户体验。","常见性能指标",`- FP (First Paint)首次绘制 ，指用户第一次看到页面内容时的时间点（通常是背景颜色）。
...
</ul>`],reference:"/myKMS/knowledge/browser/index#_1-常见的性能指标",source:"/myKMS/knowledge/browser/index"},{id:116,question:"sourcemap 有何作用",answer:["Source Map 是一种将压缩、混淆后的代码映射回源代码的文件，用于调试和定位错误。它的主要作用如下：",`- 调试优化 ：在开发者工具中看到源代码而非压缩后的代码。
- 错误定位 ：在生产环境中准确定位代码错误。
...
</ul>`],reference:"/myKMS/knowledge/browser/index#_2-sourcemap-有何作用",source:"/myKMS/knowledge/browser/index"},{id:117,question:"什么是 HTTPS 中间人攻击，如何预防",answer:["中间人攻击（MITM, Man-In-The-Middle） 是指攻击者拦截客户端与服务器之间的通信，获取敏感信息或篡改数据。","攻击原理","攻击者通过伪造证书或劫持网络流量，冒充服务器或客户端，使通信双方无法察觉中间人的存在。","常见攻击手段",`| 攻击方式                  | 描述                          |
| --------------------- | --------------------------- |
...
</table>`,"<p>cookies, sessionStorage, localStorage, 只能存字符串</p>"],reference:"/myKMS/knowledge/browser/index#_6-indexeddb-可以存什么类型的数据",source:"/myKMS/knowledge/browser/index"},{id:121,question:"常见的图片格式 和特点",answer:[`| 类型                      | 定义                                   |
| ----------------------- | ------------------------------------ |
...
</table>`],reference:"/myKMS/knowledge/browser/index#_7-常见的图片格式-和特点",source:"/myKMS/knowledge/browser/index"},{id:122,question:"react尽量不要再内部定义组件",answer:[`\`\`\`jsx
function App() {
...
\`\`\``,"🔴 每次点击按钮，Child 都会重新挂载，副作用也会重新执行。","当父组件内部定义子组件时，每次父组件 render 都会创建一个新的函数对象。React 看到“类型变了”，认为它是一个全新的组件。结果：子组件每次都会被卸载并重新挂载。**可以使用 useCallback 优化**",`- 什么时候可以在内部定义组件?
  - 组件依赖父组件的闭包变量
  - 性能无关的小组件
  - 需要动态生成组件类型`],answerHtml:[`<div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre><!--::markdown-it-async::ifl4950mfq80d84usf3394s::--><code>function App() {
  const [count, setCount] = useState(0);
...
这种机制保证了 按需更新：只重渲染真正消费 Context 的组件，提高性能。在并发模式下，React 还为每个渲染器维护独立的 currentValue，确保多根树或并发渲染时 Context 值一致。为了避免无效更新，应尽量拆分 Context、用 useMemo 缓存 value，并让消费组件保持细粒度。`,"**setState → Provider 重新 render → 检测到 context value 改变 → 遍历 Fiber 树 + 依赖链，标记相关消费者 → 在这次渲染里重新执行这些组件函数。**"],answerHtml:["<p><strong>React 内部是 精确追踪哪些 Fiber 消费了 Context。</strong></p>",`<p><strong>React 的 Context 依赖 Fiber 树 + 依赖收集机制：</strong></p>
<ol>
...
创建 Context 后，Provider 会把 value 写入 Context 对象；组件调用 useContext 时，Fiber 会读取最近的 Provider 的值，并在 Fiber 上记录对该 Context 的依赖。当 Provider 的 value 变化时，React 会标记并调度所有依赖该 Context 的 Fiber 重新渲染，其它未使用 useContext 的组件不会更新。
这种机制保证了 按需更新：只重渲染真正消费 Context 的组件，提高性能。在并发模式下，React 还为每个渲染器维护独立的 currentValue，确保多根树或并发渲染时 Context 值一致。为了避免无效更新，应尽量拆分 Context、用 useMemo 缓存 value，并让消费组件保持细粒度。</p>`,"<p><strong>setState → Provider 重新 render → 检测到 context value 改变 → 遍历 Fiber 树 + 依赖链，标记相关消费者 → 在这次渲染里重新执行这些组件函数。</strong></p>"],reference:"/myKMS/knowledge/framework/react#_2-为什么修改-context-后-只有usecontext-的组件才会重新渲染",source:"/myKMS/knowledge/framework/react"},{id:124,question:"React.memo 原理是啥",answer:["**React.memo 是一个高阶组件（HOC），用于优化函数组件的渲染性能。它的核心原理是通过记忆（Memoization）组件的渲染结果，在 props 未变化时跳过重新渲染，直接返回上一次的渲染结果。**",`\`\`\`jsx
// React.memo 的简化实现逻辑
...
- 支持自定义比较，通过第二个参数实现更精细的控制`],answerHtml:["<p><strong>React.memo 是一个高阶组件（HOC），用于优化函数组件的渲染性能。它的核心原理是通过记忆（Memoization）组件的渲染结果，在 props 未变化时跳过重新渲染，直接返回上一次的渲染结果。</strong></p>",`<div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre><!--::markdown-it-async::11y8kv5g6cpftj2zn9tzdf::--><code>// React.memo 的简化实现逻辑
function memo(Component, arePropsEqual) {
  let lastProps = null;
  let lastResult = null;
...
- 启用 ESLint 规则自动检测
- 使用函数式更新避免依赖状态值`],answerHtml:["<p>表现:缺少依赖导致过时闭包</p>",`<div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre><!--::markdown-it-async::58dn0ts00f5ypl9380ptl::--><code>function Timer() {
  const [count, setCount] = useState(0);
...
\`\`\``,"useLayoutEffect：在“本轮任务内、渲染前”执行（同步，阻塞 paint）。","useEffect：在“本轮渲染后、下一轮任务中”执行（异步，不阻塞 paint）。"],answerHtml:["<p><strong>调用时机不同</strong> 会直接影响 UI 渲染顺序和性能</p>",`<table tabindex="0">
<thead>
<tr>
<th>Hook</th>
<th>调用时机</th>
...
比如：读取 DOM 布局信息（测量元素大小）;需要在绘制前同步修改 DOM 样式（避免闪烁)</p>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::8ccgt18q4wyo68wqu3jdpd::--><code>Render 阶段（计算虚拟 DOM）
        ↓
DOM 更新（Commit 阶段）
        ↓
useLayoutEffect（同步执行） 👈 页面还没绘制
...
把原本递归的更新过程变成可中断的循环（迭代），并用一个 Fiber 数据结构 表示组件树中的每个节点。
每个 Fiber 节点本质上是一个 JS 对象.对应一个 React element.</p>`,`<div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre><!--::markdown-it-async::9yv44nxvx1w3rfc0e5m0xj::--><code>type Fiber = {
  type: any,             // 组件类型（函数/类/DOM标签）
  stateNode: any,        // 对应的DOM实例或类组件实例
  child: Fiber | null,   // 第一个子Fiber
  sibling: Fiber | null, // 下一个兄弟Fiber
...
React 通过 Lane 模型 管理任务优先级</p>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::36n2cn5iiiblzlkm60wgx::--><code>  // 优先级从高到低
ImmediatePriority（用户输入）
UserBlockingPriority（悬停、点击）
NormalPriority（数据请求）
LowPriority（分析日志）
...
- React 生命周期函数
- React 18+ 的自动批处理增强 React 18 引入 createRoot 后，即使在异步操作（如 setTimeout(同一个 callback 的同步执行阶段)、Promise、原生事件回调）中的更新也会自动批处理：`,"绕过批处理的场景:",`- React 17 及之前的异步代码 在 setTimeout、Promise 或原生事件回调中的更新默认不会批处理，每次 setState 触发一次渲染：
...
<li>React 生命周期函数</li>
<li>React 18+ 的自动批处理增强 React 18 引入 createRoot 后，即使在异步操作（如 setTimeout(同一个 callback 的同步执行阶段)、Promise、原生事件回调）中的更新也会自动批处理：</li>
</ul>`,"<p>绕过批处理的场景:</p>",`<ul>
...
</ul>`,"<p>👉 Concurrent Rendering（并发渲染） 就是 React Fiber 在 16 以后引入的核心能力，真正实现在 渲染过程中可以打断、暂停、恢复、丢弃。</p>","<p>旧:</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::caye94otvooftrcj0hinp::--><code>update → render → commit
         (整棵树一次性调和)</code></pre>
</div>`,"<p>新:</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::7qkcchyrh7e7w46ttbzjae::--><code>update → render(可被打断、分段) → commit(同步)</code></pre>
</div>`,`<ul>
...
</ul>`,"<p>在 Fiber 节点上，每个函数组件会维护一个 <strong>Hook 链表</strong>：</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::wx9dwp7x76fxy285ejwtpl::--><code>type Hook = {
  memoizedState: any,        // 保存副作用依赖数组
  next: Hook | null          // 指向下一个 Hook
}
...
首次渲染是完整构建 Fiber 树并创建 DOM，更新时只计算需要变更的部分。
在 React18 并发模式下，Render 阶段可被打断以保证用户交互优先，Commit 阶段始终同步执行</p>`,`<table tabindex="0">
<thead>
<tr>
<th>Hook</th>
<th>调用 <code>useXxx()</code> 本身</th>
<th>你传进去的回调/计算在什么时候跑？</th>
<th>属于哪个阶段</th>
</tr>
</thead>
<tbody>
...
<td>渲染阶段调用</td>
<td>没有额外回调，<code>setState</code> 只是排队更新，下次渲染时用新 state</td>
<td><strong>渲染阶段</strong></td>
</tr>
<tr>
<td><code>useRef</code></td>
<td>渲染阶段调用</td>
<td>没有异步回调，返回的 ref 对象在 render/commit 都可读写</td>
<td>主要是 <strong>渲染阶段</strong> 初始化</td>
</tr>
<tr>
<td><code>useMemo</code></td>
<td>渲染阶段调用</td>
<td>计算函数在渲染阶段执行（依赖变才重算），必须纯函数</td>
<td><strong>渲染阶段</strong></td>
</tr>
<tr>
<td><code>useCallback</code></td>
<td>渲染阶段调用</td>
<td>只是把函数包起来做依赖比较，没有额外时机</td>
<td><strong>渲染阶段</strong></td>
</tr>
<tr>
<td><code>useLayoutEffect</code></td>
<td>渲染阶段注册</td>
<td>cleanup + effect 回调在 <strong>commit 阶段，同步执行，DOM 更新后、paint 前</strong></td>
<td><strong>提交阶段（layout/pointer 前）</strong></td>
</tr>
<tr>
<td><code>useEffect</code></td>
<td>渲染阶段注册</td>
<td>cleanup + effect 回调在 <strong>commit 之后的“被动 effect 阶段”，异步执行，不阻塞 paint</strong></td>
<td><strong>提交之后（异步 passive 阶段）</strong></td>
</tr>
</tbody>
</table>`],reference:"/myKMS/knowledge/framework/react#_20-react-组件渲染和更新的全过程",source:"/myKMS/knowledge/framework/react"},{id:142,question:"React 优化",answer:[`1. React.memo：对于函数组件，React.memo 可以避免不必要的重新渲染。当组件的 props 没有变化时，React 会跳过重新渲染过程。
...
<li>图片懒加载</li>
</ol>`],reference:"/myKMS/knowledge/framework/react#_21-react-优化",source:"/myKMS/knowledge/framework/react"},{id:143,question:"React 时间线",answer:[`\`\`\`js
...
\`\`\``],answerHtml:[`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::anl860414sb9lsk96qvlsg::--><code>
function Demo() {
  const [count, setCount] = useState(0)
...
</div>`,`<div class="language-txt"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre><!--::markdown-it-async::jx7692uh6dm1ntedy42jco::--><code>┌─────────────── 一次“点击触发更新”的完整时间线 ───────────────┐
...
</div>`],reference:"/myKMS/knowledge/framework/react#_22-react-时间线",source:"/myKMS/knowledge/framework/react"},{id:144,question:"在 React 应用中如何排查性能问题?",answer:[`1. 浏览器层面（渲染、网络、JS 执行)
...
</ol>`],reference:"/myKMS/knowledge/framework/react#_23-在-react-应用中如何排查性能问题",source:"/myKMS/knowledge/framework/react"},{id:145,question:"useTransition useDeferredValue debounce 对比与原理",answer:[`| 特性            | \`useTransition\`                     | \`useDeferredValue\`            | 防抖（Debounce）             |
| ------------- | ----------------------------------- | ----------------------------- | ------------------------ |
...
</table>`],reference:"/myKMS/knowledge/framework/react#_24-usetransition-usedeferredvalue-debounce-对比与原理",source:"/myKMS/knowledge/framework/react"},{id:146,question:"react suspence 与 lazy() 底层实现原理是什么?",answer:["**React.lazy 的底层是让组件在未加载时 抛出一个 Promise，而 Suspense 则在 Fiber 渲染时捕获这个 Promise，挂起渲染并显示 fallback，等 Promise resolve 后恢复渲染。**","Suspense 作用:用于在子树中捕获“未就绪状态”，显示一个 fallback UI（比如 loading）。;与 ErrorBoundary 类似，只不过它捕获的是 **“Promise 挂起”。**","React.lazy 把动态加载的组件封装成一个“会在未加载时抛出 Promise”的特殊组件。","Suspense 作为“捕手”，在渲染子树时捕获这个 Promise，展示 fallback，并在 Promise resolve 后再重新渲染。","Suspense,底层原理:",`- 渲染子组件时，如果子组件内部调用 lazy 还没 resolve，就会抛出一个 Promise。
...
</ul>`],reference:"/myKMS/knowledge/framework/react#_25-react-suspence-与-lazy-底层实现原理是什么",source:"/myKMS/knowledge/framework/react"},{id:147,question:"react 如何实现国际化",answer:["i18n 实现国际化","1. 动态语言切换 + 按需加载",`- 动态import+映射表,页面级组件在useEffect或路由加载时调用i18n.addResources(),减少初始打包体积，提高首屏加载速度, 使用缓存(localStorage / IndexedDB)
...
</ol>`],reference:"/myKMS/knowledge/framework/react#_26-react-如何实现国际化",source:"/myKMS/knowledge/framework/react"},{id:148,question:"自己写的hooks",answer:[`- 简单的 useLocalStorage; 
...
</ul>`],reference:"/myKMS/knowledge/framework/react#_27-自己写的hooks",source:"/myKMS/knowledge/framework/react"},{id:149,question:"Redux Toolkit",answer:["1. createSlice 内部用 Immer，允许你写“可变写法”，但底层会生成不可变的新 state。",`2. createAsyncThunk 内部是如何工作的？
...
</ul>`],reference:"/myKMS/knowledge/framework/react#_28-redux-toolkit",source:"/myKMS/knowledge/framework/react"},{id:150,question:"react usestate usereducer useref useeffece 原理",answer:["环形队列就是：链表的最后一个节点的 next 指针 指向头节点，形成一个环。",`- useState 的原理
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::gocuchd29hvyngx65rou6::--><code>function useState(initialState) {
    return useReducer((state, action) =&gt; {
        return typeof action === &#039;function&#039; ? action(state) : action;
    }, initialState);
}</code></pre>
...
</ul>`],reference:"/myKMS/knowledge/framework/react#_29-react-usestate-usereducer-useref-useeffece-原理",source:"/myKMS/knowledge/framework/react"},{id:151,question:"react useEffect 依赖项为数据或者对象, 如何处理",answer:["当 useEffect 的依赖项是数组或对象时，你可能会遇到一个陷阱：useEffect 会在每次组件重新渲染时都执行，即使数组或对象的内容“看起来”没有变化.","React 组件每次重新渲染时，在函数体内部定义的对象或数组都会被重新创建一个新的实例。比较时Object.is 始终为false,因此 effect 会重新执行",`方案一：解构原始值 (Destructuring Primitives)
...
在 React 中，你写的每一段 JSX 标签都会被转译成一个 React.createElement(component, props, ...children) 函数调用
这个函数调用的返回值是一个 JavaScript 对象（用来描述你想要创建的 UI，也就是 React 元素或“虚拟 DOM”节点）</p>`],reference:"/myKMS/knowledge/framework/react#_31-jsx-为什么只允许有一个父节点",source:"/myKMS/knowledge/framework/react"},{id:153,question:"react  函数式组件 setSate 会发生什么",answer:["在 React 函数组件里调用 setState 会向当前 hook 的更新队列推入一个更新，并通过调度器批量安排一次重渲染；在下一次 render 阶段，React 会重新执行组件函数，用队列里的所有更新计算出新的 state，生成新的虚拟 DOM，再在 commit 阶段对真实 DOM 做 diff 更新，同时触发对应的 effect，所以当前 render 中的 state 不会立刻变化，变化只会体现在下一次渲染里。"],answerHtml:["<p>在 React 函数组件里调用 setState 会向当前 hook 的更新队列推入一个更新，并通过调度器批量安排一次重渲染；在下一次 render 阶段，React 会重新执行组件函数，用队列里的所有更新计算出新的 state，生成新的虚拟 DOM，再在 commit 阶段对真实 DOM 做 diff 更新，同时触发对应的 effect，所以当前 render 中的 state 不会立刻变化，变化只会体现在下一次渲染里。</p>"],reference:"/myKMS/knowledge/framework/react#_32-react-函数式组件-setsate-会发生什么",source:"/myKMS/knowledge/framework/react"},{id:154,question:"Webpack 的工作流程",answer:["Webpack 的工作流程",`- 1. 入口（Entry）：从指定文件（如 index.js）开始分析依赖。
...
</ul>`],reference:"/myKMS/knowledge/framework/vite#_2-webpack-中的-loaders-和-plugins-有什么区别",source:"/myKMS/knowledge/framework/vite"},{id:156,question:"Tree Shaking",answer:["Tree Shaking = 静态分析 + dead code elimination",`- 去除未使用代码的技术, ESM 的 import/export 是静态分析的. 本质目标：减少打包体积，把代码中 未引用的函数、变量、类 剔除掉。
- 支持条件:
  - 必须使用 ES Module;
...
</ol>`],reference:"/myKMS/knowledge/framework/vite#_3-tree-shaking",source:"/myKMS/knowledge/framework/vite"},{id:157,question:"Tree Shaking 对 css 有效吗",answer:[`- 纯 CSS 文件
...
</ul>`],reference:"/myKMS/knowledge/framework/vite#_4-tree-shaking-对-css-有效吗",source:"/myKMS/knowledge/framework/vite"},{id:158,question:"webpack runtime 是啥",answer:["**webpack runtime = 浏览器端的模块管理器 + 动态加载器 + 缓存器**","webpack 为了在浏览器执行模块打包后的代码而生成的一套加载、执行、管理模块的核心逻辑。","负责:",`- 加载模块 (**webpack_require**)
...
</ul>`],reference:"/myKMS/knowledge/framework/vite#_5-webpack-runtime-是啥",source:"/myKMS/knowledge/framework/vite"},{id:159,question:"webpack  有哪些优化项目的手段？",answer:["围绕 webpack 做性能优化，分为两个方面： 构建时间优化 、 构建体积优化",`- 构建时间优化
  - 缩小范围
  - 文件后缀
  - 别名
  - 缓存
...
</ol>`],reference:"/myKMS/knowledge/framework/vite#_1-简述vite的依赖预加载机制",source:"/myKMS/knowledge/framework/vite"},{id:161,question:"vite HMR 模块热更新 (与webpack对比)",answer:["修改代码 → 浏览器自动更新 → 状态不丢失","基本工作原理",`1. 开发服务器启动时：Vite 会用 ES Module 的方式向浏览器提供源码。
...
</ol>`],reference:"/myKMS/knowledge/framework/vite#_2-vite-hmr-模块热更新-与webpack对比",source:"/myKMS/knowledge/framework/vite"},{id:162,question:"Webpack 与 Vite",answer:[`| 对比项              | **Webpack**                                     | **Vite**                                      |
| :--------------- | :---------------------------------------------- | :-------------------------------------------- |
...
</ul>`],reference:"/myKMS/knowledge/framework/vite#_3-webpack-与-vite",source:"/myKMS/knowledge/framework/vite"},{id:163,question:"ssr 是啥, 对比csr的优势和适用场景",answer:["SSR（Server-Side Rendering） 是指在服务器端生成 HTML 内容，再发送到浏览器渲染，而不是浏览器端通过 JS 生成 DOM。",`SSR 的核心实现原理:
...
</ul>`],reference:"/myKMS/knowledge/framework/vite#_5-微前端-import-html-entry-场景下-子应用中存在路由懒加载-dynamic-import-的情况-import-html-entry-会如何处理或者需要注意什么",source:"/myKMS/knowledge/framework/vite"},{id:165,question:"CSS-in-JS  的优缺点",answer:[`| 优点                               | 说明                                     | 实际收益                        |
| -------------------------------- | -------------------------------------- | --------------------------- |
...
</table>`],reference:"/myKMS/knowledge/framework/vite#_6-css-in-js-的优缺点",source:"/myKMS/knowledge/framework/vite"},{id:166,question:"monorepo 仓库如何控制权限",answer:["因为所有代码都在一个 Git 仓库里，如果不设计好，任何人都能改任何模块，会带来安全、合规和代码质量风险。",`| 层级                     | 工具 / 方式                     | 控制能力               | 适合规模     |
| ---------------------- | --------------------------- | ------------------ | -------- |
...
</ol>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::pli8u2z85uxlwghf5m21::--><code># CODEOWNERS
/apps/web/*          @frontend-team
/apps/admin/*        @admin-team
/packages/utils/*    @core-lib-team
/packages/api/*      @backend-team</code></pre>
</div>`,"<p>作用：</p>","<p>触发 PR 时自动要求指定团队审核；</p>","<p>没有通过指定 Reviewer 的批准不能 merge；</p>","<p>搭配 分支保护（Branch Protection Rules） 可强制执行。</p>","<p>✅ 适用：中小团队；简单易行；GitHub/GitLab 都支持。</p>","<p>2.Git 平台组织级权限</p>","<p>在 GitHub / GitLab 里：</p>","<p>每个项目路径对应一个 Team（如 frontend, backend, ops）；</p>","<p>给不同路径分配 读/写/审查 权限；</p>","<p>对外协作者仅开放特定子目录（GitLab 支持 Subgroup ACL 更细）。</p>"],reference:"/myKMS/knowledge/framework/vite#_7-monorepo-仓库如何控制权限",source:"/myKMS/knowledge/framework/vite"},{id:167,question:"esbuild",answer:["esbuild 是一个用 Go 写的超快前端构建工具，定位是**JavaScript/CSS 的打包器（bundler）+ 转译器（transformer）+ 压缩器（minifier）**，很多工具（Vite、Angular、Rails、Netlify Functions 等）都会把它当作底层加速引擎来用。","运行流程（build 模式）","从入口文件到输出 bundle，大体是这条流水线：","1. 读取入口 entryPoints","2. 解析与扫描（parse/scan）",`- 词法/语法解析生成 AST
  - 扫描 import/require，收集依赖图（dependency graph）`,"3. 模块解析（resolve）",`- 根据路径、条件导出、平台（browser/node）等规则定位真实文件
  -  插件的 onResolve 会在这里介入。`,"4. 加载与转译（load/transform）",`- 读取源文件
  - 按 loader 处理 TS/JSX/CSS/JSON/文本等
  - 插件 onLoad 可以替换/生成内容。`,"5. 链接/打包（link/bundle）",`- 把依赖图按目标格式拼成一个或多个 chunk
  - 进行 tree-shaking、作用域提升、代码分割（如开启 splitting）`,"6. 优化与输出（minify/print）",`- 压缩、变量改写、去空白
  - 生成 sourcemap
  - 写入 outdir/outfile 或直接返回内存结果。`,"transform 模式只走第 2/4/6 的“单文件管线”。",`为什么 esbuild 特别快？
- Go 原生实现 + 单体编译器
- 高度并行（多核）
- 极少的中间抽象/对象分配
- 增量构建复用解析结果
- 功能聚焦（不做 Type Checking）`],answerHtml:["<p>esbuild 是一个用 Go 写的超快前端构建工具，定位是<strong>JavaScript/CSS 的打包器（bundler）+ 转译器（transformer）+ 压缩器（minifier）</strong>，很多工具（Vite、Angular、Rails、Netlify Functions 等）都会把它当作底层加速引擎来用。</p>","<p>运行流程（build 模式）</p>","<p>从入口文件到输出 bundle，大体是这条流水线：</p>",`<ol>
<li>读取入口 entryPoints</li>
</ol>`,`<ol start="2">
<li>解析与扫描（parse/scan）</li>
</ol>`,`<ul>
<li>词法/语法解析生成 AST
<ul>
<li>扫描 import/require，收集依赖图（dependency graph）</li>
</ul>
</li>
</ul>`,`<ol start="3">
<li>模块解析（resolve）</li>
</ol>`,`<ul>
<li>根据路径、条件导出、平台（browser/node）等规则定位真实文件
<ul>
<li>插件的 onResolve 会在这里介入。</li>
</ul>
</li>
</ul>`,`<ol start="4">
<li>加载与转译（load/transform）</li>
</ol>`,`<ul>
<li>读取源文件
<ul>
<li>按 loader 处理 TS/JSX/CSS/JSON/文本等</li>
<li>插件 onLoad 可以替换/生成内容。</li>
</ul>
</li>
</ul>`,`<ol start="5">
<li>链接/打包（link/bundle）</li>
</ol>`,`<ul>
<li>把依赖图按目标格式拼成一个或多个 chunk
<ul>
<li>进行 tree-shaking、作用域提升、代码分割（如开启 splitting）</li>
</ul>
</li>
</ul>`,`<ol start="6">
<li>优化与输出（minify/print）</li>
</ol>`,`<ul>
<li>压缩、变量改写、去空白
<ul>
<li>生成 sourcemap</li>
<li>写入 outdir/outfile 或直接返回内存结果。</li>
</ul>
</li>
</ul>`,"<p>transform 模式只走第 2/4/6 的“单文件管线”。</p>",`<p>为什么 esbuild 特别快？</p>
<ul>
<li>Go 原生实现 + 单体编译器</li>
<li>高度并行（多核）</li>
<li>极少的中间抽象/对象分配</li>
<li>增量构建复用解析结果</li>
<li>功能聚焦（不做 Type Checking）</li>
</ul>`],reference:"/myKMS/knowledge/framework/vite#_8-esbuild",source:"/myKMS/knowledge/framework/vite"},{id:168,question:"vue 动态渲染组件的原理是什么",answer:[`**本质是根据虚拟 DOM（VNode）的 type 动态切换组件**
...
如果是组件对象 → 返回组件本身</p>`,"<p><strong>Vue 动态组件就是 根据 reactive/ref 的值动态生成 VNode type，然后通过 patch 更新组件实例，keep-alive 则通过缓存实例优化挂载卸载。</strong></p>"],reference:"/myKMS/knowledge/framework/vue#_1-vue-动态渲染组件的原理是什么",source:"/myKMS/knowledge/framework/vue"},{id:169,question:"Vue 项目可做哪些性能优化",answer:[`- 减少不必要的响应式追踪
...
<li>虚拟滚动</li>
<li>...</li>
</ul>`],reference:"/myKMS/knowledge/framework/vue#_2-vue-项目可做哪些性能优化",source:"/myKMS/knowledge/framework/vue"},{id:170,question:"nextTick 原理是什么",answer:["**nextTick在下次 DOM 更新循环结束后执行回调，确保我们能操作到最新的 DOM 状态。**","Vue 采用 异步批量更新策略：",`- 收集本轮所有的更新任务；
...
- 在一次事件循环中，微任务总是早于宏任务执行。`,"nextTick 回调 再dom 渲染之后, 宏任务执行之前.","**Vue 3 的 nextTick 本质是：等 Vue 把当前这轮响应式更新、组件渲染、DOM patch 都批量刷完后，再把你的回调放到同一轮 flush 的末尾（一个 microtask）执行。它不是“等一个 tick 的时间”，而是“等更新队列被 flush”。**","extTick 什么时候会“马上执行”？","如果你调用 nextTick 时本轮没有任何更新队列：await nextTick() 它会用 resolvedPromise，也就是“下一次 microtask”，几乎立刻执行（但仍然是异步）。","**Vue3 的 nextTick 基于 scheduler：响应式更新会把组件渲染 job 放入队列并用 Promise microtask 安排一次 flush；flushJobs 统一执行 render/patch 后，再执行 postFlush 回调；nextTick 就是返回当前 flush 的 Promise 或在其后追加回调，从而保证拿到更新后的 DOM。**"],answerHtml:["<p><strong>nextTick在下次 DOM 更新循环结束后执行回调，确保我们能操作到最新的 DOM 状态。</strong></p>","<p>Vue 采用 异步批量更新策略：</p>",`<ul>
<li>收集本轮所有的更新任务；</li>
<li>等当前“事件循环”结束后，一次性刷新 DOM；</li>
<li>保证更新最少、性能最好。</li>
</ul>`,"<p>Vue 3 的 nextTick 实际上是封装了一个<strong>微任务调度器（microtask scheduler）</strong>。</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::ihqxbb3cuxa4vxs8ijwzfb::--><code>// Vue3 内部核心实现伪代码
let pending = false
const queue = []
...
</ul>`,"<p>nextTick 回调 再dom 渲染之后, 宏任务执行之前.</p>","<p><strong>Vue 3 的 nextTick 本质是：等 Vue 把当前这轮响应式更新、组件渲染、DOM patch 都批量刷完后，再把你的回调放到同一轮 flush 的末尾（一个 microtask）执行。它不是“等一个 tick 的时间”，而是“等更新队列被 flush”。</strong></p>","<p>extTick 什么时候会“马上执行”？</p>","<p>如果你调用 nextTick 时本轮没有任何更新队列：await nextTick() 它会用 resolvedPromise，也就是“下一次 microtask”，几乎立刻执行（但仍然是异步）。</p>","<p><strong>Vue3 的 nextTick 基于 scheduler：响应式更新会把组件渲染 job 放入队列并用 Promise microtask 安排一次 flush；flushJobs 统一执行 render/patch 后，再执行 postFlush 回调；nextTick 就是返回当前 flush 的 Promise 或在其后追加回调，从而保证拿到更新后的 DOM。</strong></p>"],reference:"/myKMS/knowledge/framework/vue#_3-nexttick-原理是什么",source:"/myKMS/knowledge/framework/vue"},{id:171,question:"如何统一监听 Vue 组件报错",answer:["在 Vue 3 中，可以通过 全局错误处理器 （errorHandler） 和 生命周期钩子（例如 onErrorCaptured ）来统一监听和处理组件中的错误.",`- 通过全局错误处理器 app.config.errorHandler
...
</table>`],reference:"/myKMS/knowledge/framework/vue#_5-什么是-mvvm",source:"/myKMS/knowledge/framework/vue"},{id:173,question:"Vue 组件初始化的各个阶段都做了什么？",answer:["**创建实例 → 建响应式 → 执行 setup/初始化状态 → 编译/生成 render → 建立渲染副作用 → 首次 patch → 调用挂载钩子。**","从组件的创建到挂载到页面，再到组件的更新和销毁，每个阶段都有特定的任务和职责。","🎯 组件实例创建：当我们第一次访问页面时，Vue创建组件实例，解析props、data、methods等属性方法，在组合式API中，执行 setup()。","🎯 响应式系统建立：基于 Proxy 实现 reactive、ref，建立依赖收集和触发更新机制，props 传递时自动响应式处理。","🎯 模板编译与渲染：将 template 编译为渲染函数，Vue 3 通过 静态提升等方式优化性能，Vite 预编译 SFC（单文件组件）。","🎯 DOM 挂载：执行渲染函数生成 VNode，通过 Patch 算法 转换为真实 DOM 并插入页面，同时初始化子组件。mounted（Options API）或 onMounted（Composition API）触发，可进行 DOM 操作。","🎯 响应式更新：状态变更触发 Diff 算法 计算最小 DOM 更新，beforeUpdate、updated（Options API）或 onBeforeUpdate、onUpdated（Composition API）执行相应逻辑。","🎯 组件销毁：移除 DOM，清理副作用（解绑事件、销毁 watcher、清理 effect），递归卸载子组件，触发 beforeUnmount、unmounted（Options API）或 onBeforeUnmount、onUnmounted（Composition API）。","Vue 组件初始化流程是：父组件 patch 时创建子组件实例 → 初始化 props/slots → 执行 setup（或 data/computed/watch 等 Options 初始化）并触发 created → 绑定 render → 建立渲染 effect → 触发 beforeMount → 首次 render 生成 subTree 并 patch 创建 DOM → DOM 插入后触发 mounted，最后跑 post-flush 队列（nextTick 等）。"],answerHtml:["<p><strong>创建实例 → 建响应式 → 执行 setup/初始化状态 → 编译/生成 render → 建立渲染副作用 → 首次 patch → 调用挂载钩子。</strong></p>","<p>从组件的创建到挂载到页面，再到组件的更新和销毁，每个阶段都有特定的任务和职责。</p>","<p>🎯 组件实例创建：当我们第一次访问页面时，Vue创建组件实例，解析props、data、methods等属性方法，在组合式API中，执行 setup()。</p>","<p>🎯 响应式系统建立：基于 Proxy 实现 reactive、ref，建立依赖收集和触发更新机制，props 传递时自动响应式处理。</p>","<p>🎯 模板编译与渲染：将 template 编译为渲染函数，Vue 3 通过 静态提升等方式优化性能，Vite 预编译 SFC（单文件组件）。</p>","<p>🎯 DOM 挂载：执行渲染函数生成 VNode，通过 Patch 算法 转换为真实 DOM 并插入页面，同时初始化子组件。mounted（Options API）或 onMounted（Composition API）触发，可进行 DOM 操作。</p>","<p>🎯 响应式更新：状态变更触发 Diff 算法 计算最小 DOM 更新，beforeUpdate、updated（Options API）或 onBeforeUpdate、onUpdated（Composition API）执行相应逻辑。</p>","<p>🎯 组件销毁：移除 DOM，清理副作用（解绑事件、销毁 watcher、清理 effect），递归卸载子组件，触发 beforeUnmount、unmounted（Options API）或 onBeforeUnmount、onUnmounted（Composition API）。</p>","<p>Vue 组件初始化流程是：父组件 patch 时创建子组件实例 → 初始化 props/slots → 执行 setup（或 data/computed/watch 等 Options 初始化）并触发 created → 绑定 render → 建立渲染 effect → 触发 beforeMount → 首次 render 生成 subTree 并 patch 创建 DOM → DOM 插入后触发 mounted，最后跑 post-flush 队列（nextTick 等）。</p>"],reference:"/myKMS/knowledge/framework/vue#_6-vue-组件初始化的各个阶段都做了什么",source:"/myKMS/knowledge/framework/vue"},{id:174,question:"Vue3 如何实现双向数据绑定",answer:["**Vue 实现双向数据绑定的核心是通过响应式系统的 数据劫持和 观察者模式来实现的。**",`Vue3 实现双向绑定的本质是这三层：
...
</ul>`],reference:"/myKMS/knowledge/framework/vue#_7-vue3-如何实现双向数据绑定",source:"/myKMS/knowledge/framework/vue"},{id:175,question:"Vue 模板编译的过程",answer:["**模板解析、AST优化 和 代码生成**",`\`\`\`
模板字符串 (template)
       ↓
[1] 解析（Parse） → 生成 AST
       ↓
...
3. 代码生成: 生成渲染函数是编译的最终阶段，这个阶段会将优化后的 AST 转换成 JavaScript 渲染函数。`],answerHtml:["<p><strong>模板解析、AST优化 和 代码生成</strong></p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::5864yh1uy3vby5o8l20vv9::--><code>模板字符串 (template)
       ↓
[1] 解析（Parse） → 生成 AST
       ↓
[2] 转换（Transform） → 优化、静态标记、指令处理
...
</ol>`],reference:"/myKMS/knowledge/framework/vue#_8-vue-模板编译的过程",source:"/myKMS/knowledge/framework/vue"},{id:176,question:"vue 异步更新",answer:["Vue 会延迟更新 DOM，等同一轮事件循环中所有状态改动都完成后，再统一执行更新。",`目的：
✅ 避免频繁的 DOM 重绘（性能优化）
✅ 保证多次修改只渲染一次（批量更新）
...
✅ 避免频繁的 DOM 重绘（性能优化）
✅ 保证多次修改只渲染一次（批量更新）
✅ 数据一致性：确保在同一事件循环中的所有数据变更后，视图一次性更新到最终状态。</p>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::48ea1sl0u55i1zuobo9v8c::--><code>数据变化（Proxy.set）
       ↓
触发依赖（trigger）
       ↓
派发更新任务（scheduler → queueJob）
...
<tr>
<td>是否能监听深层对象 /数组</td>
<td>默认浅依赖；对于深层嵌套需要用 getter 的“被读属性”依赖, 或者 <code>computed(() =&gt; JSON.stringify(...))</code> 等技巧</td>
...
</ul>`],reference:"/myKMS/knowledge/framework/vue#_10-vue-watch-computed-的区别",source:"/myKMS/knowledge/framework/vue"},{id:178,question:"vue3 lis",answer:[`LIS 在 Diff 中的作用：找出不需要移动的节点，最小化 DOM 操作
- 1. 将新节点映射到旧节点索引序列
- 2. 求最长递增子序列（LIS）
- 3. 非 LIS 节点移动或创建`,"能够降低时间复杂度;大型表格、树结构、虚拟列表和移动频繁但大部分节点不变的场景, 效果好.","为什么 LIS 能保证“移动最少”？","因为：",`- 递增子序列代表节点在旧列表中的顺序与新列表一致
 - 任何保持递增顺序的节点集合都可以不动
 - 其中最长那一个就是“能不动的最大集合”`,"不动最多 ⇒ 需要移动的就最少。 就是性能最好","完整流程大致是：","- 头头比、尾尾比（快路径）","- 建新 key → index map","- 找可复用、标记新增/删除","- 仅在需要移动时算 LIS","- 倒序遍历新节点，做 insert/move"],answerHtml:[`<p>LIS 在 Diff 中的作用：找出不需要移动的节点，最小化 DOM 操作</p>
<ul>
<li>
<ol>
...
</ul>`,"<p>能够降低时间复杂度;大型表格、树结构、虚拟列表和移动频繁但大部分节点不变的场景, 效果好.</p>","<p>为什么 LIS 能保证“移动最少”？</p>","<p>因为：</p>",`<ul>
<li>递增子序列代表节点在旧列表中的顺序与新列表一致</li>
<li>任何保持递增顺序的节点集合都可以不动</li>
<li>其中最长那一个就是“能不动的最大集合”</li>
</ul>`,"<p>不动最多 ⇒ 需要移动的就最少。 就是性能最好</p>","<p>完整流程大致是：</p>",`<ul>
<li>头头比、尾尾比（快路径）</li>
</ul>`,`<ul>
<li>建新 key → index map</li>
</ul>`,`<ul>
<li>找可复用、标记新增/删除</li>
</ul>`,`<ul>
<li>仅在需要移动时算 LIS</li>
</ul>`,`<ul>
<li>倒序遍历新节点，做 insert/move</li>
</ul>`],reference:"/myKMS/knowledge/framework/vue#_11-vue3-lis",source:"/myKMS/knowledge/framework/vue"},{id:179,question:"vue3 类似react hooks的原理是什么?",answer:[`Composition API（组合式 API）。
...
</table>`],reference:"/myKMS/knowledge/framework/vue#_12-vue3-类似react-hooks的原理是什么",source:"/myKMS/knowledge/framework/vue"},{id:180,question:"vue3 手写一个once修饰器",answer:[`\`\`\`
...
\`\`\``],answerHtml:[`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::cro5o1kngmckxi930r90vq::--><code>
&lt;template&gt;
  &lt;div&gt;
    &lt;h2 v-once-directive&gt;{{ message }}&lt;/h2&gt;
    &lt;button @click=&quot;message = &#039;更新后的消息&#039;&quot;&gt;修改 message&lt;/button&gt;
...
</div>`,"<p>事件</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::7xeye4jo6ph7uj83xw3v8m::--><code>
&lt;template&gt;
  &lt;button v-once-click=&quot;handleClick&quot;&gt;点击我一次&lt;/button&gt;
&lt;/template&gt;
...
</div>`,"<p>自定义指令有很多钩子可以选择</p>",`<div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre><!--::markdown-it-async::416x1o2zux71aov2qbxqou::--><code>const myDirective = {
  // 在绑定元素的 attribute 前
  // 或事件监听器应用前调用
  created(el, binding, vnode) {
    // 下面会介绍各个参数的细节
...
</div>`],reference:"/myKMS/knowledge/framework/vue#_13-vue3-手写一个once修饰器",source:"/myKMS/knowledge/framework/vue"},{id:181,question:"vue ref 绑定的值发现改变后, 会发生什么",answer:["**修改了 ref.value → 响应式系统触发依赖 → 调度器把相关副作用（组件渲染、computed、watch）加入队列 → 在本轮 microtask 里统一重新执行 → 重新渲染/patch DOM，触发生命周期钩子。**","在 Vue3 里，ref 的 .value 改变后会触发依赖收集到的各类 effect，通过调度器以 microtask 批量重新执行：组件渲染 effect 重新 render 并 patch DOM，相关 computed 失效重算，watch 回调被调用，并在这个过程中按顺序触发 beforeUpdate/updated 和 nextTick，从而完成响应式更新。"],answerHtml:["<p><strong>修改了 ref.value → 响应式系统触发依赖 → 调度器把相关副作用（组件渲染、computed、watch）加入队列 → 在本轮 microtask 里统一重新执行 → 重新渲染/patch DOM，触发生命周期钩子。</strong></p>","<p>在 Vue3 里，ref 的 .value 改变后会触发依赖收集到的各类 effect，通过调度器以 microtask 批量重新执行：组件渲染 effect 重新 render 并 patch DOM，相关 computed 失效重算，watch 回调被调用，并在这个过程中按顺序触发 beforeUpdate/updated 和 nextTick，从而完成响应式更新。</p>"],reference:"/myKMS/knowledge/framework/vue#_14-vue-ref-绑定的值发现改变后-会发生什么",source:"/myKMS/knowledge/framework/vue"}],$i={class:"random-question__modal"},Ui={key:0,class:"random-question__body"},Ji={class:"random-question__question"},Wi={class:"random-question__answer-blocks"},Bi=["innerHTML"],Gi=["href"],zi=f({__name:"RandomQuestionModal",props:{variant:{}},setup(n){const e=n,t=w(!1),o=w(null),r=w(0),l=S(()=>e.variant??"home"),d=S(()=>["random-question",{"random-question--nav":l.value==="nav"}]),a=S(()=>["random-question__trigger",{"random-question__trigger--nav":l.value==="nav"}]),v=S(()=>o.value?.answerHtml??[]),P=()=>{if(!on.length)return null;const I=Math.floor(Math.random()*on.length);return on[I]},C=()=>{const I=P();I&&(o.value=I,r.value++,t.value=!0)},x=()=>{const I=P();I&&(o.value=I,r.value++)},D=()=>{t.value=!1},_=()=>{D()};return(I,E)=>(i(),c("div",{class:M(d.value)},[p("button",{type:"button",class:M(a.value),onClick:C}," 🎯 随机一题 ",2),(i(),b(oe,{to:"body"},[t.value?(i(),c("div",{key:0,class:"random-question__overlay",role:"dialog","aria-modal":"true",onClick:Ln(D,["self"])},[p("div",$i,[p("header",{class:"random-question__header"},[E[0]||(E[0]=p("div",null,[p("p",{class:"random-question__eyebrow"},"Interview Drill"),p("h3",null,"随机一题")],-1)),p("button",{type:"button",class:"random-question__icon-button","aria-label":"关闭弹窗",onClick:D}," ✕ ")]),o.value?(i(),c("section",Ui,[p("p",Ji,T(o.value.question),1),v.value.length?(i(),c("details",{class:"random-question__answer",key:r.value},[E[1]||(E[1]=p("summary",null,"展开答案",-1)),p("div",Wi,[(i(!0),c(R,null,H(v.value,(F,V)=>(i(),c("div",{key:V,class:"random-question__answer-block",innerHTML:F},null,8,Bi))),128))])])):g("",!0),o.value.reference?(i(),c("a",{key:1,class:"random-question__reference",href:o.value.reference,onClick:_}," 查看原文 ",8,Gi)):g("",!0)])):g("",!0),p("footer",{class:"random-question__footer"},[p("button",{type:"button",class:"random-question__next",onClick:x}," 换一题 ")])])])):g("",!0)]))],2))}}),In=y(zi,[["__scopeId","data-v-4e1b7e9a"]]),Qi={extends:Rn,Layout:()=>Tn(Rn.Layout,null,{"nav-bar-content-before":()=>Tn(In,{variant:"nav"})}),enhanceApp({app:n,router:e,siteData:t}){n.component("Collapse",Ni),n.component("RandomQuestionModal",In)}};export{Qi as R};
