import{d as f,c,r as u,n as M,o as i,a as K,t as C,b,w as m,T as cn,e as g,_ as y,u as $n,i as Un,f as Jn,g as un,h as S,j as p,k as s,l as $,m as Mn,p as N,q as Wn,s as pn,v as Bn,x as w,y as Y,z as F,A as mn,B as gn,C as G,D as Z,E as Tn,F as Hn,G as R,H as D,I as U,J as h,K as L,L as Dn,M as j,N as nn,O as fn,P as Gn,Q as zn,R as hn,S as _n,U as Qn,V as En,W as Vn,X as Xn,Y as Yn,Z as Zn,$ as Ln,a0 as nt,a1 as tt,a2 as et,a3 as ot,a4 as Cn}from"./framework.L9hZw9cv.js";const rt=f({__name:"VPBadge",props:{text:{},type:{default:"tip"}},setup(n){return(t,e)=>(i(),c("span",{class:M(["VPBadge",n.type])},[u(t.$slots,"default",{},()=>[K(C(n.text),1)])],2))}}),it={key:0,class:"VPBackdrop"},lt=f({__name:"VPBackdrop",props:{show:{type:Boolean}},setup(n){return(t,e)=>(i(),b(cn,{name:"fade"},{default:m(()=>[n.show?(i(),c("div",it)):g("",!0)]),_:1}))}}),st=y(lt,[["__scopeId","data-v-54a304ca"]]),k=$n;function at(n,t){let e,o=!1;return()=>{e&&clearTimeout(e),o?e=setTimeout(n,t):(n(),(o=!0)&&setTimeout(()=>o=!1,t))}}function rn(n){return n.startsWith("/")?n:`/${n}`}function bn(n){const{pathname:t,search:e,hash:o,protocol:r}=new URL(n,"http://a.com");if(Un(n)||n.startsWith("#")||!r.startsWith("http")||!Jn(t))return n;const{site:l}=k(),d=t.endsWith("/")||t.endsWith(".html")?n:n.replace(/(?:(^\.+)\/)?.*$/,`$1${t.replace(/(\.md)?$/,l.value.cleanUrls?"":".html")}${e}${o}`);return un(d)}function z({correspondingLink:n=!1}={}){const{site:t,localeIndex:e,page:o,theme:r,hash:l}=k(),d=S(()=>({label:t.value.locales[e.value]?.label,link:t.value.locales[e.value]?.link||(e.value==="root"?"/":`/${e.value}/`)}));return{localeLinks:S(()=>Object.entries(t.value.locales).flatMap(([v,P])=>d.value.label===P.label?[]:{text:P.label,link:dt(P.link||(v==="root"?"/":`/${v}/`),r.value.i18nRouting!==!1&&n,o.value.relativePath.slice(d.value.link.length-1),!t.value.cleanUrls)+l.value})),currentLang:d}}function dt(n,t,e,o){return t?n.replace(/\/$/,"")+rn(e.replace(/(^|\/)index\.md$/,"$1").replace(/\.md$/,o?".html":"")):n}const ct={class:"NotFound"},ut={class:"code"},pt={class:"title"},mt={class:"quote"},gt={class:"action"},ft=["href","aria-label"],ht=f({__name:"NotFound",setup(n){const{theme:t}=k(),{currentLang:e}=z();return(o,r)=>(i(),c("div",ct,[p("p",ut,C(s(t).notFound?.code??"404"),1),p("h1",pt,C(s(t).notFound?.title??"PAGE NOT FOUND"),1),r[0]||(r[0]=p("div",{class:"divider"},null,-1)),p("blockquote",mt,C(s(t).notFound?.quote??"But if you don't change your direction, and if you keep looking, you may end up where you are heading."),1),p("div",gt,[p("a",{class:"link",href:s(un)(s(t).notFound?.link??s(e).link),"aria-label":s(t).notFound?.linkLabel??"go to home"},C(s(t).notFound?.linkText??"Take me home"),9,ft)])]))}}),bt=y(ht,[["__scopeId","data-v-b0126292"]]);function An(n,t){if(Array.isArray(n))return Q(n);if(n==null)return[];t=rn(t);const e=Object.keys(n).sort((r,l)=>l.split("/").length-r.split("/").length).find(r=>t.startsWith(rn(r))),o=e?n[e]:[];return Array.isArray(o)?Q(o):Q(o.items,o.base)}function vt(n){const t=[];let e=0;for(const o in n){const r=n[o];if(r.items){e=t.push(r);continue}t[e]||t.push({items:[]}),t[e].items.push(r)}return t}function yt(n){const t=[];function e(o){for(const r of o)r.text&&r.link&&t.push({text:r.text,link:r.link,docFooterText:r.docFooterText}),r.items&&e(r.items)}return e(n),t}function ln(n,t){return Array.isArray(t)?t.some(e=>ln(n,e)):$(n,t.link)?!0:t.items?ln(n,t.items):!1}function Q(n,t){return[...n].map(e=>{const o={...e},r=o.base||t;return r&&o.link&&(o.link=r+o.link.replace(/^\//,r.endsWith("/")?"":"/")),o.items&&(o.items=Q(o.items,r)),o})}function St(){const{hasSidebar:n}=q(),t=Mn("(min-width: 960px)"),e=Mn("(min-width: 1280px)");return{isAsideEnabled:S(()=>!e.value&&!t.value?!1:n.value?e.value:t.value)}}const kt=/\b(?:VPBadge|header-anchor|footnote-ref|ignore-header)\b/,sn=[];function Fn(n){return typeof n.outline=="object"&&!Array.isArray(n.outline)&&n.outline.label||n.outlineTitle||"On this page"}function wt(n){const t=[...document.querySelectorAll(".VPDoc :where(h1,h2,h3,h4,h5,h6)")].filter(e=>e.id&&e.hasChildNodes()).map(e=>{const o=Number(e.tagName[1]);return{element:e,title:Pt(e),link:"#"+e.id,level:o}});return Mt(t,n)}function Pt(n){let t="";for(const e of n.childNodes)if(e.nodeType===1){if(kt.test(e.className))continue;t+=e.textContent}else e.nodeType===3&&(t+=e.textContent);return t.trim()}function Mt(n,t){if(t===!1)return[];const e=(typeof t=="object"&&!Array.isArray(t)?t.level:t)||2,[o,r]=typeof e=="number"?[e,e]:e==="deep"?[2,6]:e;return xt(n,o,r)}function Tt(n,t){const{isAsideEnabled:e}=St(),o=at(l,100);let r=null;N(()=>{requestAnimationFrame(l),window.addEventListener("scroll",o)}),Wn(()=>{d(location.hash)}),pn(()=>{window.removeEventListener("scroll",o)});function l(){if(!e.value)return;const a=window.scrollY,v=window.innerHeight,P=document.body.offsetHeight,T=Math.abs(a+v-P)<1,x=sn.map(({element:_,link:I})=>({link:I,top:Ct(_)})).filter(({top:_})=>!Number.isNaN(_)).sort((_,I)=>_.top-I.top);if(!x.length){d(null);return}if(a<1){d(null);return}if(T){d(x[x.length-1].link);return}let H=null;for(const{link:_,top:I}of x){if(I>a+Bn()+4)break;H=_}d(H)}function d(a){r&&r.classList.remove("active"),a==null?r=null:r=n.value.querySelector(`a[href="${decodeURIComponent(a)}"]`);const v=r;v?(v.classList.add("active"),t.value.style.top=v.offsetTop+39+"px",t.value.style.opacity="1"):(t.value.style.top="33px",t.value.style.opacity="0")}}function Ct(n){let t=0;for(;n!==document.body;){if(n===null)return NaN;t+=n.offsetTop,n=n.offsetParent}return t}function xt(n,t,e){sn.length=0;const o=[],r=[];return n.forEach(l=>{const d={...l,children:[]};let a=r[r.length-1];for(;a&&a.level>=d.level;)r.pop(),a=r[r.length-1];if(d.element.classList.contains("ignore-header")||a&&"shouldIgnore"in a){r.push({level:d.level,shouldIgnore:!0});return}d.level>e||d.level<t||(sn.push({element:d.element,link:d.link}),a?a.children.push(d):o.push(d),r.push(d))}),o}const J=w(!1);function Rt(n){let t;Y(()=>{t=J.value?document.activeElement:void 0}),N(()=>{window.addEventListener("keyup",e)}),pn(()=>{window.removeEventListener("keyup",e)});function e(o){o.key==="Escape"&&J.value&&(n(),t?.focus())}}function It(){function n(){J.value=!0}function t(){J.value=!1}function e(){J.value?t():n()}return{isOpen:J,open:n,close:t,toggle:e}}function Ht(n){const{page:t,hash:e}=k(),o=w(!1),r=S(()=>n.value.collapsed!=null),l=S(()=>!!n.value.link),d=w(!1),a=()=>{d.value=$(t.value.relativePath,n.value.link)};F([t,n,e],a),N(a);const v=S(()=>d.value?!0:n.value.items?ln(t.value.relativePath,n.value.items):!1),P=S(()=>!!(n.value.items&&n.value.items.length));Y(()=>{o.value=!!(r.value&&n.value.collapsed)}),mn(()=>{(d.value||v.value)&&(o.value=!1)});function T(){r.value&&(o.value=!o.value)}return{collapsed:o,collapsible:r,isLink:l,isActiveLink:d,hasActiveLink:v,hasChildren:P,toggle:T}}const an=gn([]),B=gn([]),dn=gn(!1);function q(){const{frontmatter:n,theme:t}=k(),e=S(()=>!!(n.value.isHome??n.value.layout==="home")),o=S(()=>n.value.sidebar!==!1&&B.value.length>0&&!e.value),r=S(()=>o.value&&dn.value),l=S(()=>o.value?vt(B.value):[]),d=S(()=>e.value?!1:n.value.aside!=null?!!n.value.aside:t.value.aside!==!1),a=S(()=>d.value?n.value.aside==null?t.value.aside==="left":n.value.aside==="left":!1),v=S(()=>an.value.length>0);return{isHome:e,sidebar:Tn(B),sidebarGroups:l,hasSidebar:o,isSidebarEnabled:r,hasAside:d,leftAside:a,headers:Tn(an),hasLocalNav:v}}function Dt({closeSidebar:n}){const{frontmatter:t,page:e,theme:o}=k();F(()=>[e.value.relativePath,o.value.sidebar],([l,d])=>{const a=d?An(d,l):[];JSON.stringify(a)!==JSON.stringify(B.value)&&(B.value=a)},{immediate:!0,deep:!0,flush:"sync"}),Hn(()=>{an.value=wt(t.value.outline??o.value.outline)}),G&&(dn.value=window.innerWidth>=960,window.addEventListener("resize",()=>{dn.value=window.innerWidth>=960},{passive:!0}));const r=Z();F(()=>r.path,n),Rt(n)}const On=Symbol("layout-info"),_t=["href","title"],Et=f({__name:"VPDocOutlineItem",props:{headers:{},root:{type:Boolean}},setup(n){function t({target:e}){const o=e.href.split("#")[1];document.getElementById(decodeURIComponent(o))?.focus({preventScroll:!0})}return(e,o)=>{const r=U("VPDocOutlineItem",!0);return i(),c("ul",{class:M(["VPDocOutlineItem",n.root?"root":"nested"])},[(i(!0),c(R,null,D(n.headers,({children:l,link:d,title:a})=>(i(),c("li",null,[p("a",{class:"outline-link",href:d,onClick:t,title:a},C(a),9,_t),l?.length?(i(),b(r,{key:0,headers:l},null,8,["headers"])):g("",!0)]))),256))],2)}}}),qn=y(Et,[["__scopeId","data-v-b7d7ef80"]]),Vt={class:"content"},Lt={"aria-level":"2",class:"outline-title",id:"doc-outline-aria-label",role:"heading"},At=f({__name:"VPDocAsideOutline",setup(n){const{theme:t}=k(),e=w(),o=w(),{headers:r,hasLocalNav:l}=q();return Tt(e,o),(d,a)=>(i(),c("nav",{"aria-labelledby":"doc-outline-aria-label",class:M(["VPDocAsideOutline",{"has-outline":s(l)}]),ref_key:"container",ref:e},[p("div",Vt,[p("div",{class:"outline-marker",ref_key:"marker",ref:o},null,512),p("div",Lt,C(s(Fn)(s(t))),1),h(qn,{headers:s(r),root:!0},null,8,["headers"])])],2))}}),Ft=y(At,[["__scopeId","data-v-c8b19031"]]),Ot={class:"VPDocAsideCarbonAds"},qt=f({__name:"VPDocAsideCarbonAds",props:{carbonAds:{}},setup(n){const t=()=>null;return(e,o)=>(i(),c("div",Ot,[h(s(t),{"carbon-ads":n.carbonAds},null,8,["carbon-ads"])]))}}),jt={class:"VPDocAside"},Kt=f({__name:"VPDocAside",setup(n){const{theme:t}=k();return(e,o)=>(i(),c("div",jt,[u(e.$slots,"aside-top",{},void 0,!0),u(e.$slots,"aside-outline-before",{},void 0,!0),h(Ft),u(e.$slots,"aside-outline-after",{},void 0,!0),o[0]||(o[0]=p("div",{class:"spacer"},null,-1)),u(e.$slots,"aside-ads-before",{},void 0,!0),s(t).carbonAds?(i(),b(qt,{key:0,"carbon-ads":s(t).carbonAds},null,8,["carbon-ads"])):g("",!0),u(e.$slots,"aside-ads-after",{},void 0,!0),u(e.$slots,"aside-bottom",{},void 0,!0)]))}}),Nt=y(Kt,[["__scopeId","data-v-cb998dce"]]);function $t(){const{theme:n,page:t}=k();return S(()=>{const{text:e="Edit this page",pattern:o=""}=n.value.editLink||{};let r;return typeof o=="function"?r=o(t.value):r=o.replace(/:path/g,t.value.filePath),{url:r,text:e}})}function Ut(){const{page:n,theme:t,frontmatter:e}=k();return S(()=>{const o=An(t.value.sidebar,n.value.relativePath),r=yt(o),l=Jt(r,P=>P.link.replace(/[?#].*$/,"")),d=l.findIndex(P=>$(n.value.relativePath,P.link)),a=t.value.docFooter?.prev===!1&&!e.value.prev||e.value.prev===!1,v=t.value.docFooter?.next===!1&&!e.value.next||e.value.next===!1;return{prev:a?void 0:{text:(typeof e.value.prev=="string"?e.value.prev:typeof e.value.prev=="object"?e.value.prev.text:void 0)??l[d-1]?.docFooterText??l[d-1]?.text,link:(typeof e.value.prev=="object"?e.value.prev.link:void 0)??l[d-1]?.link},next:v?void 0:{text:(typeof e.value.next=="string"?e.value.next:typeof e.value.next=="object"?e.value.next.text:void 0)??l[d+1]?.docFooterText??l[d+1]?.text,link:(typeof e.value.next=="object"?e.value.next.link:void 0)??l[d+1]?.link}}})}function Jt(n,t){const e=new Set;return n.filter(o=>{const r=t(o);return e.has(r)?!1:e.add(r)})}const A=f({__name:"VPLink",props:{tag:{},href:{},noIcon:{type:Boolean},target:{},rel:{}},setup(n){const t=n,e=S(()=>t.tag??(t.href?"a":"span")),o=S(()=>t.href&&Dn.test(t.href)||t.target==="_blank");return(r,l)=>(i(),b(L(e.value),{class:M(["VPLink",{link:n.href,"vp-external-link-icon":o.value,"no-icon":n.noIcon}]),href:n.href?s(bn)(n.href):void 0,target:n.target??(o.value?"_blank":void 0),rel:n.rel??(o.value?"noreferrer":void 0)},{default:m(()=>[u(r.$slots,"default")]),_:3},8,["class","href","target","rel"]))}}),Wt={class:"VPLastUpdated"},Bt=["datetime"],Gt=f({__name:"VPDocFooterLastUpdated",setup(n){const{theme:t,page:e,lang:o}=k(),r=S(()=>new Date(e.value.lastUpdated)),l=S(()=>r.value.toISOString()),d=w("");return N(()=>{Y(()=>{d.value=new Intl.DateTimeFormat(t.value.lastUpdated?.formatOptions?.forceLocale?o.value:void 0,t.value.lastUpdated?.formatOptions??{dateStyle:"short",timeStyle:"short"}).format(r.value)})}),(a,v)=>(i(),c("p",Wt,[K(C(s(t).lastUpdated?.text||s(t).lastUpdatedText||"Last updated")+": ",1),p("time",{datetime:l.value},C(d.value),9,Bt)]))}}),zt=y(Gt,[["__scopeId","data-v-1bb0c8a8"]]),Qt={key:0,class:"VPDocFooter"},Xt={key:0,class:"edit-info"},Yt={key:0,class:"edit-link"},Zt={key:1,class:"last-updated"},ne={key:1,class:"prev-next","aria-labelledby":"doc-footer-aria-label"},te={class:"pager"},ee=["innerHTML"],oe=["innerHTML"],re={class:"pager"},ie=["innerHTML"],le=["innerHTML"],se=f({__name:"VPDocFooter",setup(n){const{theme:t,page:e,frontmatter:o}=k(),r=$t(),l=Ut(),d=S(()=>t.value.editLink&&o.value.editLink!==!1),a=S(()=>e.value.lastUpdated),v=S(()=>d.value||a.value||l.value.prev||l.value.next);return(P,T)=>v.value?(i(),c("footer",Qt,[u(P.$slots,"doc-footer-before",{},void 0,!0),d.value||a.value?(i(),c("div",Xt,[d.value?(i(),c("div",Yt,[h(A,{class:"edit-link-button",href:s(r).url,"no-icon":!0},{default:m(()=>[T[0]||(T[0]=p("span",{class:"vpi-square-pen edit-link-icon"},null,-1)),K(" "+C(s(r).text),1)]),_:1},8,["href"])])):g("",!0),a.value?(i(),c("div",Zt,[h(zt)])):g("",!0)])):g("",!0),s(l).prev?.link||s(l).next?.link?(i(),c("nav",ne,[T[1]||(T[1]=p("span",{class:"visually-hidden",id:"doc-footer-aria-label"},"Pager",-1)),p("div",te,[s(l).prev?.link?(i(),b(A,{key:0,class:"pager-link prev",href:s(l).prev.link},{default:m(()=>[p("span",{class:"desc",innerHTML:s(t).docFooter?.prev||"Previous page"},null,8,ee),p("span",{class:"title",innerHTML:s(l).prev.text},null,8,oe)]),_:1},8,["href"])):g("",!0)]),p("div",re,[s(l).next?.link?(i(),b(A,{key:0,class:"pager-link next",href:s(l).next.link},{default:m(()=>[p("span",{class:"desc",innerHTML:s(t).docFooter?.next||"Next page"},null,8,ie),p("span",{class:"title",innerHTML:s(l).next.text},null,8,le)]),_:1},8,["href"])):g("",!0)])])):g("",!0)])):g("",!0)}}),ae=y(se,[["__scopeId","data-v-1bcd8184"]]),de={class:"container"},ce={class:"aside-container"},ue={class:"aside-content"},pe={class:"content"},me={class:"content-container"},ge={class:"main"},fe=f({__name:"VPDoc",setup(n){const{theme:t}=k(),e=Z(),{hasSidebar:o,hasAside:r,leftAside:l}=q(),d=S(()=>e.path.replace(/[./]+/g,"_").replace(/_html$/,""));return(a,v)=>{const P=U("Content");return i(),c("div",{class:M(["VPDoc",{"has-sidebar":s(o),"has-aside":s(r)}])},[u(a.$slots,"doc-top",{},void 0,!0),p("div",de,[s(r)?(i(),c("div",{key:0,class:M(["aside",{"left-aside":s(l)}])},[v[0]||(v[0]=p("div",{class:"aside-curtain"},null,-1)),p("div",ce,[p("div",ue,[h(Nt,null,{"aside-top":m(()=>[u(a.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":m(()=>[u(a.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":m(()=>[u(a.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":m(()=>[u(a.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":m(()=>[u(a.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":m(()=>[u(a.$slots,"aside-ads-after",{},void 0,!0)]),_:3})])])],2)):g("",!0),p("div",pe,[p("div",me,[u(a.$slots,"doc-before",{},void 0,!0),p("main",ge,[h(P,{class:M(["vp-doc",[d.value,s(t).externalLinkIcon&&"external-link-icon-enabled"]])},null,8,["class"])]),h(ae,null,{"doc-footer-before":m(()=>[u(a.$slots,"doc-footer-before",{},void 0,!0)]),_:3}),u(a.$slots,"doc-after",{},void 0,!0)])])]),u(a.$slots,"doc-bottom",{},void 0,!0)],2)}}}),he=y(fe,[["__scopeId","data-v-d668f7cc"]]),be=f({__name:"VPButton",props:{tag:{},size:{default:"medium"},theme:{default:"brand"},text:{},href:{},target:{},rel:{}},setup(n){const t=n,e=S(()=>t.href&&Dn.test(t.href)),o=S(()=>t.tag||(t.href?"a":"button"));return(r,l)=>(i(),b(L(o.value),{class:M(["VPButton",[n.size,n.theme]]),href:n.href?s(bn)(n.href):void 0,target:t.target??(e.value?"_blank":void 0),rel:t.rel??(e.value?"noreferrer":void 0)},{default:m(()=>[u(r.$slots,"default",{},()=>[K(C(n.text),1)],!0)]),_:3},8,["class","href","target","rel"]))}}),ve=y(be,[["__scopeId","data-v-58d3b43b"]]),ye=["src","alt"],Se=f({inheritAttrs:!1,__name:"VPImage",props:{image:{},alt:{}},setup(n){return(t,e)=>{const o=U("VPImage",!0);return n.image?(i(),c(R,{key:0},[typeof n.image=="string"||"src"in n.image?(i(),c("img",j({key:0,class:"VPImage"},typeof n.image=="string"?t.$attrs:{...n.image,...t.$attrs},{src:s(un)(typeof n.image=="string"?n.image:n.image.src),alt:n.alt??(typeof n.image=="string"?"":n.image.alt||"")}),null,16,ye)):(i(),c(R,{key:1},[h(o,j({class:"dark",image:n.image.dark,alt:n.image.alt},t.$attrs),null,16,["image","alt"]),h(o,j({class:"light",image:n.image.light,alt:n.image.alt},t.$attrs),null,16,["image","alt"])],64))],64)):g("",!0)}}}),X=y(Se,[["__scopeId","data-v-ab19afbb"]]),ke={class:"container"},we={class:"main"},Pe={class:"heading"},Me=["innerHTML"],Te=["innerHTML"],Ce=["innerHTML"],xe={key:0,class:"actions"},Re={key:0,class:"image"},Ie={class:"image-container"},He=f({__name:"VPHero",props:{name:{},text:{},tagline:{},image:{},actions:{}},setup(n){const{heroImageSlotExists:t}=nn(On);return(e,o)=>(i(),c("div",{class:M(["VPHero",{"has-image":n.image||s(t)}])},[p("div",ke,[p("div",we,[u(e.$slots,"home-hero-info-before",{},void 0,!0),u(e.$slots,"home-hero-info",{},()=>[p("h1",Pe,[n.name?(i(),c("span",{key:0,innerHTML:n.name,class:"name clip"},null,8,Me)):g("",!0),n.text?(i(),c("span",{key:1,innerHTML:n.text,class:"text"},null,8,Te)):g("",!0)]),n.tagline?(i(),c("p",{key:0,innerHTML:n.tagline,class:"tagline"},null,8,Ce)):g("",!0)],!0),u(e.$slots,"home-hero-info-after",{},void 0,!0),n.actions?(i(),c("div",xe,[(i(!0),c(R,null,D(n.actions,r=>(i(),c("div",{key:r.link,class:"action"},[h(ve,{tag:"a",size:"medium",theme:r.theme,text:r.text,href:r.link,target:r.target,rel:r.rel},null,8,["theme","text","href","target","rel"])]))),128))])):g("",!0),u(e.$slots,"home-hero-actions-after",{},void 0,!0)]),n.image||s(t)?(i(),c("div",Re,[p("div",Ie,[o[0]||(o[0]=p("div",{class:"image-bg"},null,-1)),u(e.$slots,"home-hero-image",{},()=>[n.image?(i(),b(X,{key:0,class:"image-src",image:n.image},null,8,["image"])):g("",!0)],!0)])])):g("",!0)])],2))}}),De=y(He,[["__scopeId","data-v-a4190d00"]]),_e=f({__name:"VPHomeHero",setup(n){const{frontmatter:t}=k();return(e,o)=>s(t).hero?(i(),b(De,{key:0,class:"VPHomeHero",name:s(t).hero.name,text:s(t).hero.text,tagline:s(t).hero.tagline,image:s(t).hero.image,actions:s(t).hero.actions},{"home-hero-info-before":m(()=>[u(e.$slots,"home-hero-info-before")]),"home-hero-info":m(()=>[u(e.$slots,"home-hero-info")]),"home-hero-info-after":m(()=>[u(e.$slots,"home-hero-info-after")]),"home-hero-actions-after":m(()=>[u(e.$slots,"home-hero-actions-after")]),"home-hero-image":m(()=>[u(e.$slots,"home-hero-image")]),_:3},8,["name","text","tagline","image","actions"])):g("",!0)}}),Ee={class:"box"},Ve={key:0,class:"icon"},Le=["innerHTML"],Ae=["innerHTML"],Fe=["innerHTML"],Oe={key:4,class:"link-text"},qe={class:"link-text-value"},je=f({__name:"VPFeature",props:{icon:{},title:{},details:{},link:{},linkText:{},rel:{},target:{}},setup(n){return(t,e)=>(i(),b(A,{class:"VPFeature",href:n.link,rel:n.rel,target:n.target,"no-icon":!0,tag:n.link?"a":"div"},{default:m(()=>[p("article",Ee,[typeof n.icon=="object"&&n.icon.wrap?(i(),c("div",Ve,[h(X,{image:n.icon,alt:n.icon.alt,height:n.icon.height||48,width:n.icon.width||48},null,8,["image","alt","height","width"])])):typeof n.icon=="object"?(i(),b(X,{key:1,image:n.icon,alt:n.icon.alt,height:n.icon.height||48,width:n.icon.width||48},null,8,["image","alt","height","width"])):n.icon?(i(),c("div",{key:2,class:"icon",innerHTML:n.icon},null,8,Le)):g("",!0),p("h2",{class:"title",innerHTML:n.title},null,8,Ae),n.details?(i(),c("p",{key:3,class:"details",innerHTML:n.details},null,8,Fe)):g("",!0),n.linkText?(i(),c("div",Oe,[p("p",qe,[K(C(n.linkText)+" ",1),e[0]||(e[0]=p("span",{class:"vpi-arrow-right link-text-icon"},null,-1))])])):g("",!0)])]),_:1},8,["href","rel","target","tag"]))}}),Ke=y(je,[["__scopeId","data-v-02d1074d"]]),Ne={key:0,class:"VPFeatures"},$e={class:"container"},Ue={class:"items"},Je=f({__name:"VPFeatures",props:{features:{}},setup(n){const t=n,e=S(()=>{const o=t.features.length;if(o){if(o===2)return"grid-2";if(o===3)return"grid-3";if(o%3===0)return"grid-6";if(o>3)return"grid-4"}else return});return(o,r)=>n.features?(i(),c("div",Ne,[p("div",$e,[p("div",Ue,[(i(!0),c(R,null,D(n.features,l=>(i(),c("div",{key:l.title,class:M(["item",[e.value]])},[h(Ke,{icon:l.icon,title:l.title,details:l.details,link:l.link,"link-text":l.linkText,rel:l.rel,target:l.target},null,8,["icon","title","details","link","link-text","rel","target"])],2))),128))])])])):g("",!0)}}),We=y(Je,[["__scopeId","data-v-b1eea84a"]]),Be=f({__name:"VPHomeFeatures",setup(n){const{frontmatter:t}=k();return(e,o)=>s(t).features?(i(),b(We,{key:0,class:"VPHomeFeatures",features:s(t).features},null,8,["features"])):g("",!0)}}),Ge=f({__name:"VPHomeContent",setup(n){const{width:t}=Gn({initialWidth:0,includeScrollbar:!1});return(e,o)=>(i(),c("div",{class:"vp-doc container",style:fn(s(t)?{"--vp-offset":`calc(50% - ${s(t)/2}px)`}:{})},[u(e.$slots,"default",{},void 0,!0)],4))}}),ze=y(Ge,[["__scopeId","data-v-c141a4bd"]]),Qe=f({__name:"VPHome",setup(n){const{frontmatter:t,theme:e}=k();return(o,r)=>{const l=U("Content");return i(),c("div",{class:M(["VPHome",{"external-link-icon-enabled":s(e).externalLinkIcon}])},[u(o.$slots,"home-hero-before",{},void 0,!0),h(_e,null,{"home-hero-info-before":m(()=>[u(o.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":m(()=>[u(o.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":m(()=>[u(o.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":m(()=>[u(o.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":m(()=>[u(o.$slots,"home-hero-image",{},void 0,!0)]),_:3}),u(o.$slots,"home-hero-after",{},void 0,!0),u(o.$slots,"home-features-before",{},void 0,!0),h(Be),u(o.$slots,"home-features-after",{},void 0,!0),s(t).markdownStyles!==!1?(i(),b(ze,{key:0},{default:m(()=>[h(l)]),_:1})):(i(),b(l,{key:1}))],2)}}}),Xe=y(Qe,[["__scopeId","data-v-e07eaea7"]]),Ye={},Ze={class:"VPPage"};function no(n,t){const e=U("Content");return i(),c("div",Ze,[u(n.$slots,"page-top"),h(e),u(n.$slots,"page-bottom")])}const to=y(Ye,[["render",no]]),eo=f({__name:"VPContent",setup(n){const{page:t,frontmatter:e}=k(),{isHome:o,hasSidebar:r}=q();return(l,d)=>(i(),c("div",{class:M(["VPContent",{"has-sidebar":s(r),"is-home":s(o)}]),id:"VPContent"},[s(t).isNotFound?u(l.$slots,"not-found",{key:0},()=>[h(bt)],!0):s(e).layout==="page"?(i(),b(to,{key:1},{"page-top":m(()=>[u(l.$slots,"page-top",{},void 0,!0)]),"page-bottom":m(()=>[u(l.$slots,"page-bottom",{},void 0,!0)]),_:3})):s(e).layout==="home"?(i(),b(Xe,{key:2},{"home-hero-before":m(()=>[u(l.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":m(()=>[u(l.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":m(()=>[u(l.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":m(()=>[u(l.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":m(()=>[u(l.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":m(()=>[u(l.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":m(()=>[u(l.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":m(()=>[u(l.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":m(()=>[u(l.$slots,"home-features-after",{},void 0,!0)]),_:3})):s(e).layout&&s(e).layout!=="doc"?(i(),b(L(s(e).layout),{key:3})):(i(),b(he,{key:4},{"doc-top":m(()=>[u(l.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":m(()=>[u(l.$slots,"doc-bottom",{},void 0,!0)]),"doc-footer-before":m(()=>[u(l.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":m(()=>[u(l.$slots,"doc-before",{},void 0,!0)]),"doc-after":m(()=>[u(l.$slots,"doc-after",{},void 0,!0)]),"aside-top":m(()=>[u(l.$slots,"aside-top",{},void 0,!0)]),"aside-outline-before":m(()=>[u(l.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":m(()=>[u(l.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":m(()=>[u(l.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":m(()=>[u(l.$slots,"aside-ads-after",{},void 0,!0)]),"aside-bottom":m(()=>[u(l.$slots,"aside-bottom",{},void 0,!0)]),_:3}))],2))}}),oo=y(eo,[["__scopeId","data-v-2652e39a"]]),ro={class:"container"},io=["innerHTML"],lo=["innerHTML"],so=f({__name:"VPFooter",setup(n){const{theme:t,frontmatter:e}=k(),{hasSidebar:o}=q();return(r,l)=>s(t).footer&&s(e).footer!==!1?(i(),c("footer",{key:0,class:M(["VPFooter",{"has-sidebar":s(o)}])},[p("div",ro,[s(t).footer.message?(i(),c("p",{key:0,class:"message",innerHTML:s(t).footer.message},null,8,io)):g("",!0),s(t).footer.copyright?(i(),c("p",{key:1,class:"copyright",innerHTML:s(t).footer.copyright},null,8,lo)):g("",!0)])],2)):g("",!0)}}),ao=y(so,[["__scopeId","data-v-5b9946f5"]]),co={class:"menu-text"},uo={class:"header"},po={class:"outline"},mo=f({__name:"VPLocalNavOutlineDropdown",props:{headers:{},navHeight:{}},setup(n){const t=n,{theme:e}=k(),o=w(!1),r=w(0),l=w(),d=w();function a(x){l.value?.contains(x.target)||(o.value=!1)}F(o,x=>{if(x){document.addEventListener("click",a);return}document.removeEventListener("click",a)}),zn("Escape",()=>{o.value=!1}),Hn(()=>{o.value=!1});function v(){o.value=!o.value,r.value=window.innerHeight+Math.min(window.scrollY-t.navHeight,0)}function P(x){x.target.classList.contains("outline-link")&&(d.value&&(d.value.style.transition="none"),hn(()=>{o.value=!1}))}function T(){o.value=!1,window.scrollTo({top:0,left:0,behavior:"smooth"})}return(x,H)=>(i(),c("div",{class:"VPLocalNavOutlineDropdown",style:fn({"--vp-vh":r.value+"px"}),ref_key:"main",ref:l},[n.headers.length>0?(i(),c("button",{key:0,onClick:v,class:M({open:o.value})},[p("span",co,C(s(Fn)(s(e))),1),H[0]||(H[0]=p("span",{class:"vpi-chevron-right icon"},null,-1))],2)):(i(),c("button",{key:1,onClick:T},C(s(e).returnToTopLabel||"Return to top"),1)),h(cn,{name:"flyout"},{default:m(()=>[o.value?(i(),c("div",{key:0,ref_key:"items",ref:d,class:"items",onClick:P},[p("div",uo,[p("a",{class:"top-link",href:"#",onClick:T},C(s(e).returnToTopLabel||"Return to top"),1)]),p("div",po,[h(qn,{headers:n.headers},null,8,["headers"])])],512)):g("",!0)]),_:1})],4))}}),go=y(mo,[["__scopeId","data-v-e28a51a6"]]),fo={class:"container"},ho=["aria-expanded"],bo={class:"menu-text"},vo=f({__name:"VPLocalNav",props:{open:{type:Boolean}},emits:["open-menu"],setup(n){const{theme:t}=k(),{isHome:e,hasSidebar:o,headers:r,hasLocalNav:l}=q(),{y:d}=_n(),a=w(0);N(()=>{a.value=parseInt(getComputedStyle(document.documentElement).getPropertyValue("--vp-nav-height"))});const v=S(()=>({VPLocalNav:!0,"has-sidebar":o.value,empty:!l.value,fixed:!l.value&&!o.value}));return(P,T)=>!s(e)&&(s(l)||s(o)||s(d)>=a.value)?(i(),c("div",{key:0,class:M(v.value)},[p("div",fo,[s(o)?(i(),c("button",{key:0,class:"menu","aria-expanded":n.open,"aria-controls":"VPSidebarNav",onClick:T[0]||(T[0]=x=>P.$emit("open-menu"))},[T[1]||(T[1]=p("span",{class:"vpi-align-left menu-icon"},null,-1)),p("span",bo,C(s(t).sidebarMenuLabel||"Menu"),1)],8,ho)):g("",!0),h(go,{headers:s(r),navHeight:a.value},null,8,["headers","navHeight"])])],2)):g("",!0)}}),yo=y(vo,[["__scopeId","data-v-5ae341c6"]]);function So(){const n=w(!1);function t(){n.value=!0,window.addEventListener("resize",r)}function e(){n.value=!1,window.removeEventListener("resize",r)}function o(){n.value?e():t()}function r(){window.outerWidth>=768&&e()}const l=Z();return F(()=>l.path,e),{isScreenOpen:n,openScreen:t,closeScreen:e,toggleScreen:o}}const vn=Symbol("nav"),ko={},wo={class:"VPSwitch",type:"button",role:"switch"},Po={class:"check"},Mo={key:0,class:"icon"};function To(n,t){return i(),c("button",wo,[p("span",Po,[n.$slots.default?(i(),c("span",Mo,[u(n.$slots,"default",{},void 0,!0)])):g("",!0)])])}const Co=y(ko,[["render",To],["__scopeId","data-v-b4ccac88"]]),xo=f({__name:"VPSwitchAppearance",setup(n){const{isDark:t,theme:e}=k(),o=nn("toggle-appearance",()=>{t.value=!t.value}),r=w("");return mn(()=>{r.value=t.value?e.value.lightModeSwitchTitle||"Switch to light theme":e.value.darkModeSwitchTitle||"Switch to dark theme"}),(l,d)=>(i(),b(Co,{title:r.value,class:"VPSwitchAppearance","aria-checked":s(t),onClick:s(o)},{default:m(()=>[...d[0]||(d[0]=[p("span",{class:"vpi-sun sun"},null,-1),p("span",{class:"vpi-moon moon"},null,-1)])]),_:1},8,["title","aria-checked","onClick"]))}}),yn=y(xo,[["__scopeId","data-v-be9742d9"]]),Ro={key:0,class:"VPNavBarAppearance"},Io=f({__name:"VPNavBarAppearance",setup(n){const{site:t}=k();return(e,o)=>s(t).appearance&&s(t).appearance!=="force-dark"&&s(t).appearance!=="force-auto"?(i(),c("div",Ro,[h(yn)])):g("",!0)}}),Ho=y(Io,[["__scopeId","data-v-3f90c1a5"]]),Sn=w();let jn=!1,en=0;function Do(n){const t=w(!1);if(G){!jn&&_o(),en++;const e=F(Sn,o=>{o===n.el.value||n.el.value?.contains(o)?(t.value=!0,n.onFocus?.()):(t.value=!1,n.onBlur?.())});pn(()=>{e(),en--,en||Eo()})}return Qn(t)}function _o(){document.addEventListener("focusin",Kn),jn=!0,Sn.value=document.activeElement}function Eo(){document.removeEventListener("focusin",Kn)}function Kn(){Sn.value=document.activeElement}const Vo={class:"VPMenuLink"},Lo=["innerHTML"],Ao=f({__name:"VPMenuLink",props:{item:{}},setup(n){const{page:t}=k();return(e,o)=>(i(),c("div",Vo,[h(A,{class:M({active:s($)(s(t).relativePath,n.item.activeMatch||n.item.link,!!n.item.activeMatch)}),href:n.item.link,target:n.item.target,rel:n.item.rel,"no-icon":n.item.noIcon},{default:m(()=>[p("span",{innerHTML:n.item.text},null,8,Lo)]),_:1},8,["class","href","target","rel","no-icon"])]))}}),tn=y(Ao,[["__scopeId","data-v-f2aefde6"]]),Fo={class:"VPMenuGroup"},Oo={key:0,class:"title"},qo=f({__name:"VPMenuGroup",props:{text:{},items:{}},setup(n){return(t,e)=>(i(),c("div",Fo,[n.text?(i(),c("p",Oo,C(n.text),1)):g("",!0),(i(!0),c(R,null,D(n.items,o=>(i(),c(R,{key:JSON.stringify(o)},["link"in o?(i(),b(tn,{key:0,item:o},null,8,["item"])):g("",!0)],64))),128))]))}}),jo=y(qo,[["__scopeId","data-v-5474bd6a"]]),Ko={class:"VPMenu"},No={key:0,class:"items"},$o=f({__name:"VPMenu",props:{items:{}},setup(n){return(t,e)=>(i(),c("div",Ko,[n.items?(i(),c("div",No,[(i(!0),c(R,null,D(n.items,o=>(i(),c(R,{key:JSON.stringify(o)},["link"in o?(i(),b(tn,{key:0,item:o},null,8,["item"])):"component"in o?(i(),b(L(o.component),j({key:1,ref_for:!0},o.props),null,16)):(i(),b(jo,{key:2,text:o.text,items:o.items},null,8,["text","items"]))],64))),128))])):g("",!0),u(t.$slots,"default",{},void 0,!0)]))}}),Uo=y($o,[["__scopeId","data-v-fcd1d7a8"]]),Jo=["aria-expanded","aria-label"],Wo={key:0,class:"text"},Bo=["innerHTML"],Go={key:1,class:"vpi-more-horizontal icon"},zo={class:"menu"},Qo=f({__name:"VPFlyout",props:{icon:{},button:{},label:{},items:{}},setup(n){const t=w(!1),e=w();Do({el:e,onBlur:o});function o(){t.value=!1}return(r,l)=>(i(),c("div",{class:"VPFlyout",ref_key:"el",ref:e,onMouseenter:l[1]||(l[1]=d=>t.value=!0),onMouseleave:l[2]||(l[2]=d=>t.value=!1)},[p("button",{type:"button",class:"button","aria-haspopup":"true","aria-expanded":t.value,"aria-label":n.label,onClick:l[0]||(l[0]=d=>t.value=!t.value)},[n.button||n.icon?(i(),c("span",Wo,[n.icon?(i(),c("span",{key:0,class:M([n.icon,"option-icon"])},null,2)):g("",!0),n.button?(i(),c("span",{key:1,innerHTML:n.button},null,8,Bo)):g("",!0),l[3]||(l[3]=p("span",{class:"vpi-chevron-down text-icon"},null,-1))])):(i(),c("span",Go))],8,Jo),p("div",zo,[h(Uo,{items:n.items},{default:m(()=>[u(r.$slots,"default",{},void 0,!0)]),_:3},8,["items"])])],544))}}),kn=y(Qo,[["__scopeId","data-v-d8fae6e2"]]),Xo=["href","aria-label","rel","innerHTML"],Yo=f({__name:"VPSocialLink",props:{icon:{},link:{},ariaLabel:{},me:{type:Boolean}},setup(n){const t=n,e=w();N(async()=>{await hn();const r=e.value?.children[0];r instanceof HTMLElement&&r.className.startsWith("vpi-social-")&&(getComputedStyle(r).maskImage||getComputedStyle(r).webkitMaskImage)==="none"&&r.style.setProperty("--icon",`url('https://api.iconify.design/simple-icons/${t.icon}.svg')`)});const o=S(()=>typeof t.icon=="object"?t.icon.svg:`<span class="vpi-social-${t.icon}"></span>`);return(r,l)=>(i(),c("a",{ref_key:"el",ref:e,class:"VPSocialLink no-icon",href:n.link,"aria-label":n.ariaLabel??(typeof n.icon=="string"?n.icon:""),target:"_blank",rel:n.me?"me noopener":"noopener",innerHTML:o.value},null,8,Xo))}}),Zo=y(Yo,[["__scopeId","data-v-32d78712"]]),nr={class:"VPSocialLinks"},tr=f({__name:"VPSocialLinks",props:{links:{},me:{type:Boolean,default:!0}},setup(n){return(t,e)=>(i(),c("div",nr,[(i(!0),c(R,null,D(n.links,({link:o,icon:r,ariaLabel:l})=>(i(),b(Zo,{key:o,icon:r,link:o,ariaLabel:l,me:n.me},null,8,["icon","link","ariaLabel","me"]))),128))]))}}),wn=y(tr,[["__scopeId","data-v-a1a7286e"]]),er={key:0,class:"group translations"},or={class:"trans-title"},rr={key:1,class:"group"},ir={class:"item appearance"},lr={class:"label"},sr={class:"appearance-action"},ar={key:2,class:"group"},dr={class:"item social-links"},cr=f({__name:"VPNavBarExtra",setup(n){const{site:t,theme:e}=k(),{localeLinks:o,currentLang:r}=z({correspondingLink:!0}),l=S(()=>o.value.length&&r.value.label||t.value.appearance||e.value.socialLinks);return(d,a)=>l.value?(i(),b(kn,{key:0,class:"VPNavBarExtra",label:"extra navigation"},{default:m(()=>[s(o).length&&s(r).label?(i(),c("div",er,[p("p",or,C(s(r).label),1),(i(!0),c(R,null,D(s(o),v=>(i(),b(tn,{key:v.link,item:v},null,8,["item"]))),128))])):g("",!0),s(t).appearance&&s(t).appearance!=="force-dark"&&s(t).appearance!=="force-auto"?(i(),c("div",rr,[p("div",ir,[p("p",lr,C(s(e).darkModeSwitchLabel||"Appearance"),1),p("div",sr,[h(yn)])])])):g("",!0),s(e).socialLinks?(i(),c("div",ar,[p("div",dr,[h(wn,{class:"social-links-list",links:s(e).socialLinks},null,8,["links"])])])):g("",!0)]),_:1})):g("",!0)}}),ur=y(cr,[["__scopeId","data-v-f953d92f"]]),pr=["aria-expanded"],mr=f({__name:"VPNavBarHamburger",props:{active:{type:Boolean}},emits:["click"],setup(n){return(t,e)=>(i(),c("button",{type:"button",class:M(["VPNavBarHamburger",{active:n.active}]),"aria-label":"mobile navigation","aria-expanded":n.active,"aria-controls":"VPNavScreen",onClick:e[0]||(e[0]=o=>t.$emit("click"))},[...e[1]||(e[1]=[p("span",{class:"container"},[p("span",{class:"top"}),p("span",{class:"middle"}),p("span",{class:"bottom"})],-1)])],10,pr))}}),gr=y(mr,[["__scopeId","data-v-6bee1efd"]]),fr=["innerHTML"],hr=f({__name:"VPNavBarMenuLink",props:{item:{}},setup(n){const{page:t}=k();return(e,o)=>(i(),b(A,{class:M({VPNavBarMenuLink:!0,active:s($)(s(t).relativePath,n.item.activeMatch||n.item.link,!!n.item.activeMatch)}),href:n.item.link,target:n.item.target,rel:n.item.rel,"no-icon":n.item.noIcon,tabindex:"0"},{default:m(()=>[p("span",{innerHTML:n.item.text},null,8,fr)]),_:1},8,["class","href","target","rel","no-icon"]))}}),br=y(hr,[["__scopeId","data-v-815115f5"]]),vr=f({__name:"VPNavBarMenuGroup",props:{item:{}},setup(n){const t=n,{page:e}=k(),o=l=>"component"in l?!1:"link"in l?$(e.value.relativePath,l.link,!!t.item.activeMatch):l.items.some(o),r=S(()=>o(t.item));return(l,d)=>(i(),b(kn,{class:M({VPNavBarMenuGroup:!0,active:s($)(s(e).relativePath,n.item.activeMatch,!!n.item.activeMatch)||r.value}),button:n.item.text,items:n.item.items},null,8,["class","button","items"]))}}),yr={key:0,"aria-labelledby":"main-nav-aria-label",class:"VPNavBarMenu"},Sr=f({__name:"VPNavBarMenu",setup(n){const{theme:t}=k();return(e,o)=>s(t).nav?(i(),c("nav",yr,[o[0]||(o[0]=p("span",{id:"main-nav-aria-label",class:"visually-hidden"}," Main Navigation ",-1)),(i(!0),c(R,null,D(s(t).nav,r=>(i(),c(R,{key:JSON.stringify(r)},["link"in r?(i(),b(br,{key:0,item:r},null,8,["item"])):"component"in r?(i(),b(L(r.component),j({key:1,ref_for:!0},r.props),null,16)):(i(),b(vr,{key:2,item:r},null,8,["item"]))],64))),128))])):g("",!0)}}),kr=y(Sr,[["__scopeId","data-v-020be4db"]]);function wr(n){const{localeIndex:t,theme:e}=k();function o(r){const l=r.split("."),d=e.value.search?.options,a=d&&typeof d=="object",v=a&&d.locales?.[t.value]?.translations||null,P=a&&d.translations||null;let T=v,x=P,H=n;const _=l.pop();for(const I of l){let E=null;const O=H?.[I];O&&(E=H=O);const V=x?.[I];V&&(E=x=V);const W=T?.[I];W&&(E=T=W),O||(H=E),V||(x=E),W||(T=E)}return T?.[_]??x?.[_]??H?.[_]??""}return o}const Pr=["aria-label"],Mr={class:"DocSearch-Button-Container"},Tr={class:"DocSearch-Button-Placeholder"},xn=f({__name:"VPNavBarSearchButton",setup(n){const e=wr({button:{buttonText:"Search",buttonAriaLabel:"Search"}});return(o,r)=>(i(),c("button",{type:"button","aria-label":s(e)("button.buttonAriaLabel"),"aria-keyshortcuts":"/ control+k meta+k",class:"DocSearch DocSearch-Button"},[p("span",Mr,[r[0]||(r[0]=p("span",{class:"vpi-search DocSearch-Search-Icon"},null,-1)),p("span",Tr,C(s(e)("button.buttonText")),1)]),r[1]||(r[1]=p("span",{class:"DocSearch-Button-Keys"},[p("kbd",{class:"DocSearch-Button-Key"}),p("kbd",{class:"DocSearch-Button-Key"})],-1))],8,Pr))}}),Cr={class:"VPNavBarSearch"},xr={id:"local-search"},Rr={key:1,id:"docsearch"},Ir=f({__name:"VPNavBarSearch",setup(n){const t=()=>null,e=()=>null,{theme:o}=k(),r=w(!1),l=w(!1);N(()=>{});function d(){r.value||(r.value=!0,setTimeout(a,16))}function a(){const T=new Event("keydown");T.key="k",T.metaKey=!0,window.dispatchEvent(T),setTimeout(()=>{document.querySelector(".DocSearch-Modal")||a()},16)}const v=w(!1),P="";return(T,x)=>(i(),c("div",Cr,[s(P)==="local"?(i(),c(R,{key:0},[v.value?(i(),b(s(t),{key:0,onClose:x[0]||(x[0]=H=>v.value=!1)})):g("",!0),p("div",xr,[h(xn,{onClick:x[1]||(x[1]=H=>v.value=!0)})])],64)):s(P)==="algolia"?(i(),c(R,{key:1},[r.value?(i(),b(s(e),{key:0,algolia:s(o).search?.options??s(o).algolia,onVnodeBeforeMount:x[2]||(x[2]=H=>l.value=!0)},null,8,["algolia"])):g("",!0),l.value?g("",!0):(i(),c("div",Rr,[h(xn,{onClick:d})]))],64)):g("",!0)]))}}),Hr=f({__name:"VPNavBarSocialLinks",setup(n){const{theme:t}=k();return(e,o)=>s(t).socialLinks?(i(),b(wn,{key:0,class:"VPNavBarSocialLinks",links:s(t).socialLinks},null,8,["links"])):g("",!0)}}),Dr=y(Hr,[["__scopeId","data-v-ef6192dc"]]),_r=["href","rel","target"],Er=["innerHTML"],Vr={key:2},Lr=f({__name:"VPNavBarTitle",setup(n){const{site:t,theme:e}=k(),{hasSidebar:o}=q(),{currentLang:r}=z(),l=S(()=>typeof e.value.logoLink=="string"?e.value.logoLink:e.value.logoLink?.link),d=S(()=>typeof e.value.logoLink=="string"?void 0:e.value.logoLink?.rel),a=S(()=>typeof e.value.logoLink=="string"?void 0:e.value.logoLink?.target);return(v,P)=>(i(),c("div",{class:M(["VPNavBarTitle",{"has-sidebar":s(o)}])},[p("a",{class:"title",href:l.value??s(bn)(s(r).link),rel:d.value,target:a.value},[u(v.$slots,"nav-bar-title-before",{},void 0,!0),s(e).logo?(i(),b(X,{key:0,class:"logo",image:s(e).logo},null,8,["image"])):g("",!0),s(e).siteTitle?(i(),c("span",{key:1,innerHTML:s(e).siteTitle},null,8,Er)):s(e).siteTitle===void 0?(i(),c("span",Vr,C(s(t).title),1)):g("",!0),u(v.$slots,"nav-bar-title-after",{},void 0,!0)],8,_r)],2))}}),Ar=y(Lr,[["__scopeId","data-v-d4488dd0"]]),Fr={class:"items"},Or={class:"title"},qr=f({__name:"VPNavBarTranslations",setup(n){const{theme:t}=k(),{localeLinks:e,currentLang:o}=z({correspondingLink:!0});return(r,l)=>s(e).length&&s(o).label?(i(),b(kn,{key:0,class:"VPNavBarTranslations",icon:"vpi-languages",label:s(t).langMenuLabel||"Change language"},{default:m(()=>[p("div",Fr,[p("p",Or,C(s(o).label),1),(i(!0),c(R,null,D(s(e),d=>(i(),b(tn,{key:d.link,item:d},null,8,["item"]))),128))])]),_:1},8,["label"])):g("",!0)}}),jr=y(qr,[["__scopeId","data-v-acee064b"]]),Kr={class:"wrapper"},Nr={class:"container"},$r={class:"title"},Ur={class:"content"},Jr={class:"content-body"},Wr=f({__name:"VPNavBar",props:{isScreenOpen:{type:Boolean}},emits:["toggle-screen"],setup(n){const t=n,{y:e}=_n(),{isHome:o,hasSidebar:r}=q(),l=w({});return mn(()=>{l.value={"has-sidebar":r.value,home:o.value,top:e.value===0,"screen-open":t.isScreenOpen}}),(d,a)=>(i(),c("div",{class:M(["VPNavBar",l.value])},[p("div",Kr,[p("div",Nr,[p("div",$r,[h(Ar,null,{"nav-bar-title-before":m(()=>[u(d.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":m(()=>[u(d.$slots,"nav-bar-title-after",{},void 0,!0)]),_:3})]),p("div",Ur,[p("div",Jr,[u(d.$slots,"nav-bar-content-before",{},void 0,!0),h(Ir,{class:"search"}),h(kr,{class:"menu"}),h(jr,{class:"translations"}),h(Ho,{class:"appearance"}),h(Dr,{class:"social-links"}),h(ur,{class:"extra"}),u(d.$slots,"nav-bar-content-after",{},void 0,!0),h(gr,{class:"hamburger",active:n.isScreenOpen,onClick:a[0]||(a[0]=v=>d.$emit("toggle-screen"))},null,8,["active"])])])])]),a[1]||(a[1]=p("div",{class:"divider"},[p("div",{class:"divider-line"})],-1))],2))}}),Br=y(Wr,[["__scopeId","data-v-8eab0e6d"]]),Gr={key:0,class:"VPNavScreenAppearance"},zr={class:"text"},Qr=f({__name:"VPNavScreenAppearance",setup(n){const{site:t,theme:e}=k();return(o,r)=>s(t).appearance&&s(t).appearance!=="force-dark"&&s(t).appearance!=="force-auto"?(i(),c("div",Gr,[p("p",zr,C(s(e).darkModeSwitchLabel||"Appearance"),1),h(yn)])):g("",!0)}}),Xr=y(Qr,[["__scopeId","data-v-a3e2920d"]]),Yr=["innerHTML"],Zr=f({__name:"VPNavScreenMenuLink",props:{item:{}},setup(n){const{closeScreen:t}=nn(vn);return(e,o)=>(i(),b(A,{class:"VPNavScreenMenuLink",href:n.item.link,target:n.item.target,rel:n.item.rel,"no-icon":n.item.noIcon,onClick:s(t)},{default:m(()=>[p("span",{innerHTML:n.item.text},null,8,Yr)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),ni=y(Zr,[["__scopeId","data-v-0c441e57"]]),ti=["innerHTML"],ei=f({__name:"VPNavScreenMenuGroupLink",props:{item:{}},setup(n){const{closeScreen:t}=nn(vn);return(e,o)=>(i(),b(A,{class:"VPNavScreenMenuGroupLink",href:n.item.link,target:n.item.target,rel:n.item.rel,"no-icon":n.item.noIcon,onClick:s(t)},{default:m(()=>[p("span",{innerHTML:n.item.text},null,8,ti)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),Nn=y(ei,[["__scopeId","data-v-37ed8a9a"]]),oi={class:"VPNavScreenMenuGroupSection"},ri={key:0,class:"title"},ii=f({__name:"VPNavScreenMenuGroupSection",props:{text:{},items:{}},setup(n){return(t,e)=>(i(),c("div",oi,[n.text?(i(),c("p",ri,C(n.text),1)):g("",!0),(i(!0),c(R,null,D(n.items,o=>(i(),b(Nn,{key:o.text,item:o},null,8,["item"]))),128))]))}}),li=y(ii,[["__scopeId","data-v-7dfe209c"]]),si=["aria-controls","aria-expanded"],ai=["innerHTML"],di=["id"],ci={key:0,class:"item"},ui={key:1,class:"item"},pi={key:2,class:"group"},mi=f({__name:"VPNavScreenMenuGroup",props:{text:{},items:{}},setup(n){const t=n,e=w(!1),o=S(()=>`NavScreenGroup-${t.text.replace(" ","-").toLowerCase()}`);function r(){e.value=!e.value}return(l,d)=>(i(),c("div",{class:M(["VPNavScreenMenuGroup",{open:e.value}])},[p("button",{class:"button","aria-controls":o.value,"aria-expanded":e.value,onClick:r},[p("span",{class:"button-text",innerHTML:n.text},null,8,ai),d[0]||(d[0]=p("span",{class:"vpi-plus button-icon"},null,-1))],8,si),p("div",{id:o.value,class:"items"},[(i(!0),c(R,null,D(n.items,a=>(i(),c(R,{key:JSON.stringify(a)},["link"in a?(i(),c("div",ci,[h(Nn,{item:a},null,8,["item"])])):"component"in a?(i(),c("div",ui,[(i(),b(L(a.component),j({ref_for:!0},a.props,{"screen-menu":""}),null,16))])):(i(),c("div",pi,[h(li,{text:a.text,items:a.items},null,8,["text","items"])]))],64))),128))],8,di)],2))}}),gi=y(mi,[["__scopeId","data-v-d3547da8"]]),fi={key:0,class:"VPNavScreenMenu"},hi=f({__name:"VPNavScreenMenu",setup(n){const{theme:t}=k();return(e,o)=>s(t).nav?(i(),c("nav",fi,[(i(!0),c(R,null,D(s(t).nav,r=>(i(),c(R,{key:JSON.stringify(r)},["link"in r?(i(),b(ni,{key:0,item:r},null,8,["item"])):"component"in r?(i(),b(L(r.component),j({key:1,ref_for:!0},r.props,{"screen-menu":""}),null,16)):(i(),b(gi,{key:2,text:r.text||"",items:r.items},null,8,["text","items"]))],64))),128))])):g("",!0)}}),bi=f({__name:"VPNavScreenSocialLinks",setup(n){const{theme:t}=k();return(e,o)=>s(t).socialLinks?(i(),b(wn,{key:0,class:"VPNavScreenSocialLinks",links:s(t).socialLinks},null,8,["links"])):g("",!0)}}),vi={class:"list"},yi=f({__name:"VPNavScreenTranslations",setup(n){const{localeLinks:t,currentLang:e}=z({correspondingLink:!0}),o=w(!1);function r(){o.value=!o.value}return(l,d)=>s(t).length&&s(e).label?(i(),c("div",{key:0,class:M(["VPNavScreenTranslations",{open:o.value}])},[p("button",{class:"title",onClick:r},[d[0]||(d[0]=p("span",{class:"vpi-languages icon lang"},null,-1)),K(" "+C(s(e).label)+" ",1),d[1]||(d[1]=p("span",{class:"vpi-chevron-down icon chevron"},null,-1))]),p("ul",vi,[(i(!0),c(R,null,D(s(t),a=>(i(),c("li",{key:a.link,class:"item"},[h(A,{class:"link",href:a.link},{default:m(()=>[K(C(a.text),1)]),_:2},1032,["href"])]))),128))])],2)):g("",!0)}}),Si=y(yi,[["__scopeId","data-v-516e4bc3"]]),ki={class:"container"},wi=f({__name:"VPNavScreen",props:{open:{type:Boolean}},setup(n){const t=w(null),e=En(G?document.body:null);return(o,r)=>(i(),b(cn,{name:"fade",onEnter:r[0]||(r[0]=l=>e.value=!0),onAfterLeave:r[1]||(r[1]=l=>e.value=!1)},{default:m(()=>[n.open?(i(),c("div",{key:0,class:"VPNavScreen",ref_key:"screen",ref:t,id:"VPNavScreen"},[p("div",ki,[u(o.$slots,"nav-screen-content-before",{},void 0,!0),h(hi,{class:"menu"}),h(Si,{class:"translations"}),h(Xr,{class:"appearance"}),h(bi,{class:"social-links"}),u(o.$slots,"nav-screen-content-after",{},void 0,!0)])],512)):g("",!0)]),_:3}))}}),Pi=y(wi,[["__scopeId","data-v-2dd6d0c7"]]),Mi={key:0,class:"VPNav"},Ti=f({__name:"VPNav",setup(n){const{isScreenOpen:t,closeScreen:e,toggleScreen:o}=So(),{frontmatter:r}=k(),l=S(()=>r.value.navbar!==!1);return Vn(vn,{closeScreen:e}),Y(()=>{G&&document.documentElement.classList.toggle("hide-nav",!l.value)}),(d,a)=>l.value?(i(),c("header",Mi,[h(Br,{"is-screen-open":s(t),onToggleScreen:s(o)},{"nav-bar-title-before":m(()=>[u(d.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":m(()=>[u(d.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":m(()=>[u(d.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":m(()=>[u(d.$slots,"nav-bar-content-after",{},void 0,!0)]),_:3},8,["is-screen-open","onToggleScreen"]),h(Pi,{open:s(t)},{"nav-screen-content-before":m(()=>[u(d.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":m(()=>[u(d.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3},8,["open"])])):g("",!0)}}),Ci=y(Ti,[["__scopeId","data-v-d5bf7c8e"]]),xi=["role","tabindex"],Ri={key:1,class:"items"},Ii=f({__name:"VPSidebarItem",props:{item:{},depth:{}},setup(n){const t=n,{collapsed:e,collapsible:o,isLink:r,isActiveLink:l,hasActiveLink:d,hasChildren:a,toggle:v}=Ht(S(()=>t.item)),P=S(()=>a.value?"section":"div"),T=S(()=>r.value?"a":"div"),x=S(()=>a.value?t.depth+2===7?"p":`h${t.depth+2}`:"p"),H=S(()=>r.value?void 0:"button"),_=S(()=>[[`level-${t.depth}`],{collapsible:o.value},{collapsed:e.value},{"is-link":r.value},{"is-active":l.value},{"has-active":d.value}]);function I(O){"key"in O&&O.key!=="Enter"||!t.item.link&&v()}function E(){t.item.link&&v()}return(O,V)=>{const W=U("VPSidebarItem",!0);return i(),b(L(P.value),{class:M(["VPSidebarItem",_.value])},{default:m(()=>[n.item.text?(i(),c("div",j({key:0,class:"item",role:H.value},Xn(n.item.items?{click:I,keydown:I}:{},!0),{tabindex:n.item.items&&0}),[V[1]||(V[1]=p("div",{class:"indicator"},null,-1)),n.item.link?(i(),b(A,{key:0,tag:T.value,class:"link",href:n.item.link,rel:n.item.rel,target:n.item.target},{default:m(()=>[(i(),b(L(x.value),{class:"text",innerHTML:n.item.text},null,8,["innerHTML"]))]),_:1},8,["tag","href","rel","target"])):(i(),b(L(x.value),{key:1,class:"text",innerHTML:n.item.text},null,8,["innerHTML"])),n.item.collapsed!=null&&n.item.items&&n.item.items.length?(i(),c("div",{key:2,class:"caret",role:"button","aria-label":"toggle section",onClick:E,onKeydown:Yn(E,["enter"]),tabindex:"0"},[...V[0]||(V[0]=[p("span",{class:"vpi-chevron-right caret-icon"},null,-1)])],32)):g("",!0)],16,xi)):g("",!0),n.item.items&&n.item.items.length?(i(),c("div",Ri,[n.depth<5?(i(!0),c(R,{key:0},D(n.item.items,Pn=>(i(),b(W,{key:Pn.text,item:Pn,depth:n.depth+1},null,8,["item","depth"]))),128)):g("",!0)])):g("",!0)]),_:1},8,["class"])}}}),Hi=y(Ii,[["__scopeId","data-v-6b36a2fd"]]),Di=f({__name:"VPSidebarGroup",props:{items:{}},setup(n){const t=w(!0);let e=null;return N(()=>{e=setTimeout(()=>{e=null,t.value=!1},300)}),Zn(()=>{e!=null&&(clearTimeout(e),e=null)}),(o,r)=>(i(!0),c(R,null,D(n.items,l=>(i(),c("div",{key:l.text,class:M(["group",{"no-transition":t.value}])},[h(Hi,{item:l,depth:0},null,8,["item"])],2))),128))}}),_i=y(Di,[["__scopeId","data-v-a84b7c21"]]),Ei={class:"nav",id:"VPSidebarNav","aria-labelledby":"sidebar-aria-label",tabindex:"-1"},Vi=f({__name:"VPSidebar",props:{open:{type:Boolean}},setup(n){const{sidebarGroups:t,hasSidebar:e}=q(),o=n,r=w(null),l=En(G?document.body:null);F([o,r],()=>{o.open?(l.value=!0,r.value?.focus()):l.value=!1},{immediate:!0,flush:"post"});const d=w(0);return F(t,()=>{d.value+=1},{deep:!0}),(a,v)=>s(e)?(i(),c("aside",{key:0,class:M(["VPSidebar",{open:n.open}]),ref_key:"navEl",ref:r,onClick:v[0]||(v[0]=Ln(()=>{},["stop"]))},[v[2]||(v[2]=p("div",{class:"curtain"},null,-1)),p("nav",Ei,[v[1]||(v[1]=p("span",{class:"visually-hidden",id:"sidebar-aria-label"}," Sidebar Navigation ",-1)),u(a.$slots,"sidebar-nav-before",{},void 0,!0),(i(),b(_i,{items:s(t),key:d.value},null,8,["items"])),u(a.$slots,"sidebar-nav-after",{},void 0,!0)])],2)):g("",!0)}}),Li=y(Vi,[["__scopeId","data-v-e0eef791"]]),Ai=f({__name:"VPSkipLink",setup(n){const{theme:t}=k(),e=Z(),o=w();F(()=>e.path,()=>o.value.focus());function r({target:l}){const d=document.getElementById(decodeURIComponent(l.hash).slice(1));if(d){const a=()=>{d.removeAttribute("tabindex"),d.removeEventListener("blur",a)};d.setAttribute("tabindex","-1"),d.addEventListener("blur",a),d.focus(),window.scrollTo(0,0)}}return(l,d)=>(i(),c(R,null,[p("span",{ref_key:"backToTop",ref:o,tabindex:"-1"},null,512),p("a",{href:"#VPContent",class:"VPSkipLink visually-hidden",onClick:r},C(s(t).skipToContentLabel||"Skip to content"),1)],64))}}),Fi=y(Ai,[["__scopeId","data-v-fcbfc0e0"]]),Oi=f({__name:"Layout",setup(n){const{isOpen:t,open:e,close:o}=It();Dt({closeSidebar:o});const{frontmatter:r}=k(),l=nt(),d=S(()=>!!l["home-hero-image"]);return Vn(On,{heroImageSlotExists:d}),(a,v)=>{const P=U("Content");return s(r).layout!==!1?(i(),c("div",{key:0,class:M(["Layout",s(r).pageClass])},[u(a.$slots,"layout-top",{},void 0,!0),h(Fi),h(st,{class:"backdrop",show:s(t),onClick:s(o)},null,8,["show","onClick"]),h(Ci,null,{"nav-bar-title-before":m(()=>[u(a.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":m(()=>[u(a.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":m(()=>[u(a.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":m(()=>[u(a.$slots,"nav-bar-content-after",{},void 0,!0)]),"nav-screen-content-before":m(()=>[u(a.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":m(()=>[u(a.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3}),h(yo,{open:s(t),onOpenMenu:s(e)},null,8,["open","onOpenMenu"]),h(Li,{open:s(t)},{"sidebar-nav-before":m(()=>[u(a.$slots,"sidebar-nav-before",{},void 0,!0)]),"sidebar-nav-after":m(()=>[u(a.$slots,"sidebar-nav-after",{},void 0,!0)]),_:3},8,["open"]),h(oo,null,{"page-top":m(()=>[u(a.$slots,"page-top",{},void 0,!0)]),"page-bottom":m(()=>[u(a.$slots,"page-bottom",{},void 0,!0)]),"not-found":m(()=>[u(a.$slots,"not-found",{},void 0,!0)]),"home-hero-before":m(()=>[u(a.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":m(()=>[u(a.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":m(()=>[u(a.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":m(()=>[u(a.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":m(()=>[u(a.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":m(()=>[u(a.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":m(()=>[u(a.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":m(()=>[u(a.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":m(()=>[u(a.$slots,"home-features-after",{},void 0,!0)]),"doc-footer-before":m(()=>[u(a.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":m(()=>[u(a.$slots,"doc-before",{},void 0,!0)]),"doc-after":m(()=>[u(a.$slots,"doc-after",{},void 0,!0)]),"doc-top":m(()=>[u(a.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":m(()=>[u(a.$slots,"doc-bottom",{},void 0,!0)]),"aside-top":m(()=>[u(a.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":m(()=>[u(a.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":m(()=>[u(a.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":m(()=>[u(a.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":m(()=>[u(a.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":m(()=>[u(a.$slots,"aside-ads-after",{},void 0,!0)]),_:3}),h(ao),u(a.$slots,"layout-bottom",{},void 0,!0)],2)):(i(),b(P,{key:1}))}}}),qi=y(Oi,[["__scopeId","data-v-304c8b69"]]),Rn={Layout:qi,enhanceApp:({app:n})=>{n.component("Badge",rt)}},ji={class:"vp-collapse"},Ki=f({__name:"Collapse",setup(n){const t=w(!1),e=w(null),o=w({});function r(){t.value=!t.value}return F(t,async l=>{await hn();const d=e.value;if(d)if(l){const a=d.scrollHeight;o.value={height:"0px",overflow:"hidden"},d.offsetHeight,o.value={height:a+"px",overflow:"hidden"},setTimeout(()=>{t.value&&(o.value={height:"auto"})},300)}else{const a=d.clientHeight;o.value={height:a+"px",overflow:"hidden"},d.offsetHeight,o.value={height:"0px",overflow:"hidden"}}}),(l,d)=>(i(),c("div",ji,[p("div",{class:M(["vp-collapse__summary",{"vp-collapse__summary--open":t.value}]),onClick:r},[u(l.$slots,"summary",{},()=>[K(C(t.value?"▼":"►")+" "+C(t.value?"折叠":"展开"),1)],!0)],2),tt(p("div",{class:"vp-collapse__content",ref_key:"contentRef",ref:e,style:fn(o.value)},[u(l.$slots,"default",{},void 0,!0)],4),[[et,t.value]])]))}}),Ni=y(Ki,[["__scopeId","data-v-4585a904"]]),on=[{id:1,question:"AI Agent  是啥?",answer:["AI Agent（智能代理） 是一个能够 **感知环境、做决策、执行动作** 的系统。是能够感知环境、做决策并执行动作的智能系统，其复杂度从简单规则反应型到学习型智能体不等。","AI Agent 的代码生成、辅助编程工具和提示工程 (Prompt Engineering) 工具","AI Agent 是能够感知环境、基于目标和策略做决策并执行动作的智能系统，现代应用多结合 LLM，实现自动化任务、多步推理和上下文增强。"],answerHtml:["<p>AI Agent（智能代理） 是一个能够 <strong>感知环境、做决策、执行动作</strong> 的系统。是能够感知环境、做决策并执行动作的智能系统，其复杂度从简单规则反应型到学习型智能体不等。</p>","<p>AI Agent 的代码生成、辅助编程工具和提示工程 (Prompt Engineering) 工具</p>","<p>AI Agent 是能够感知环境、基于目标和策略做决策并执行动作的智能系统，现代应用多结合 LLM，实现自动化任务、多步推理和上下文增强。</p>"],reference:"/myKMS/ai/index#_1-ai-agent-是啥",source:"/myKMS/ai/index"},{id:2,question:"MCP 是啥",answer:[`ai mcp 是啥: 
...
\`\`\``],answerHtml:["<p><strong>是一条从上下文收集 → 语言模型推断 → 候选生成与重排 → 约束与安全 → 呈现与学习的工程流水线</strong></p>",`<div class="language-swift"><button title="Copy Code" class="copy"></button><span class="lang">swift</span><pre><!--::markdown-it-async::7a0asibksbn424s8so61vi::--><code>键入 → 触发条件命中
   → 上下文构建（prefix+suffix+符号/RAG+工程规则）
     → 模型解码（FIM/自回归，KV cache，限长/停用符）
       → 生成多候选（不同温度/窗口）
         → 重排（可编性/风格/相似度/历史采纳）
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::43c5lub777e3czwvs92k0p::--><code>
function bubbleSort(arr) {
  for (let i = 0; i &lt; arr.length - 1; i++) {
    for (let j = 0; j &lt; arr.length - 1 - i; j++) {
      if (arr[j] &gt; arr[j + 1]) {
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::szpwl6hmt3q1joacgp2dtc::--><code>function selectionSort(arr) {
  for (let i = 0; i &lt; arr.length; i++) {
    let min = i;
    for (let j = i + 1; j &lt; arr.length; j++) {
      if (arr[j] &lt; arr[min]) min = j;
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::qkveze5fu4oz7orvjtw4ur::--><code>function insertionSort(arr) {
  for (let i = 1; i &lt; arr.length; i++) {
    let key = arr[i];
    let j = i - 1;
    while (j &gt;= 0 &amp;&amp; arr[j] &gt; key) {
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::vcx3oz15ht8chn3r1mdu7h::--><code>function quickSort(arr) {
  if (arr.length &lt;= 1) return arr;
  const pivot = arr[arr.length &gt;&gt; 1];
  const left = arr.filter(x =&gt; x &lt; pivot);
  const mid = arr.filter(x =&gt; x === pivot);
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::9dtrrj9odfq8azudk18l::--><code>
function mergeSort(arr) {
  if (arr.length &lt;= 1) return arr;
  const mid = Math.floor(arr.length / 2);
  const left = mergeSort(arr.slice(0, mid));
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::44f5xiaqxs2h5esgktu0w::--><code>function countingSort(arr, maxValue) {
  const count = new Array(maxValue + 1).fill(0);
  arr.forEach(v =&gt; count[v]++);
  const res = [];
  count.forEach((v, i) =&gt; { while (v--) res.push(i); });
...
\`\`\``],answerHtml:[`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::fltwuokd7fq5bil6n9aa79::--><code>function shuffle(array) {
  let arr = array.slice(); // 拷贝一份，不修改原数组
  for (let i = arr.length - 1; i &gt; 0; i--) {
    const j = Math.floor(Math.random() * (i + 1)); // 随机索引 [0, i]
    [arr[i], arr[j]] = [arr[j], arr[i]]; // 交换
...
<li>过程中记录窗口最大长度。</li>
</ul>`,`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::5oomgx2j7l21p7dv74i2sz::--><code>function lengthOfLongestSubstring(s) {
  let set = new Set();
  let left = 0, maxLen = 0;
...
基于 ES6 Proxy 拦截子应用对全局对象的读写。每个子应用有一个独立的代理对象作为 window，实际访问 window.xxx 时，会优先读写子应用自己的代理上下文。多个子应用可并行运行，互不影响。</p>`,"<p>qiankun 默认在支持 Proxy 的浏览器下使用这个方案</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::ze9fssw9jyr0dglo1qfytcf::--><code>const fakeWindow = {};
const proxy = new Proxy(window, {
        get(target, key) {
        return key in fakeWindow ? fakeWindow[key] : target[key];
},
...
\`\`\``],answerHtml:[`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::or4tni92ie9ounpvhor4p::--><code>import type { Plugin } from &#039;vite&#039;;
...
</div>`,"<p>// 替换模板的一个字</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::nav8uzf9qsvdqh7qz0vsm::--><code>export default function replaceTextPlugin(options = { search: &#039;FOO&#039;, replace: &#039;BAR&#039; }) {
  return {
    name: &#039;vite-plugin-replace-text&#039;,
    enforce: &#039;pre&#039;,
    transform(code, id) {
...
</div>`,"<p>// 统计TODO</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::i6jw6am7pg6kycg7u9gv::--><code>import fs from &#039;fs&#039;;
import path from &#039;path&#039;;
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::ela5kqr5selh29z56qa2aj::--><code>function isElementRendered(sampleCount = 10) {
    let visibleCount = 0;
    for (let i = 0; i &lt; sampleCount; i++) {
        const x = Math.random() * window.innerWidth;
        const y = Math.random() * window.innerHeight;
...
<li>重复上述步骤</li>
</ul>`,"<p>宏任务 → 微任务 → ✅ 渲染 → 下一个宏任务</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::wzru6xmozi8bndc5oz4qd::--><code>┌────────────────────────────┐
│       1. 取一个宏任务       │ (如 script, I/O, setTimeout 回调)
├────────────────────────────┤
│       2. 执行所有微任务     │ (Promise.then, MutationObserver)
├────────────────────────────┤
...
</ul>`,"<p>典型用法:</p>",`<div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre><!--::markdown-it-async::so03q88o8b3gfwojpcolv::--><code>&lt;Form form={form} initialValues={{ username: &#039;Tom&#039; }}&gt;
  &lt;Form.Item name=&quot;username&quot;&gt;
    &lt;Input /&gt;
  &lt;/Form.Item&gt;
&lt;/Form&gt;</code></pre>
</div>`,"<p>对应关系：</p>",`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::6uc4gebs24jkv8upaq5m::--><code>&lt;Form&gt;           —— 维护 FormStore（字段状态）
   │
   └─&lt;FormContext.Provider&gt;  —— 提供 Store 和订阅方法
        │
        └─&lt;Form.Item name=&quot;username&quot;&gt; —— 注册字段
...
</ul>`,`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::6klwz2pt3xo1dhggunpia8::--><code>    {
    value: store[name],
    onChange: (e) =&gt; {
      const newValue = e &amp;&amp; e.target ? e.target.value : e;
      store.setFieldValue(name, newValue);
...
\`\`\``],answerHtml:[`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::7uqtb4nyvxkgq9xf52jb0c::--><code>function arrange(name) {
  const queue = []
...
\`\`\``],answerHtml:[`<div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre><!--::markdown-it-async::ox5ylll7rrbsx26k0jrbhm::--><code>// 代码由github copilot 生成
...
\`\`\``],answerHtml:[`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::shpqnq289y9kgihi04gw6c::--><code>
function debounce(fn, wait = 300) {
  let timer = null;
  return function(...args) {
    clearTimeout(timer);
...
\`\`\``],answerHtml:[`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::xqx6tr9r7f4piu2l516ue::--><code>
function throttle_timestamp(fn, wait) {
  let last = 0; // 上次执行时间（ms）
...
\`\`\``],answerHtml:[`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::5i7kifpmu6kdobs4nui3jk::--><code>class MyPromise {
        static PENDING = &quot;pending&quot;;
        static RESOLVED = &quot;resolved&quot;;
        static REJECTED = &quot;rejected&quot;;
        constructor(executor) {
...
</ul>`,`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::v89hhipenfdyuse0m5sctr::--><code>// 简单版
Function.prototype.myBind = function (context) {
  const fn = this; // 保存原函数
  return function () {
    return fn.apply(context);
...
</table>`,`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::hpl01f81mvlnz7btqb1a::--><code>function greet(g1, g2) {
  console.log(this.name, g1, g2);
}
...
</ul>`,`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::gl40bu2ecjvj94jn54rcx::--><code>function myInstanceof(left, right) {
  let proto = Object.getPrototypeOf(left), // 获取对象的原型
      prototype = right.prototype; // 获取构造函数的 prototype 对象
...
\`\`\``],answerHtml:["<p>在调用 new 的过程中会发生以上四件事情：</p>","<p>（1）首先创建了一个新的空对象</p>","<p>（2）设置原型，将对象的原型设置为函数的 prototype 对象。</p>","<p>（3）让函数的 this 指向这个对象，执行构造函数的代码（为这个新对象添加属性）</p>","<p>（4）判断函数的返回值类型，如果是值类型，返回创建的对象。如果是引用类型，就返回这个引用类型的对象。</p>",`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::szwijjm4wupwn2us4xllp::--><code>
function myNew(constructor, ...args) {
  if (typeof constructor !== &quot;function&quot;) return
  let obj = {}
  obj.prototype = Object.create(constructor.prototype)
...
\`\`\``],answerHtml:["<p>柯里化（Currying） 是把一个接受多个参数的函数，转换成一系列每次只接收一个参数的函数。</p>","<p>类比: “一次性买 3 个苹果”，变成 “一次买 1 个，买 3 次，最后结算”。</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::s2lrij0njjmrjl37p3tp8::--><code>function add(a, b, c) {
  return a + b + c;
}
...
<li>✅ 提升代码可读性和函数式风格</li>
</ul>`,`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::1sgs8lpqiuggdfmqljyrsr::--><code>
function curry(fn) {
  const curried = (...args) =&gt; {
    // 如果参数足够就执行，否则返回新函数继续收集
    return args.length &gt;= fn.length
...
\`\`\``],answerHtml:["<p>一、页面可见性 Page Visibility API</p>","<p>判断用户标签页是否可见（切换到后台/最小化浏览器）</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::rmlyspbptxltt7r0zex5uj::--><code>document.addEventListener(&#039;visibilitychange&#039;, () =&gt; {
  if (document.hidden) {
    console.log(&#039;用户离开页面（切换标签页或最小化）&#039;);
  } else {
    console.log(&#039;用户回到页面&#039;);
...
</div>`,"<p>二、窗口焦点（Focus / Blur）</p>","<p>检测窗口或 iframe 是否获得焦点</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::aixk62w9hpbjt22pp2vnuq::--><code>window.addEventListener(&#039;blur&#039;, () =&gt; {
  console.log(&#039;用户离开了当前窗口/标签页&#039;);
});
...
</div>`,"<p>三、用户离开页面 / 卸载（beforeunload / unload）</p>","<p>检测用户关闭页面、刷新或跳转。</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::0y5ra6y3ys6owgq5g1fdq7c::--><code>window.addEventListener(&#039;beforeunload&#039;, (e) =&gt; {
  console.log(&#039;用户可能离开页面&#039;);
  // 阻止默认提示（可选）
  e.preventDefault();
  e.returnValue = &#039;&#039;;
...
</div>`,"<p>四、鼠标 / 用户交互检测</p>","<p>当用户长时间没有交互（鼠标、键盘、触屏），可推测用户离开</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::uq9tx062nofk3wyph4optr::--><code>let idleTimer;
function resetIdle() {
  clearTimeout(idleTimer);
  idleTimer = setTimeout(() =&gt; {
    console.log(&#039;用户可能离开或无操作&#039;);
...
</div>`,"<p>可以检测“用户不活跃”，用于自动登出、心跳等.</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::655r6bgo48fbuche3peuua::--><code>let idleTimer;
function onUserIdle() { console.log(&#039;用户离开页面或长时间不操作&#039;); }
function resetIdle() {
  clearTimeout(idleTimer);
  idleTimer = setTimeout(onUserIdle, 30000);
...
<li>构建观察者 / 订阅机制</li>
<li>动态执行规则</li>
</ol>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::c7jgpyvdafnshpzvtdyga::--><code>formFields = [
  { field: &#039;province&#039;, type: &#039;select&#039; },
  { field: &#039;city&#039;, type: &#039;select&#039;, dependsOn: &#039;province&#039;, compute: (state) =&gt; cities[state.province] }
]
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::q2zkdh8bgbki53pg5sjp6::--><code>let lastRequestId = 0;
...
</ol>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::38n2c0yqs34yf0ckmbmuus::--><code>useEffect(() =&gt; {
  let canceled = false;
...
</table>`,"<p>Vue 3 自带了<code> &lt;KeepAlive&gt;</code> 组件</p>","<p>react 实现 keep-alive</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::xjla6i5j1ve60630no3ct9::--><code>// KeepAlive.jsx 
import { useRef } from &#039;react&#039;;
import { useLocation } from &#039;react-router-dom&#039;;
...
</ul>`,"<p>js sdk</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::g6jx2stj9kle91rzigfnna::--><code>// perf-sdk.js (浏览器端核心逻辑, 精简示例)
(function (window) {
  const APP = {};
  const SEND_URL = &#039;/beacon/perf&#039;;
  const BATCH_MAX = 20;
...
\`\`\``],answerHtml:["<p><strong>当主线程（Main Thread）执行某个任务超过 50ms</strong>，它就被标记为一个 “Long Task”。</p>","<p>浏览器提供了 PerformanceObserver 接口，监听类型为 &quot;longtask&quot; 的性能条目。</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::m2ghe1dn6mbjas49os9mea::--><code>
let longTaskCount = 0;
let totalLongTaskTime = 0;
...
\`\`\``],answerHtml:[`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::q59n0g18ytbzzc4a9zf2q::--><code>
组件库发布
   │
   ├─ 生成 CHANGELOG
   ├─ 更新远程版本记录
...
</table>`,`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre><!--::markdown-it-async::mf4v3p8n5bl5h0jdmvxpn::--><code>// 模块表（缓存）
const modules = {};      // 模块名 -&gt; 导出对象
const factories = {};    // 模块名 -&gt; 模块定义函数
const loading = {};      // 模块名 -&gt; 是否正在加载中
...
</div>`,`<div class="language-scss"><button title="Copy Code" class="copy"></button><span class="lang">scss</span><pre><!--::markdown-it-async::37k654uxvbbtbrqb8h2lbq::--><code>require(&#039;main&#039;)
   │
   ├─▶ 检查缓存
   │
   ├─▶ 找到定义 (factory)
...
</table>`,"<p>实践中采用 OpenSeadragon 库</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::p7fyizg2insql20pcpqom::--><code> ┌─────────────────────────────┐
 │         大图瓦片浏览器         │
 │                             │
 │  ┌──────────────┐            │
 │  │视窗视口(Viewport)│  ← 仅渲染屏幕内的瓦片 │
...
- 执行所有微任务（直到清空微任务队列）
- 渲染（浏览器）
- 开始下一轮循环`,"**同步先执行，异步分队列；先宏后微，再渲染。**","Node.js：","- **process.nextTick 优先级高于 Promise 微任务**"],answerHtml:[`<ol>
<li>背景
JavaScript 是 单线程 的：同一时刻只能执行一个任务。但浏览器/Node 需要同时处理用户输入、网络请求、定时器、渲染等。
...
</ul>`],reference:"/myKMS/knowledge/base/js#_2-描述-event-loop-运行机制",source:"/myKMS/knowledge/base/js"},{id:76,question:"网页多标签页之间如何通讯？和 iframe 如何通讯？",answer:["| 特性        | `BroadcastChannel` | `localStorage` + `storage` 事件 | `postMessage` + iframe / worker |\n| --------- | ------------------ | ----------------------------- | ------------------------------- |\n| 是否需要刷新    | 否                  | 否                             | 否                               |\n| 是否支持多 Tab | ✅                  | ✅                             | 部分（需要 iframe/worker）            |\n| 是否易用      | ✅（直接发送消息）          | 中等（需要 JSON 序列化）               | 较复杂（需建立通道）                      |\n| 是否跨域      | ❌（只能同源）            | ❌                             | 可跨域（需正确设置 targetOrigin）         |\n| 性能        | 较好                 | 一般（依赖 storage 事件）             | 较好                              |"],answerHtml:[`<table tabindex="0">
<thead>
<tr>
<th>特性</th>
...
\`\`\``],answerHtml:[`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::r1vw3tg0bj14kgwit0vyp::--><code>async function batchRequestAllSettled(tasks, batchSize = 5) {
  const results = []
...
- esm缓存生效场景: 同一个模块被多次 import; 循环依赖(缓存的“半成品”也会存起来，这样可以避免死循环);动态 import 多次;`],answerHtml:["<p>ES Module (ESM) 的 import 是编译期就确定依赖关系;ESM 默认是 严格模式，并且是 异步加载</p>",`<p><strong>解析阶段（Parsing）=&gt; 加载阶段 =&gt; 实例化阶段 =&gt; 执行阶段 =&gt; 缓存</strong></p>
<ul>
...
</ul>`],reference:"/myKMS/knowledge/base/js#_11-esm-中-import-会发生什么",source:"/myKMS/knowledge/base/js"},{id:84,question:"在 JS 代码中避免内存泄漏的方法?",answer:[`1. 释放不再需要的引用(把对象置 null 或者移除属性，就能让 GC 正常回收。)
2. 避免全局变量
...
</ol>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::0uu7n13twc4mbz3zfrn63c6::--><code>每个阶段的宏任务执行完 →
    执行所有 nextTick 回调 →
    执行所有微任务 (Promise)
→ 进入下一个阶段</code></pre>
...
</table>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::qeoy8j8ziuriu51xv6a4or::--><code>客户端 (Client)                             服务器 (Server)
------------------                          ------------------
...
假设浏览器要加载三个资源：</p>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::zghp1a3vyakdbt9sbxc0oo::--><code>index.html
style.css
main.js
</code></pre>
</div>`,"<p>HTTP/1.1：</p>",`<ul>
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::4an16sf08lhtwmw2cxe1oc::--><code>// HTTP/2
HTTP/2
  ↓
  TLS
  ↓
...
</ol>`,`<div class="language-nginx"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre><!--::markdown-it-async::gzec1d1fovhv98lvsk3da::--><code>http {
    # 开发环境（域名区分）
    server {
        listen 80;
        server_name dev.example.com;  # 开发环境域名
...
</div>`,"<p>同域名不同路径映射的重写问题及解决方案</p>","<p>当多个前端应用部署在同一域名的不同路径下（如 example.com/app1、example.com/app2），需要解决路径映射和资源引用的问题。</p>",`<div class="language-nginx"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre><!--::markdown-it-async::voobm3tjken36c2oyg1pg::--><code>server {
    listen 80;
    server_name example.com;
    root /var/www;  # 父目录
...
\`\`\``,"🔴 每次点击按钮，Child 都会重新挂载，副作用也会重新执行。","当父组件内部定义子组件时，每次父组件 render 都会创建一个新的函数对象。React 看到“类型变了”，认为它是一个全新的组件。结果：子组件每次都会被卸载并重新挂载。**可以使用 useCallback 优化**",`- 什么时候可以在内部定义组件?
  - 组件依赖父组件的闭包变量
  - 性能无关的小组件
  - 需要动态生成组件类型`],answerHtml:[`<div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre><!--::markdown-it-async::9zk5s476lseltauzp8rrhq::--><code>function App() {
  const [count, setCount] = useState(0);
...
- 支持自定义比较，通过第二个参数实现更精细的控制`],answerHtml:["<p><strong>React.memo 是一个高阶组件（HOC），用于优化函数组件的渲染性能。它的核心原理是通过记忆（Memoization）组件的渲染结果，在 props 未变化时跳过重新渲染，直接返回上一次的渲染结果。</strong></p>",`<div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre><!--::markdown-it-async::7dqqfawv0tucqt9g9hex38::--><code>// React.memo 的简化实现逻辑
function memo(Component, arePropsEqual) {
  let lastProps = null;
  let lastResult = null;
...
- 启用 ESLint 规则自动检测
- 使用函数式更新避免依赖状态值`],answerHtml:["<p>表现:缺少依赖导致过时闭包</p>",`<div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre><!--::markdown-it-async::i61bet1623ld83n197q8vh::--><code>function Timer() {
  const [count, setCount] = useState(0);
...
比如：读取 DOM 布局信息（测量元素大小）;需要在绘制前同步修改 DOM 样式（避免闪烁)</p>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::fbar6toacicp4ltdzlec6p::--><code>Render 阶段（计算虚拟 DOM）
        ↓
DOM 更新（Commit 阶段）
        ↓
useLayoutEffect（同步执行） 👈 页面还没绘制
...
</ul>`],reference:"/myKMS/knowledge/framework/react#_7-为何-dev-模式下-useeffect-执行两次",source:"/myKMS/knowledge/framework/react"},{id:129,question:"React state 不可变数据",answer:[`**State（状态）必须保持不可变（immutable）**
不可变数据（Immutable Data）:指的是一旦创建就不能直接修改的对象或数组。如果要更新，必须创建一个新对象/数组。`,"React 为何需要不可变数据",`- 高效的重渲染判断, 性能好  
...
- 可预测性
  ...
  - 每次状态更新都会生成一个新的对象或数组，这样可以更容易地调试和追踪状态的变化历史`,"封装数据可以用 immer 库"],answerHtml:[`<p><strong>State（状态）必须保持不可变（immutable）</strong>
不可变数据（Immutable Data）:指的是一旦创建就不能直接修改的对象或数组。如果要更新，必须创建一个新对象/数组。</p>`,"<p>React 为何需要不可变数据</p>",`<ul>
<li>高效的重渲染判断, 性能好
<ul>
...
把原本递归的更新过程变成可中断的循环（迭代），并用一个 Fiber 数据结构 表示组件树中的每个节点。
每个 Fiber 节点本质上是一个 JS 对象.对应一个 React element.</p>`,`<div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre><!--::markdown-it-async::2evt5uer00yy24qxojuaf::--><code>type Fiber = {
  type: any,             // 组件类型（函数/类/DOM标签）
  stateNode: any,        // 对应的DOM实例或类组件实例
  child: Fiber | null,   // 第一个子Fiber
  sibling: Fiber | null, // 下一个兄弟Fiber
...
React 通过 Lane 模型 管理任务优先级</p>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::4h9z52h6poxcxtb8dszern::--><code>  // 优先级从高到低
ImmediatePriority（用户输入）
UserBlockingPriority（悬停、点击）
NormalPriority（数据请求）
LowPriority（分析日志）
...
</ul>`,"<p>👉 Concurrent Rendering（并发渲染） 就是 React Fiber 在 16 以后引入的核心能力，真正实现在 渲染过程中可以打断、暂停、恢复、丢弃。</p>","<p>旧:</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::ynwxgcf7f8b223x1zk9liv::--><code>update → render → commit
         (整棵树一次性调和)</code></pre>
</div>`,"<p>新:</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::m75t1b76xgfutk80w2ilk::--><code>update → render(可被打断、分段) → commit(同步)</code></pre>
</div>`,`<ul>
...
</ul>`,"<p>在 Fiber 节点上，每个函数组件会维护一个 <strong>Hook 链表</strong>：</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::x6ngvkhiwj7ucn6j1r8i9n::--><code>type Hook = {
  memoizedState: any,        // 保存副作用依赖数组
  next: Hook | null          // 指向下一个 Hook
}
...
</ul>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::fuqfbg3ns0jv3j0ji1ffj::--><code>function useState(initialState) {
    return useReducer((state, action) =&gt; {
        return typeof action === &#039;function&#039; ? action(state) : action;
    }, initialState);
}</code></pre>
...
</table>`],reference:"/myKMS/knowledge/framework/vite#_6-css-in-js-的优缺点",source:"/myKMS/knowledge/framework/vite"},{id:164,question:"vue 动态渲染组件的原理是什么",answer:[`**本质是根据虚拟 DOM（VNode）的 type 动态切换组件**
...
如果是组件对象 → 返回组件本身</p>`,"<p><strong>Vue 动态组件就是 根据 reactive/ref 的值动态生成 VNode type，然后通过 patch 更新组件实例，keep-alive 则通过缓存实例优化挂载卸载。</strong></p>"],reference:"/myKMS/knowledge/framework/vue#_1-vue-动态渲染组件的原理是什么",source:"/myKMS/knowledge/framework/vue"},{id:165,question:"Vue 项目可做哪些性能优化",answer:[`- 减少不必要的响应式追踪
...
<li>虚拟滚动</li>
<li>...</li>
</ul>`],reference:"/myKMS/knowledge/framework/vue#_2-vue-项目可做哪些性能优化",source:"/myKMS/knowledge/framework/vue"},{id:166,question:"nextTick 原理是什么",answer:["**nextTick在下次 DOM 更新循环结束后执行回调，确保我们能操作到最新的 DOM 状态。**","Vue 采用 异步批量更新策略：",`- 收集本轮所有的更新任务；
...
<li>保证更新最少、性能最好。</li>
</ul>`,"<p>Vue 3 的 nextTick 实际上是封装了一个<strong>微任务调度器（microtask scheduler）</strong>。</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::lqfi56trtzrkhojnogqsba::--><code>// Vue3 内部核心实现伪代码
let pending = false
const queue = []
...
</ul>`,"<p>nextTick 回调 再dom 渲染之后, 宏任务执行之前.</p>"],reference:"/myKMS/knowledge/framework/vue#_3-nexttick-原理是什么",source:"/myKMS/knowledge/framework/vue"},{id:167,question:"如何统一监听 Vue 组件报错",answer:["在 Vue 3 中，可以通过 全局错误处理器 （errorHandler） 和 生命周期钩子（例如 onErrorCaptured ）来统一监听和处理组件中的错误.",`- 通过全局错误处理器 app.config.errorHandler
...
</ul>`],reference:"/myKMS/knowledge/framework/vue#_7-vue3-如何实现双向数据绑定",source:"/myKMS/knowledge/framework/vue"},{id:171,question:"Vue 模板编译的过程",answer:["**模板解析、AST优化 和 代码生成**",`\`\`\`
模板字符串 (template)
       ↓
[1] 解析（Parse） → 生成 AST
       ↓
...
3. 代码生成: 生成渲染函数是编译的最终阶段，这个阶段会将优化后的 AST 转换成 JavaScript 渲染函数。`],answerHtml:["<p><strong>模板解析、AST优化 和 代码生成</strong></p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::2o8ca7ghdlt4p5te9lngtf::--><code>模板字符串 (template)
       ↓
[1] 解析（Parse） → 生成 AST
       ↓
[2] 转换（Transform） → 优化、静态标记、指令处理
...
</ol>`],reference:"/myKMS/knowledge/framework/vue#_8-vue-模板编译的过程",source:"/myKMS/knowledge/framework/vue"},{id:172,question:"vue 异步更新",answer:["Vue 会延迟更新 DOM，等同一轮事件循环中所有状态改动都完成后，再统一执行更新。",`目的：
✅ 避免频繁的 DOM 重绘（性能优化）
✅ 保证多次修改只渲染一次（批量更新）
...
✅ 避免频繁的 DOM 重绘（性能优化）
✅ 保证多次修改只渲染一次（批量更新）
✅ 数据一致性：确保在同一事件循环中的所有数据变更后，视图一次性更新到最终状态。</p>`,`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::u3temh65l7kloptny29o::--><code>数据变化（Proxy.set）
       ↓
触发依赖（trigger）
       ↓
派发更新任务（scheduler → queueJob）
...
</ul>`],reference:"/myKMS/knowledge/framework/vue#_10-vue-watch-computed-的区别",source:"/myKMS/knowledge/framework/vue"},{id:174,question:"vue3 lis",answer:[`LIS 在 Diff 中的作用：找出不需要移动的节点，最小化 DOM 操作
- 1. 将新节点映射到旧节点索引序列
- 2. 求最长递增子序列（LIS）
...
</ul>`,"<p>能够降低时间复杂度;大型表格、树结构、虚拟列表和移动频繁但大部分节点不变的场景, 效果好.</p>"],reference:"/myKMS/knowledge/framework/vue#_11-vue3-lis",source:"/myKMS/knowledge/framework/vue"},{id:175,question:"vue3 类似react hooks的原理是什么?",answer:[`Composition API（组合式 API）。
...
</table>`],reference:"/myKMS/knowledge/framework/vue#_12-vue3-类似react-hooks的原理是什么",source:"/myKMS/knowledge/framework/vue"},{id:176,question:"vue3 手写一个once修饰器",answer:[`\`\`\`
...
\`\`\``],answerHtml:[`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::to92eulofes6wrbpf5fyg::--><code>
&lt;template&gt;
  &lt;div&gt;
    &lt;h2 v-once-directive&gt;{{ message }}&lt;/h2&gt;
    &lt;button @click=&quot;message = &#039;更新后的消息&#039;&quot;&gt;修改 message&lt;/button&gt;
...
</div>`,"<p>事件</p>",`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><!--::markdown-it-async::letbf08wjon26v0ek458e2::--><code>
&lt;template&gt;
  &lt;button v-once-click=&quot;handleClick&quot;&gt;点击我一次&lt;/button&gt;
&lt;/template&gt;
...
</div>`,"<p>自定义指令有很多钩子可以选择</p>",`<div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre><!--::markdown-it-async::pzkszwxzzxi3xrjr7zgvy9::--><code>const myDirective = {
  // 在绑定元素的 attribute 前
  // 或事件监听器应用前调用
  created(el, binding, vnode) {
    // 下面会介绍各个参数的细节
...
</div>`],reference:"/myKMS/knowledge/framework/vue#_13-vue3-手写一个once修饰器",source:"/myKMS/knowledge/framework/vue"}],$i={class:"random-question__modal"},Ui={key:0,class:"random-question__body"},Ji={class:"random-question__question"},Wi={class:"random-question__answer-blocks"},Bi=["innerHTML"],Gi=["href"],zi=f({__name:"RandomQuestionModal",props:{variant:{}},setup(n){const t=n,e=w(!1),o=w(null),r=w(0),l=S(()=>t.variant??"home"),d=S(()=>["random-question",{"random-question--nav":l.value==="nav"}]),a=S(()=>["random-question__trigger",{"random-question__trigger--nav":l.value==="nav"}]),v=S(()=>o.value?.answerHtml??[]),P=()=>{if(!on.length)return null;const I=Math.floor(Math.random()*on.length);return on[I]},T=()=>{const I=P();I&&(o.value=I,r.value++,e.value=!0)},x=()=>{const I=P();I&&(o.value=I,r.value++)},H=()=>{e.value=!1},_=()=>{H()};return(I,E)=>(i(),c("div",{class:M(d.value)},[p("button",{type:"button",class:M(a.value),onClick:T}," 🎯 随机抽题 ",2),(i(),b(ot,{to:"body"},[e.value?(i(),c("div",{key:0,class:"random-question__overlay",role:"dialog","aria-modal":"true",onClick:Ln(H,["self"])},[p("div",$i,[p("header",{class:"random-question__header"},[E[0]||(E[0]=p("div",null,[p("p",{class:"random-question__eyebrow"},"Interview Drill"),p("h3",null,"随机面试题")],-1)),p("button",{type:"button",class:"random-question__icon-button","aria-label":"关闭弹窗",onClick:H}," ✕ ")]),o.value?(i(),c("section",Ui,[p("p",Ji,C(o.value.question),1),v.value.length?(i(),c("details",{class:"random-question__answer",key:r.value},[E[1]||(E[1]=p("summary",null,"展开答案",-1)),p("div",Wi,[(i(!0),c(R,null,D(v.value,(O,V)=>(i(),c("div",{key:V,class:"random-question__answer-block",innerHTML:O},null,8,Bi))),128))])])):g("",!0),o.value.reference?(i(),c("a",{key:1,class:"random-question__reference",href:o.value.reference,onClick:_}," 查看原文 ",8,Gi)):g("",!0)])):g("",!0),p("footer",{class:"random-question__footer"},[p("button",{type:"button",class:"random-question__next",onClick:x}," 换一题 ")])])])):g("",!0)]))],2))}}),In=y(zi,[["__scopeId","data-v-edebde8c"]]),Xi={extends:Rn,Layout:()=>Cn(Rn.Layout,null,{"nav-bar-content-before":()=>Cn(In,{variant:"nav"})}),enhanceApp({app:n,router:t,siteData:e}){n.component("Collapse",Ni),n.component("RandomQuestionModal",In)}};export{Xi as R};
