import{_ as o,c as t,o as r,j as e}from"./chunks/framework.fGi7qB65.js";const p=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"knowledge/browser/webSecurity.md","filePath":"knowledge/browser/webSecurity.md"}'),S={name:"knowledge/browser/webSecurity.md"};function i(a,n,s,c,l,d){return r(),t("div",null,[...n[0]||(n[0]=[e("p",null,"1.xss",-1),e("p",null,"XSS: 攻击者往网页里注入恶意脚本（通常是 JavaScript），当用户访问时这些脚本被执行，从而窃取数据、劫持会话或执行恶意操作。 利用 前端页面缺乏输入/输出校验，把恶意代码“混”进正常页面。 存储型 XSS: 恶意代码被存储到数据库/服务器（例如留言板、评论区）。用户访问页面时，恶意代码被从服务器取出并执行。 反射型 XSS: 恶意代码直接拼接在 URL 中，通过点击链接触发。常见于搜索结果页、错误提示页。 DOM 型 XSS: 不依赖服务器，漏洞在前端 JS 里。 前端代码直接把 URL 或输入插入到 DOM，导致执行恶意脚本。",-1),e("pre",null,[e("code",null,`    XSS 能干什么: 窃取 Cookie / LocalStorage / Token;劫持用户会话（伪造请求、冒充身份）;插入钓鱼页面，引导用户输入敏感信息;挂马（加载恶意脚本，挖矿、键盘监听）;DDoS（利用浏览器不断发请求）
...
11. 服务器安全
`)],-1)])])}const u=o(S,[["render",i]]);export{p as __pageData,u as default};
