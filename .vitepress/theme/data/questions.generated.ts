...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-swift\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">swift</span><pre><!--::markdown-it-async::zuiktrn6d1cyctq7y9gnm::--><code>键入 → 触发条件命中\n   → 上下文构建（prefix+suffix+符号/RAG+工程规则）\n     → 模型解码（FIM/自回归，KV cache，限长/停用符）\n       → 生成多候选（不同温度/窗口）\n         → 重排（可编性/风格/相似度/历史采纳）\n           → 约束&amp;安全过滤（语法/lint/secret）\n             → 呈现（渐进式，短→长）\n               → 反馈学习（接受/编辑/拒绝→排序器/提示适配）\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::749uijmohb4zle2ylp478m::--><code>\nfunction bubbleSort(arr) {\n  for (let i = 0; i &lt; arr.length - 1; i++) {\n    for (let j = 0; j &lt; arr.length - 1 - i; j++) {\n      if (arr[j] &gt; arr[j + 1]) {\n        [arr[j], arr[j + 1]] = [arr[j + 1], arr[j]];\n      }\n    }\n  }\n  return arr;\n}\n</code></pre>\n</div>",
      "<p>时间复杂度：O(n²)</p>",
      "<p>空间复杂度：O(1)</p>",
      "<p>稳定：✅</p>",
      "<ul>\n<li>选择排序: 每轮选择最小（或最大）值放到前面</li>\n</ul>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::i43eui9f42gzb7f9hj848h::--><code>function selectionSort(arr) {\n  for (let i = 0; i &lt; arr.length; i++) {\n    let min = i;\n    for (let j = i + 1; j &lt; arr.length; j++) {\n      if (arr[j] &lt; arr[min]) min = j;\n    }\n    [arr[i], arr[min]] = [arr[min], arr[i]];\n  }\n  return arr;\n}\n</code></pre>\n</div>",
      "<p>时间复杂度：O(n²)</p>",
      "<p>空间复杂度：O(1)</p>",
      "<p>稳定：❌（因为交换可能打乱相等元素顺序）</p>",
      "<ul>\n<li>插入排序: 将未排序的元素插入到已排序部分的合适位置</li>\n</ul>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::jv9mx3zvflfrjs0abn84w::--><code>function insertionSort(arr) {\n  for (let i = 1; i &lt; arr.length; i++) {\n    let key = arr[i];\n    let j = i - 1;\n    while (j &gt;= 0 &amp;&amp; arr[j] &gt; key) {\n      arr[j + 1] = arr[j];\n      j--;\n    }\n    arr[j + 1] = key;\n  }\n  return arr;\n}\n\n</code></pre>\n</div>",
      "<p>时间复杂度：O(n²)，但几乎有序时效率极高</p>",
      "<p>空间复杂度：O(1)</p>",
      "<p>稳定：✅</p>",
      "<ul>\n<li>快速排序: 分治思想，选一个“基准”pivot，小的放左，大的放右，然后递归。</li>\n</ul>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::eeq9k9n2lkseovbrgyqz1::--><code>function quickSort(arr) {\n  if (arr.length &lt;= 1) return arr;\n  const pivot = arr[arr.length &gt;&gt; 1];\n  const left = arr.filter(x =&gt; x &lt; pivot);\n  const mid = arr.filter(x =&gt; x === pivot);\n  const right = arr.filter(x =&gt; x &gt; pivot);\n  return [...quickSort(left), ...mid, ...quickSort(right)];\n}\n</code></pre>\n</div>",
      "<p>平均复杂度：O(n log n)</p>",
      "<p>最坏复杂度：O(n²)（当数组几乎有序时）</p>",
      "<p>稳定：❌</p>",
      "<ul>\n<li>归并排序: 分治思想，将数组不断二分排序后再合并</li>\n</ul>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::jsrus7ttfsqptxhyy36lj::--><code>\nfunction mergeSort(arr) {\n  if (arr.length &lt;= 1) return arr;\n  const mid = Math.floor(arr.length / 2);\n  const left = mergeSort(arr.slice(0, mid));\n  const right = mergeSort(arr.slice(mid));\n  return merge(left, right);\n}\n\nfunction merge(left, right) {\n  const res = [];\n  while (left.length &amp;&amp; right.length) {\n    res.push(left[0] &lt;= right[0] ? left.shift() : right.shift());\n  }\n  return [...res, ...left, ...right];\n}\n\n</code></pre>\n</div>",
      "<p>时间复杂度：O(n log n)</p>",
      "<p>空间复杂度：O(n)</p>",
      "<p>稳定：✅</p>",
      "<ul>\n<li>计数排序: 非比较类排序，统计每个元素出现次数</li>\n</ul>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::0hheedzlp1wjaqxrlbu7wh::--><code>function countingSort(arr, maxValue) {\n  const count = new Array(maxValue + 1).fill(0);\n  arr.forEach(v =&gt; count[v]++);\n  const res = [];\n  count.forEach((v, i) =&gt; { while (v--) res.push(i); });\n  return res;\n}\n</code></pre>\n</div>",
      "<p>时间复杂度：O(n + k)</p>",
      "<p>空间复杂度：O(k)</p>",
      "<p>稳定：✅</p>",
  ...
  },
  {
    ...
    "answerHtml": [
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::4ewtcjhncnxymdizpkbsbi::--><code>function shuffle(array) {\n  let arr = array.slice(); // 拷贝一份，不修改原数组\n  for (let i = arr.length - 1; i &gt; 0; i--) {\n    const j = Math.floor(Math.random() * (i + 1)); // 随机索引 [0, i]\n    [arr[i], arr[j]] = [arr[j], arr[i]]; // 交换\n  }\n  return arr;\n}\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<ul>\n<li>过程中记录窗口最大长度。</li>\n</ul>",
      "<div class=\"language-js\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">js</span><pre><!--::markdown-it-async::ihlf02haupr9e61cp4thwm::--><code>function lengthOfLongestSubstring(s) {\n  let set = new Set();\n  let left = 0, maxLen = 0;\n\n  for (let right = 0; right &lt; s.length; right++) {\n    while (set.has(s[right])) {\n      set.delete(s[left]);\n      left++;\n    }\n    set.add(s[right]);\n    maxLen = Math.max(maxLen, right - left + 1);\n  }\n\n  return maxLen;\n}\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::c70jfsjzz9jgcztfbrjxuj::--><code>const fakeWindow = {};\nconst proxy = new Proxy(window, {\n        get(target, key) {\n        return key in fakeWindow ? fakeWindow[key] : target[key];\n},\nset(target, key, value) {\n        fakeWindow[key] = value;\n        return true;\n      }\n});</code></pre>\n</div>",
      "<ul>\n<li>样式隔离:</li>\n</ul>",
  ...
  },
  {
    ...
    "answerHtml": [
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::qtudiu574rec1auayft1t::--><code>import type { Plugin } from &#039;vite&#039;;\n\nfunction myPlugin(options?): Plugin {\n  return {\n    name: &#039;my-plugin&#039;,  // **必须**有 name，方便调试\n    // enforce: &#039;pre&#039; 或 &#039;post&#039;（可选），指定此插件执行顺序\n    config(config, { command }) {\n      // 修改 Vite / Rollup 配置（可选）\n    },\n    configResolved(resolvedConfig) {\n      // 当最终 config 确定后执行\n    },\n    resolveId(source, importer) {\n      // 自定义模块解析逻辑\n    },\n    load(id) {\n      // 如果你要“自己加载一个模块”，返回内容\n      // 否则返回 null 让后续钩子 /默认流程处理\n    },\n    transform(code, id) {\n      // 转换模块源代码，返回 { code, map } 或 string\n    },\n    handleHotUpdate(ctx) {\n      // 在开发服务下，处理 HMR 热更新逻辑\n    },\n    // 构建阶段钩子\n    buildStart() { },\n    generateBundle(options, bundle, isWrite) { },\n    writeBundle() { },\n    closeBundle() { },\n  };\n}</code></pre>\n</div>",
      "<p>// 替换模板的一个字</p>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::df5qcmtjf5delqrd7fa85q::--><code>export default function replaceTextPlugin(options = { search: &#039;FOO&#039;, replace: &#039;BAR&#039; }) {\n  return {\n    name: &#039;vite-plugin-replace-text&#039;,\n    enforce: &#039;pre&#039;,\n    transform(code, id) {\n      if (/\\.(js|ts|jsx|tsx)$/.test(id)) {\n        return code.replace(new RegExp(options.search, &#039;g&#039;), options.replace);\n      }\n      return null;\n    }\n  };\n}</code></pre>\n</div>",
      "<p>// 统计TODO</p>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::97mu1xwm3j9mtf2zt2efh::--><code>import fs from &#039;fs&#039;;\nimport path from &#039;path&#039;;\n\nexport function vitePluginTodo() {\n  const todos = [];\n\n  function scanFile(filePath) {\n    const code = fs.readFileSync(filePath, &#039;utf-8&#039;);\n    const lines = code.split(&#039;\\n&#039;);\n\n    lines.forEach((line, index) =&gt; {\n      const todoMatch = line.match(/\\/\\/\\s*TODO\\s*:(.*)/i) \n                     || line.match(/\\/\\*\\s*TODO\\s*:(.*)\\*\\//i);\n\n      if (todoMatch) {\n        todos.push({\n          file: path.relative(process.cwd(), filePath),\n          line: index + 1,\n          content: todoMatch[1].trim(),\n        });\n      }\n    });\n  }\n\n  function scanDir(dir) {\n    const entries = fs.readdirSync(dir, { withFileTypes: true });\n    for (const entry of entries) {\n      const fullPath = path.join(dir, entry.name);\n\n      if (entry.isDirectory()) {\n        if (entry.name === &#039;node_modules&#039; || entry.name.startsWith(&#039;.&#039;)) continue;\n        scanDir(fullPath);\n      } else if (/\\.(ts|js|tsx|jsx|vue)$/.test(entry.name)) {\n        scanFile(fullPath);\n      }\n    }\n  }\n\n  console.log(&#039;vite-plugin-todo&#039;);\n  return {\n    name: &#039;vite-plugin-todo&#039;,\n    apply: &#039;build&#039;,\n    buildStart() {\n      console.log(&#039;vite-plugin-todo buildStart&#039;);\n      todos.length = 0;\n      scanDir(process.cwd());\n    },\n    closeBundle() {\n      if (todos.length &gt; 0) {\n        console.log(&#039;\\n💡 TODO List:&#039;);\n        todos.forEach(todo =&gt; {\n          console.log(`${todo.file}:${todo.line} - ${todo.content}`);\n        });\n      } else {\n        console.log(&#039;\\n✅ No TODO found.&#039;);\n      }\n    }\n  };\n}\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::v5jvnir8yjpcahrfq9i9b::--><code>function isElementRendered(sampleCount = 10) {\n    let visibleCount = 0;\n    for (let i = 0; i &lt; sampleCount; i++) {\n        const x = Math.random() * window.innerWidth;\n        const y = Math.random() * window.innerHeight;\n        const element = document.elementFromPoint(x, y);\n\n        if (element &amp;&amp; element.offsetParent !== null) {\n            visibleCount++;\n        }\n    }\n\n    return visibleCount / sampleCount &gt; 0.5; // 如果超过一半的采样点有可见元素，认为页面已渲染\n}</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::rqd906w8g288sjrgkjso7::--><code>┌────────────────────────────┐\n│       1. 取一个宏任务       │ (如 script, I/O, setTimeout 回调)\n├────────────────────────────┤\n│       2. 执行所有微任务     │ (Promise.then, MutationObserver)\n├────────────────────────────┤\n│       3. 执行渲染前钩子     │ (requestAnimationFrame)\n├────────────────────────────┤\n│       4. 执行渲染 / 绘制    │ (样式计算, 布局, 合成, 绘制)\n├────────────────────────────┤\n│       5. requestIdleCallback │ (如果有空闲)\n├────────────────────────────┤\n│       6. 下一个宏任务循环    │\n└────────────────────────────┘\n</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<p>典型用法:</p>",
      "<div class=\"language-jsx\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">jsx</span><pre><!--::markdown-it-async::5vvj2lr7diwqxiybi3ldpq::--><code>&lt;Form form={form} initialValues={{ username: &#039;Tom&#039; }}&gt;\n  &lt;Form.Item name=&quot;username&quot;&gt;\n    &lt;Input /&gt;\n  &lt;/Form.Item&gt;\n&lt;/Form&gt;</code></pre>\n</div>",
      "<p>对应关系：</p>",
      "<div class=\"language-js\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">js</span><pre><!--::markdown-it-async::udx1gzkekxfv1ghrlfsqno::--><code>&lt;Form&gt;           —— 维护 FormStore（字段状态）\n   │\n   └─&lt;FormContext.Provider&gt;  —— 提供 Store 和订阅方法\n        │\n        └─&lt;Form.Item name=&quot;username&quot;&gt; —— 注册字段\n              │\n              └─ cloneElement(&lt;Input&gt;, {value, onChange})</code></pre>\n</div>",
      "<ol>\n<li>流程详解</li>\n</ol>",
      ...
      "<div class=\"language-js\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">js</span><pre><!--::markdown-it-async::p88ujvpki0dlkambp94br::--><code>    {\n    value: store[name],\n    onChange: (e) =&gt; {\n      const newValue = e &amp;&amp; e.target ? e.target.value : e;\n      store.setFieldValue(name, newValue);\n    }\n  }</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      "<div class=\"language-js\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">js</span><pre><!--::markdown-it-async::93ly5qv67a60uxe6kucp2h::--><code>function arrange(name) {\n  const queue = []\n\n  const obj = {\n    do(task) {\n      queue.push({ first: false, fn: () =&gt; console.log(`Start to ${task}`) })\n      return obj\n    },\n    wait(sec) {\n      queue.push({ first: false, fn: () =&gt; new Promise(r =&gt; {\n        console.log(`等待 ${sec} 秒`)\n        setTimeout(r, sec * 1000)\n      })})\n      return obj\n    },\n    waitFirst(sec) {\n      queue.push({ first: true, fn: () =&gt; new Promise(r =&gt; {\n        console.log(`等待 ${sec} 秒`)\n        setTimeout(r, sec * 1000)\n      })})\n      return obj\n    },\n    async execute() {\n      // 先执行所有 waitFirst\n      for (const t of queue.filter(t =&gt; t.first)) await t.fn()\n      // 打印通知\n      console.log(`${name} is notified`)\n      // 执行剩下的普通任务\n      for (const t of queue.filter(t =&gt; !t.first)) {\n        const res = t.fn()\n        if (res instanceof Promise) await res\n      }\n    }\n  }\n\n  return obj\n}</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      "<div class=\"language-jsx\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">jsx</span><pre><!--::markdown-it-async::hsum6yfvs94crb0nv9mn4::--><code>// 代码由github copilot 生成\n\nimport { useCallback, useEffect, useRef, useState } from &quot;react&quot;;\n\nconst INITIAL = 120;\n\nconst Demo = () =&gt; {\n  const [time, setTime] = useState(INITIAL);\n  const [isStop, setStop] = useState(false);\n  const t = useRef(null);\n\n  // 提取清理函数，统一调用\n  const clearTimer = useCallback(() =&gt; {\n    if (t.current) {\n      clearInterval(t.current);\n      t.current = null;\n    }\n  }, []);\n\n  useEffect(() =&gt; {\n    // 如果暂停，清理定时器并返回\n    if (isStop) {\n      clearTimer();\n      return;\n    }\n\n    // 已有定时器则不重复创建\n    if (t.current) return;\n\n    t.current = setInterval(() =&gt; {\n      setTime((prev) =&gt; {\n        if (prev &lt;= 1) {\n          // 到 0 时清理定时器并返回 0\n          clearTimer();\n          return 0;\n        }\n        return prev - 1;\n      });\n    }, 1000);\n\n    // 卸载时清理\n    return () =&gt; {\n      clearTimer();\n    };\n  }, [isStop, clearTimer]);\n\n  // 卸载时再确保清理（保险）\n  useEffect(() =&gt; {\n    return () =&gt; {\n      clearTimer();\n    };\n  }, [clearTimer]);\n\n  const stopAc = useCallback(() =&gt; {\n    setStop((v) =&gt; !v);\n  }, []);\n\n  const down = useCallback(() =&gt; {\n    setTime((t) =&gt; (t - 10 &gt; 0 ? t - 10 : 0));\n  }, []);\n\n  // 重新开始：清理旧定时器、重置时间并立即启动新定时器\n  const restart = useCallback(() =&gt; {\n    clearTimer();\n    setTime(INITIAL);\n    setStop(false);\n\n    // 立即启动新的定时器（与 useEffect 中逻辑一致）\n    if (!t.current) {\n      t.current = setInterval(() =&gt; {\n        setTime((prev) =&gt; {\n          if (prev &lt;= 1) {\n            clearTimer();\n            return 0;\n          }\n          return prev - 1;\n        });\n      }, 1000);\n    }\n  }, [clearTimer]);\n\n  const formatTime = (secs) =&gt; {\n    const m = Math.floor(secs / 60)\n      .toString()\n      .padStart(2, &quot;0&quot;);\n    const s = (secs % 60).toString().padStart(2, &quot;0&quot;);\n    return `${m}:${s}`;\n  };\n\n  return (\n    &lt;&gt;\n      &lt;div aria-live=&quot;polite&quot; style={{ fontSize: 32, marginBottom: 12 }}&gt;\n        {formatTime(time)}\n      &lt;/div&gt;\n      &lt;button onClick={stopAc} aria-pressed={isStop}&gt;\n        {isStop ? &quot;恢复&quot; : &quot;暂停&quot;}\n      &lt;/button&gt;\n      &lt;button onClick={down} disabled={time === 0} aria-disabled={time === 0}&gt;\n        减10秒倒计时\n      &lt;/button&gt;\n      &lt;button onClick={restart} style={{ marginLeft: 8 }}&gt;\n        重新开始\n      &lt;/button&gt;\n      {time === 0 ? &lt;button aria-label=&quot;秒杀按钮&quot;&gt;秒杀&lt;/button&gt; : null}\n    &lt;/&gt;\n  );\n};\n\nexport default Demo;\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      "<div class=\"language-js\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">js</span><pre><!--::markdown-it-async::xhjh31mlj7cjfudoeb8rbd::--><code>\nfunction debounce(fn, wait = 300) {\n  let timer = null;\n  return function(...args) {\n    clearTimeout(timer);\n    timer = setTimeout(() =&gt; {\n      fn.apply(this, args);\n    }, wait);\n  };\n}\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      "<div class=\"language-js\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">js</span><pre><!--::markdown-it-async::djtf256wbou8m33sffqhg::--><code>\nfunction throttle_timestamp(fn, wait) {\n  let last = 0; // 上次执行时间（ms）\n\n  return function (...args) {\n    const now = Date.now();\n    if (now - last &gt;= wait) {\n      last = now;\n      fn.apply(this, args);\n    }\n  };\n}\n\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      "<div class=\"language-js\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">js</span><pre><!--::markdown-it-async::tc24r3oekdhr8p6vdf9i5j::--><code>class MyPromise {\n        static PENDING = &quot;pending&quot;;\n        static RESOLVED = &quot;resolved&quot;;\n        static REJECTED = &quot;rejected&quot;;\n        constructor(executor) {\n          this.status = MyPromise.PENDING;\n          // resolve 的值\n          this.value = null;\n          // reject 的值\n          this.reason = null;\n          // then 成功回调\n          this.onFulfilledQueues = [];\n          // then 失败回调\n          this.onRejectedQueues = [];\n\n          // 执行成功回掉\n          let resolve = (value) =&gt; {\n            if (this.status === MyPromise.PENDING) {\n              this.status = MyPromise.RESOLVED;\n              this.value = value;\n              // console.log(&quot;this.onFulfilledQueues&quot;, this.onFulfilledQueues);\n              this.onFulfilledQueues.forEach((item) =&gt; {\n                try {\n                  item(value);\n                } catch (err) {\n                  reject(err);\n                }\n              });\n            }\n          };\n\n          // 执行失败回掉\n          let reject = (reason) =&gt; {\n            if (this.status === MyPromise.PENDING) {\n              this.status = MyPromise.REJECTED;\n              this.reason = reason;\n              this.onRejectedQueues.forEach((item) =&gt; {\n                try {\n                  item(value);\n                } catch (err) {\n                  reject(err);\n                }\n              });\n            }\n          };\n\n          try {\n            executor(resolve, reject);\n          } catch (err) {\n            reject(err);\n          }\n        }\n\n        then(onFulfilled, onRejected) {\n          onFulfilled =\n            typeof onFulfilled === &quot;function&quot; ? onFulfilled : (value) =&gt; value;\n          onRejected =\n            typeof onRejected === &quot;function&quot;\n              ? onRejected\n              : (reason) =&gt; {\n                  throw reason;\n                };\n\n          const promise = new MyPromise((res, rej) =&gt; {\n            if (this.status === MyPromise.PENDING) {\n              this.onFulfilledQueues.push((v) =&gt; res(onFulfilled(v)));\n              this.onRejectedQueues.push((v) =&gt; rej(onRejected(v)));\n            }\n            // 状态是成功态，直接就调用 onFulfilled 函数\n            if (this.status === MyPromise.RESOLVED) {\n              res(onFulfilled(this.value));\n            }\n\n            // 状态是成功态，直接就调用 onRejected 函数\n            if (this.status === MyPromise.REJECTED) {\n              rej(onRejected(this.reason));\n            }\n          });\n\n          return promise;\n        }\n\n        // 将多个 Promise 并行等待：所有都成功则返回按原数组顺序的结果数组，\n        // 只要有一个失败则立即 reject（行为类似原生 Promise.all）\n        // 参数：arr - Promise 实例数组\n        // 返回：MyPromise，resolve(valueArray) / reject(firstError)\n        static all(arr) {\n          return new MyPromise((res, rej) =&gt; {\n            let result = [];\n            let count = 0;\n            for (let i = 0; i &lt; arr.length; i++) {\n              arr[i].then(\n                (d) =&gt; {\n                  result[i] = d;\n                  if (++count === arr.length) {\n                    res(result);\n                  }\n                },\n                (err) =&gt; {\n                  rej(err);\n                }\n              );\n            }\n          });\n        }\n        // 竞速：返回第一个完成（resolve 或 reject）的结果（类似原生 Promise.race）\n        // 参数：arr - Promise 实例数组\n        // 返回：MyPromise，resolve(firstResolved) 或 reject(firstRejected)\n      \n        static race(arr) {\n          return new MyPromise((res, rej) =&gt; {\n            for (let i = 0; i &lt; arr.length; i++) {\n              arr[i].then(res, rej);\n            }\n          });\n        }\n        \n        // allSettled：等待所有 Promise 都 settle（不论成功或失败）后返回结果集合\n        // 参数：promises - Promise 实例数组\n        // 返回：MyPromise，resolve(resultArray)\n        // 说明：本实现将每个 Promise 的 finally 视作“完成”的回调点并把返回值放到结果数组，\n        //       意味着结果数组项的结构取决于 finally 回调传入的值 —— 与原生 Promise.allSettled 返回\n        //       的 {status, value/reason} 结构有所不同。调整以匹配原生行为可在 finally/then 中\n        //       分别处理 fulfilled/rejected 情况。\n\n        static allSettled(promises) {\n          return new MyPromise((resolve) =&gt; {\n            let result = [];\n            let count = 0;\n            for (let i = 0; i &lt; promises.length; i++) {\n              promises[i].finally((res) =&gt; {\n                result[i] = res;\n                if (++count == promises.length) {\n                  resolve(result);\n                }\n              });\n            }\n          });\n        }\n\n        // any：只要有一个 Promise 成功就 resolve（值为第一个成功的结果），\n        //      若全部失败则 reject，返回所有错误组成的数组（行为类似原生 Promise.any，\n        //      但原生 Promise.any 在全部失败时会返回 AggregateError）\n        // 参数：arr - Promise 实例数组\n        // 返回：MyPromise，resolve(firstSuccess) 或 reject(errorArray)\n \n        static any(arr) {\n          return new MyPromise((res, rej) =&gt; {\n            let result = [];\n            let count = 0;\n            for (let i = 0; i &lt; arr.length; i++) {\n              arr[i].then(\n                (d) =&gt; {\n                  res(d);\n                },\n                (err) =&gt; {\n                  result[i] = err;\n                  if (++count === arr.length) {\n                    rej(result);\n                  }\n                }\n              );\n            }\n          });\n        }\n\n        catch(rej) {\n          return this.then(null, rej);\n        }\n\n        finally(res) {\n          return this.then(res, res);\n        }\n\n        // map：限制并发数的 Promise 执行器\n        // 参数：\n        //   promises - Promise 实例数组（或返回 Promise 的函数数组，视使用场景）\n        //   concurrency - 最大并发数（同时运行的 Promise 数量上限）\n        // 返回：MyPromise，resolve(resultArray) 在所有 Promise 完成后触发\n        // 算法要点：\n        //  - 使用 nextIndex 指向下一个待启动的 Promise，下发任务时递增 nextIndex\n        //  - 初始启动 concurrency 个任务；每当一个任务完成后（finally 回调），\n        //    记录结果并启动下一个待办任务，从而始终保持并发数量不超过 concurrency\n        //  - 通过 count 统计已完成任务数，全部完成后 resolve 最终结果数组\n        // 注意：\n        //  - 这里通过 promises[i].finally(...) 作为“完成”判定点，因此无论成功或失败都\n        //    会触发后续调度；若需区分成功/失败并保留状态信息，需要在 finally/then 中\n        //    对 result 数组项存储更丰富的对象（如 { status, value/reason }）\n\n        static map(promises, concurrency) {\n          // 返回一个新的 MyPromise\n          return new MyPromise((resolve) =&gt; {\n            let result = []; // 用于保存每个 Promise 的结果\n            let count = 0; // 已完成的 Promise 数量\n            let nextIndex = 0; // 下一个要启动的 Promise 下标\n\n            // 并发执行的函数\n            function run() {\n              // 如果所有 Promise 都已启动，则直接返回\n              if (nextIndex &gt;= promises.length) return;\n              const current = nextIndex; // 当前要启动的 Promise 下标\n              nextIndex++; // 下一个要启动的下标\n              // 启动当前 Promise，并在其 finally 后处理结果\n              promises[current].finally((res) =&gt; {\n                result[current] = res; // 保存结果到对应位置\n                count++; // 完成数量加一\n                if (count === promises.length) {\n                  // 所有 Promise 都完成后，resolve 最终结果\n                  resolve(result);\n                } else {\n                  // 启动下一个 Promise\n                  run();\n                }\n              });\n            }\n\n            // 一开始并发启动 concurrency 个 Promise\n            for (let i = 0; i &lt; concurrency &amp;&amp; i &lt; promises.length; i++) {\n              run();\n            }\n          });\n        }\n      }\n\n      let p1 = new MyPromise((resolve, reject) =&gt; {\n        setTimeout(() =&gt; {\n          console.log(&quot;ok&quot;);\n          resolve(&quot;成功了&quot;);\n        }, 1000);\n      });\n\n      p1.then(\n        (data) =&gt; {\n          console.log(&quot;then1 resolve&quot;, data);\n          return 111;\n        },\n        (err) =&gt; {\n          console.log(&quot;then1 reject&quot;, err);\n        }\n      )\n        .then(\n          (data) =&gt; {\n            console.log(&quot;then2 resolve&quot;, data);\n          },\n          (err) =&gt; {\n            console.log(&quot;then2 reject&quot;, err);\n          }\n        )\n        .then(\n          (data) =&gt; {\n            console.log(&quot;then3 resolve&quot;, data);\n          },\n          (err) =&gt; {\n            console.log(&quot;then3 reject&quot;, err);\n          }\n        );\n\n      let Promise1 = new MyPromise((resolve, reject) =&gt; {\n        setTimeout(() =&gt; {\n          resolve(&quot;Promise1&quot;);\n        }, 5000);\n        resolve(&quot;Promise2&quot;);\n      });\n\n      let Promise2 = new MyPromise((resolve, reject) =&gt; {\n        resolve(&quot;Promise2&quot;);\n      });\n\n      let Promise3 = new MyPromise((resolve, reject) =&gt; {\n        resolve(&quot;Promise3&quot;);\n      });\n\n      let Promise4 = new MyPromise((resolve, reject) =&gt; {\n        resolve(&quot;Promise4&quot;);\n      });\n      let Promise5 = new MyPromise((resolve, reject) =&gt; {\n        reject(&quot;Promise5&quot;);\n      });\n      let Promise6 = new MyPromise((resolve, reject) =&gt; {\n        reject(&quot;Promise6&quot;);\n      });\n\n      let p = MyPromise.all([Promise1, Promise2, Promise3, Promise4]);\n\n      p.then(\n        (res) =&gt; {\n          // 三个都成功则成功\n          console.log(&quot;all ---成功了&quot;, res);\n        },\n        (err) =&gt; {\n          console.log(&quot;all ---失败了&quot;, err);\n        }\n      ).catch((error) =&gt; {\n        // 只要有失败，则失败\n        console.log(&quot;all ---失败了&quot;, err);\n      });\n\n      MyPromise.any([Promise4, Promise5, Promise6])\n        .then(\n          (res) =&gt; {\n            // 三个都成功则成功\n            console.log(&quot;any 成功了&quot;, res);\n          },\n          (err) =&gt; {\n            console.log(&quot;any 失败了&quot;, err);\n          }\n        )\n        .catch((error) =&gt; {\n          // 只要有失败，则失败\n          console.log(&quot;any 失败了&quot;, err);\n        });\n\n      Promise.race([Promise1, Promise2, Promise3]).then(\n        (res) =&gt; {\n          console.log(&quot;race resolve&quot;, res);\n        },\n        (rej) =&gt; {\n          console.log(&quot;race reject&quot;, rej);\n        }\n      );\n\n      let pAll = MyPromise.allSettled([Promise1, Promise2, Promise3, Promise4]);\n\n      pAll.then(\n        (res) =&gt; {\n          // 三个都成功则成功\n          console.log(&quot;---成功了 allSettled&quot;, res);\n        },\n        (err) =&gt; {\n          // 只要有失败，则失败\n          console.log(&quot;---失败了 allSettled&quot;, err);\n        }\n      );\n\n      // 2s 后输出：---成功了 (4) [&quot;Promise1&quot;, &quot;Promise2&quot;, &quot;Promise3&quot;, &quot;Promise4&quot;]\n\n      // 直接输出：---失败了 Promise4\n\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-js\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">js</span><pre><!--::markdown-it-async::eyj12u8p5mocyg9tikb536::--><code>// 简单版\nFunction.prototype.myBind = function (context) {\n  const fn = this; // 保存原函数\n  return function () {\n    return fn.apply(context);\n  };\n};\n\n// 支持参数传递（柯里化）\nFunction.prototype.myBind = function (context, ...args) {\n  const fn = this;\n  return function (...innerArgs) {\n    return fn.apply(context, [...args, ...innerArgs]);\n  };\n};\n\n\n// 考虑 new 构造调用\nFunction.prototype.myBind = function (context, ...args) {\n  const fn = this;\n\n  function boundFn(...innerArgs) {\n    // 如果作为构造函数被调用\n    const isNew = this instanceof boundFn;\n    return fn.apply(isNew ? this : context, [...args, ...innerArgs]);\n  }\n\n  // 继承原函数原型\n  boundFn.prototype = Object.create(fn.prototype);\n\n  return boundFn;\n};\n</code></pre>\n</div>",
      ...
      "<div class=\"language-js\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">js</span><pre><!--::markdown-it-async::3m7ak3kiom76e56afck2k::--><code>function greet(g1, g2) {\n  console.log(this.name, g1, g2);\n}\n\nconst obj = { name: &quot;Alice&quot; };\n\ngreet.call(obj, &quot;Hello&quot;, &quot;World&quot;);   // Alice Hello World\ngreet.apply(obj, [&quot;Hi&quot;, &quot;JS&quot;]);      // Alice Hi JS\nconst bound = greet.bind(obj, &quot;Hey&quot;);\nbound(&quot;React&quot;);                      // Alice Hey React\n</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-js\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">js</span><pre><!--::markdown-it-async::yiruy65jys2qocsp8i8p7::--><code>function myInstanceof(left, right) {\n  let proto = Object.getPrototypeOf(left), // 获取对象的原型\n      prototype = right.prototype; // 获取构造函数的 prototype 对象\n\n  // 判断构造函数的 prototype 对象是否在对象的原型链上\n  while (true) {\n    if (!proto) return false;\n    if (proto === prototype) return true;\n\n    proto = Object.getPrototypeOf(proto);\n  }\n}</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-js\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">js</span><pre><!--::markdown-it-async::azo8p541h1gcmx6o06kfti::--><code>\nfunction myNew(constructor, ...args) {\n  if (typeof constructor !== &quot;function&quot;) return\n  let obj = {}\n  obj.prototype = Object.create(constructor.prototype)\n  const res = constructor.apply(obj, args)\n  if (res &amp;&amp; (typeof res !== &quot;object&quot; || typeof res === &quot;function&quot;)) return res\n  return obj\n}\nfunction Fn(obj) {\n  this.obj =obj\n}\nlet obj =myNew(Fn,&#039;222&#039;)\nconsole.log(obj);\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::1szmiukgnvsp2z3hgb0jeq::--><code>function add(a, b, c) {\n  return a + b + c;\n}\n\nadd(1, 2, 3)  →  curry(add)(1)(2)(3)\n\ncurry(add)(1)  // 返回一个函数，等待第二个参数\n\n</code></pre>\n</div>",
      "<p>好处:</p>\n<ul>\n<li>✅ 参数复用（延迟调用）</li>\n</ul>",
      "<ul>\n<li>✅ 提高函数复用性、组合性</li>\n</ul>",
      "<ul>\n<li>✅ 实现函数“预设参数”（偏函数）</li>\n</ul>",
      "<ul>\n<li>✅ 提升代码可读性和函数式风格</li>\n</ul>",
      "<div class=\"language-js\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">js</span><pre><!--::markdown-it-async::axkkhfu4h662jlevexn66r::--><code>\nfunction curry(fn) {\n  const curried = (...args) =&gt; {\n    // 如果参数足够就执行，否则返回新函数继续收集\n    return args.length &gt;= fn.length\n      ? fn(...args)\n      : (...next) =&gt; curried(...args, ...next);\n  };\n  return curried;\n}\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::0b2b1na93od793kyarc8rf::--><code>document.addEventListener(&#039;visibilitychange&#039;, () =&gt; {\n  if (document.hidden) {\n    console.log(&#039;用户离开页面（切换标签页或最小化）&#039;);\n  } else {\n    console.log(&#039;用户回到页面&#039;);\n  }\n});\n</code></pre>\n</div>",
      "<p>二、窗口焦点（Focus / Blur）</p>",
      "<p>检测窗口或 iframe 是否获得焦点</p>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::fjc189xabf9pphditve2ti::--><code>window.addEventListener(&#039;blur&#039;, () =&gt; {\n  console.log(&#039;用户离开了当前窗口/标签页&#039;);\n});\n\nwindow.addEventListener(&#039;focus&#039;, () =&gt; {\n  console.log(&#039;用户回到当前窗口/标签页&#039;);\n});\n</code></pre>\n</div>",
      "<p>三、用户离开页面 / 卸载（beforeunload / unload）</p>",
      "<p>检测用户关闭页面、刷新或跳转。</p>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::a3bhsr4ex8h4hsbvid2o2h::--><code>window.addEventListener(&#039;beforeunload&#039;, (e) =&gt; {\n  console.log(&#039;用户可能离开页面&#039;);\n  // 阻止默认提示（可选）\n  e.preventDefault();\n  e.returnValue = &#039;&#039;;\n});\n</code></pre>\n</div>",
      "<p>四、鼠标 / 用户交互检测</p>",
      "<p>当用户长时间没有交互（鼠标、键盘、触屏），可推测用户离开</p>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::i9rhfwhbr6b1mfo4sum8f::--><code>let idleTimer;\nfunction resetIdle() {\n  clearTimeout(idleTimer);\n  idleTimer = setTimeout(() =&gt; {\n    console.log(&#039;用户可能离开或无操作&#039;);\n  }, 30000); // 30秒无操作\n}\n\n// 监听用户操作\n[&#039;mousemove&#039;,&#039;keydown&#039;,&#039;click&#039;,&#039;scroll&#039;,&#039;touchstart&#039;].forEach(ev =&gt;\n  document.addEventListener(ev, resetIdle)\n);\nresetIdle();\n</code></pre>\n</div>",
      "<p>可以检测“用户不活跃”，用于自动登出、心跳等.</p>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::r2utmt343mzctxddhrjni::--><code>let idleTimer;\nfunction onUserIdle() { console.log(&#039;用户离开页面或长时间不操作&#039;); }\nfunction resetIdle() {\n  clearTimeout(idleTimer);\n  idleTimer = setTimeout(onUserIdle, 30000);\n}\n[&#039;mousemove&#039;,&#039;keydown&#039;,&#039;click&#039;,&#039;scroll&#039;,&#039;touchstart&#039;].forEach(ev =&gt; \n  document.addEventListener(ev, resetIdle)\n);\nresetIdle();\n\ndocument.addEventListener(&#039;visibilitychange&#039;, () =&gt; {\n  if (document.hidden) onUserIdle();\n});\nwindow.addEventListener(&#039;blur&#039;, onUserIdle);\nwindow.addEventListener(&#039;focus&#039;, resetIdle);\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      "<ol>\n<li>解析依赖关系</li>\n<li>构建观察者 / 订阅机制</li>\n<li>动态执行规则</li>\n</ol>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::7154u0afamgg1nnq2skxs7::--><code>formFields = [\n  { field: &#039;province&#039;, type: &#039;select&#039; },\n  { field: &#039;city&#039;, type: &#039;select&#039;, dependsOn: &#039;province&#039;, compute: (state) =&gt; cities[state.province] }\n]\n\n// 生成依赖图\ndepMap = {\n  province: [&#039;city&#039;]\n}\n\n// 字段值变化时触发依赖\nfunction onChange(field, value) {\n  formState[field] = value;\n  (depMap[field] || []).forEach(depField =&gt; {\n    const compute = formFields.find(f =&gt; f.field === depField).compute;\n    if(compute) formState[depField] = compute(formState);\n  });\n}\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::owkgiztwkfhtg21j245kqr::--><code>let lastRequestId = 0;\n\nasync function fetchData(query) {\n  const requestId = ++lastRequestId; // 每次请求自增\n  const res = await fetch(`/api/search?q=${query}`);\n  const data = await res.json();\n\n  if (requestId === lastRequestId) {\n    setData(data); // 只有最新请求才能更新UI\n  }\n}\n</code></pre>\n</div>",
      "<ol start=\"2\">\n<li>AbortController（中断旧请求）</li>\n</ol>\n<ul>\n<li>在发新请求前，主动“中止”旧请求。</li>\n</ul>",
      "<ol start=\"3\">\n<li>使用 useEffect + cleanup</li>\n</ol>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::9knd7mhmqyyr1q63c3lw::--><code>useEffect(() =&gt; {\n  let canceled = false;\n\n  (async () =&gt; {\n    const res = await fetch(`/api/data?id=${id}`);\n    const data = await res.json();\n    if (!canceled) setData(data);\n  })();\n\n  return () =&gt; (canceled = true); // 清理逻辑\n}, [id]);\n</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::ktmwlfbk2rawbv95xag96::--><code>// KeepAlive.jsx \nimport { useRef } from &#039;react&#039;;\nimport { useLocation } from &#039;react-router-dom&#039;;\n\nexport default function KeepAlive({ children }) {\n  const location = useLocation();\n  const cacheRef = useRef({});\n  const path = location.pathname;\n\n  Object.keys(cacheRef.current).forEach((key) =&gt; {\n    cacheRef.current[key].style.display = key === path ? &#039;block&#039; : &#039;none&#039;;\n  });\n\n  if (!cacheRef.current[path]) {\n    const div = document.createElement(&#039;div&#039;);\n    div.style.display = &#039;block&#039;;\n    cacheRef.current[path] = div;\n  }\n\n  return (\n    &lt;&gt;\n      {Object.entries(cacheRef.current).map(([key, container]) =&gt; (\n        &lt;div\n          key={key}\n          style={{ display: key === path ? &#039;block&#039; : &#039;none&#039; }}\n        &gt;\n          {key === path ? children : null}\n        &lt;/div&gt;\n      ))}\n    &lt;/&gt;\n  );\n}\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<p>js sdk</p>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::vyha7cfl59pa5p10b0pa7::--><code>// perf-sdk.js (浏览器端核心逻辑, 精简示例)\n(function (window) {\n  const APP = {};\n  const SEND_URL = &#039;/beacon/perf&#039;;\n  const BATCH_MAX = 20;\n  const BATCH_INTERVAL = 5000; // ms\n  let queue = [];\n\n  function now() { return Math.round(performance.now()); }\n\n  // 收集 web vitals\n  function installVitals() {\n    // LCP\n    try {\n      const po = new PerformanceObserver((list) =&gt; {\n        const entries = list.getEntries();\n        const last = entries[entries.length - 1];\n        if (last) push({ k: &#039;lcp&#039;, v: Math.round(last.startTime) });\n      });\n      po.observe({ type: &#039;largest-contentful-paint&#039;, buffered: true });\n    } catch (e) {}\n\n    // CLS\n    try {\n      let clsValue = 0;\n      const po2 = new PerformanceObserver((list) =&gt; {\n        for (const entry of list.getEntries()) {\n          if (!entry.hadRecentInput) clsValue += entry.value;\n        }\n      });\n      po2.observe({ type: &#039;layout-shift&#039;, buffered: true });\n      window.addEventListener(&#039;visibilitychange&#039;, () =&gt; {\n        if (document.visibilityState === &#039;hidden&#039;) push({ k: &#039;cls&#039;, v: clsValue });\n      });\n    } catch (e) {}\n\n    // FCP\n    try {\n      const po3 = new PerformanceObserver((list) =&gt; {\n        const fcp = list.getEntries()[0];\n        if (fcp) push({ k: &#039;fcp&#039;, v: Math.round(fcp.startTime) });\n      });\n      po3.observe({ type: &#039;paint&#039;, buffered: true });\n    } catch (e) {}\n  }\n\n  function captureNavigation() {\n    const nav = performance.getEntriesByType(&#039;navigation&#039;)[0];\n    if (nav) {\n      push({ k: &#039;ttfb&#039;, v: Math.round(nav.responseStart) });\n      push({ k: &#039;domcontentloaded&#039;, v: Math.round(nav.domContentLoadedEventEnd) });\n      push({ k: &#039;load&#039;, v: Math.round(nav.loadEventEnd) });\n    } else if (performance.timing) {\n      const t = performance.timing;\n      push({ k: &#039;ttfb&#039;, v: t.responseStart - t.requestStart });\n    }\n  }\n\n  function push(event) {\n    const payload = {\n      ts: Date.now(),\n      url: location.pathname + location.search,\n      ua: navigator.userAgent,\n      navType: performance.getEntriesByType(&#039;navigation&#039;)[0]?.type || &#039;navigate&#039;,\n      ...event\n    };\n    queue.push(payload);\n    if (queue.length &gt;= BATCH_MAX) flush();\n  }\n\n  function flush() {\n    if (queue.length === 0) return;\n    const body = JSON.stringify(queue.splice(0, BATCH_MAX));\n    // prefer sendBeacon\n    if (navigator.sendBeacon) {\n      navigator.sendBeacon(SEND_URL, body);\n    } else {\n      fetch(SEND_URL, { method: &#039;POST&#039;, keepalive: true, headers: { &#039;Content-Type&#039;: &#039;application/json&#039; }, body }).catch(()=&gt;{});\n    }\n  }\n\n  // 定时发送\n  setInterval(flush, BATCH_INTERVAL);\n\n  // 在卸载页面时发送\n  window.addEventListener(&#039;pagehide&#039;, flush);\n\n  // init\n  installVitals();\n  captureNavigation();\n  APP.flush = flush;\n  window.__PerfSDK = APP;\n})(window);\n\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::j7t79nd957bzek6ia1mw3m::--><code>\nlet longTaskCount = 0;\nlet totalLongTaskTime = 0;\n\nif (&#039;PerformanceObserver&#039; in window) {\n  const observer = new PerformanceObserver((list) =&gt; {\n    list.getEntries().forEach(entry =&gt; {\n      // 每个 entry 表示一个长任务\n      longTaskCount++;\n      totalLongTaskTime += entry.duration;\n\n      console.log(`[LongTask] ${entry.name} 耗时 ${entry.duration.toFixed(2)}ms`);\n      console.log(&#039;来源：&#039;, item.name, &#039;类型：&#039;, item.entryType, &#039;URL：&#039;, item.containerSrc);\n    });\n  });\n\n  observer.observe({ entryTypes: [&#039;longtask&#039;] });\n}\n\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::ygz2gzqqhzjpytuepgqr6::--><code>\n组件库发布\n   │\n   ├─ 生成 CHANGELOG\n   ├─ 更新远程版本记录\n   │\n项目启动 / 构建\n   │\n   ├─ 自动检测组件版本\n   │\n   ├─ 判断安全性（PATCH / MINOR / MAJOR）\n   │\n   ├─ 控制台 / UI 提醒开发者\n   │\n   └─ 开发者选择：\n        ├─ 自动升级（安全）\n        └─ 手动升级（MAJOR）\n   │\n升级完成 → 自动记录版本 → 支持回滚\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-js\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">js</span><pre><!--::markdown-it-async::v38ixlgzfke3quo4eqjd::--><code>// 模块表（缓存）\nconst modules = {};      // 模块名 -&gt; 导出对象\nconst factories = {};    // 模块名 -&gt; 模块定义函数\nconst loading = {};      // 模块名 -&gt; 是否正在加载中\n\n// 定义模块\nfunction define(name, deps, factory) {\n  factories[name] = { deps, factory };\n}\n\ndefine(&#039;math&#039;, [], function() {\n  return {\n    add(a, b) { return a + b; }\n  };\n});\n\n\n// 加载模块\nfunction require(name) {\n  // 已加载则直接返回\n  if (modules[name]) return modules[name];\n  if (!factories[name]) throw new Error(`${name} not found`);\n\n  const { deps, factory } = factories[name];\n\n  // 加载依赖\n  const args = deps.map(require);\n\n  // 执行工厂函数\n  const moduleExports = factory.apply(null, args);\n\n  // 缓存结果\n  modules[name] = moduleExports;\n\n  return moduleExports;\n}\n\n\ndefine(&#039;main&#039;, [&#039;math&#039;], function(math) {\n  console.log(math.add(1, 2)); // 3\n});\n// 使用\nrequire(&#039;main&#039;);\n</code></pre>\n</div>",
      "<div class=\"language-scss\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">scss</span><pre><!--::markdown-it-async::5es77bpp4cczuwkt5kka7::--><code>require(&#039;main&#039;)\n   │\n   ├─▶ 检查缓存\n   │\n   ├─▶ 找到定义 (factory)\n   │\n   ├─▶ 加载依赖 [&#039;math&#039;]\n   │        │\n   │        └─▶ 递归 require(&#039;math&#039;)\n   │\n   ├─▶ 执行 factory 函数\n   │\n   └─▶ 缓存并返回 exports\n</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::1h57g4em83nk2urpnsbrvo::--><code> ┌─────────────────────────────┐\n │         大图瓦片浏览器         │\n │                             │\n │  ┌──────────────┐            │\n │  │视窗视口(Viewport)│  ← 仅渲染屏幕内的瓦片 │\n │  └──────┬──────┘            │\n │         │计算可见区域           │\n │         ▼                     │\n │  ┌────────────────────┐       │\n │  │   瓦片管理器(TileManager)│← 负责加载/缓存 |\n │  └──────┬────────────┘       │\n │         │网络请求             │\n │         ▼                     │\n │  ┌────────────────────┐       │\n │  │   瓦片缓存(TileCache) │← LRU 缓存机制 |\n │  └────────────────────┘       │\n └─────────────────────────────┘\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::skjyq9lkh4ig7jndkwsnf::--><code>async function batchRequestAllSettled(tasks, batchSize = 5) {\n  const results = []\n\n  for (let i = 0; i &lt; tasks.length; i += batchSize) {\n    const batch = tasks.slice(i, i + batchSize).map(fn =&gt; fn())\n    // 等待当前批次所有请求完成（成功或失败）\n    const batchResults = await Promise.allSettled(batch)\n    results.push(...batchResults)\n  }\n\n  return results\n}\n\n// 使用示例\nconst urls = Array.from({ length: 30 }, (_, i) =&gt; `https://api.example.com/data/${i}`)\nconst tasks = urls.map(url =&gt; () =&gt; fetch(url).then(res =&gt; res.json()))\n\nbatchRequestAllSettled(tasks, 5).then(results =&gt; {\n  results.forEach((res, idx) =&gt; {\n    if (res.status === &#039;fulfilled&#039;) console.log(`任务 ${idx} 成功`, res.value)\n    else console.log(`任务 ${idx} 失败`, res.reason)\n  })\n})\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::nvvuhsg2duco6fo8oa1hrg::--><code>每个阶段的宏任务执行完 →\n    执行所有 nextTick 回调 →\n    执行所有微任务 (Promise)\n→ 进入下一个阶段</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::87qe4iktrl41b4qta0zo0d::--><code>客户端 (Client)                             服务器 (Server)\n------------------                          ------------------\n\n   ESTABLISHED                                  ESTABLISHED\n        |                                              |\n        | ① FIN=1, seq=u                              |\n        |---------------------------------------------&gt;|\n        |                                              |\n        |                           收到 FIN, 发 ACK=1, ack=u+1\n        | ②                                            |\n        |&lt;---------------------------------------------|\n        |                                              |\n        |                           服务器继续处理剩余数据\n        |                                              |\n        |                           ③ FIN=1, seq=v    |\n        |&lt;---------------------------------------------|\n        | ④ ACK=1, ack=v+1                             |\n        |---------------------------------------------&gt;|\n        |                                              |\n   TIME_WAIT(等待2MSL)                          CLOSED\n        |\n   连接彻底关闭</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<p>举个例子：\n假设浏览器要加载三个资源：</p>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::d4iwl89njflmrfarjemu::--><code>index.html\nstyle.css\nmain.js\n</code></pre>\n</div>",
      "<p>HTTP/1.1：</p>",
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::ylvpdmtokofgkk5ffm1po::--><code>// HTTP/2\nHTTP/2\n  ↓\n  TLS\n  ↓\n  TCP\n  ↓\n  IP\n\n// HTTP/3\nHTTP/3\n  ↓\n  QUIC (内含TLS 1.3 + 可靠传输)\n  ↓\n  UDP\n  ↓\n  IP\n</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-nginx\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">nginx</span><pre><!--::markdown-it-async::vmce86ze1wqgmc1kvuvn::--><code>http {\n    # 开发环境（域名区分）\n    server {\n        listen 80;\n        server_name dev.example.com;  # 开发环境域名\n        root /path/to/frontend/dev;\n        # ... 其他配置（路由、代理等）\n    }\n\n    # 测试环境（端口区分）\n    server {\n        listen 8081;  # 测试环境端口\n        server_name localhost;\n        root /path/to/frontend/test;\n        # ... 其他配置\n    }\n\n    # 生产环境（HTTPS）\n    server {\n        listen 443 ssl;\n        server_name example.com;  # 生产环境域名\n        root /path/to/frontend/prod;\n        # ... SSL 配置和其他生产环境特有的规则\n    }\n}</code></pre>\n</div>",
      "<p>同域名不同路径映射的重写问题及解决方案</p>",
      "<p>当多个前端应用部署在同一域名的不同路径下（如 example.com/app1、example.com/app2），需要解决路径映射和资源引用的问题。</p>",
      "<div class=\"language-nginx\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">nginx</span><pre><!--::markdown-it-async::i4u7ovickx6ax89q8m6w::--><code>server {\n    listen 80;\n    server_name example.com;\n    root /var/www;  # 父目录\n\n    # 应用 A：匹配 /app1 路径\n    location /app1 {\n        # 实际文件目录为 /var/www/app1\n        alias /var/www/app1;  # 注意：这里用 alias 而非 root（关键区别）\n        index index.html;\n\n        # 解决 History 路由刷新 404\n        try_files $uri $uri/ /app1/index.html;\n    }\n\n    # 应用 B：匹配 /app2 路径\n    location /app2 {\n        alias /var/www/app2;\n        index index.html;\n        try_files $uri $uri/ /app2/index.html;\n    }\n}</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      "<div class=\"language-jsx\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">jsx</span><pre><!--::markdown-it-async::i9zou9by169v2zv5mgijcg::--><code>function App() {\n  const [count, setCount] = useState(0);\n\n  const Child = () =&gt; {\n    useEffect(() =&gt; {\n      console.log(&#039;Child mounted&#039;);\n    }, []);\n    return &lt;div&gt;child&lt;/div&gt;;\n  };\n  const Child2 = useCallback(() =&gt; {\n    useEffect(() =&gt; {\n      console.log(&quot;Child mounted&quot;);\n    }, []);\n    return &lt;div&gt;child2&lt;/div&gt;;\n  }, []);\n\n  return (\n    &lt;&gt;\n      &lt;button onClick={() =&gt; setCount(c =&gt; c + 1)}&gt;+&lt;/button&gt;\n      &lt;Child /&gt;\n      &lt;Child2 /&gt;\n    &lt;/&gt;\n  );\n}\n</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-jsx\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">jsx</span><pre><!--::markdown-it-async::611xkdclfopa0n7aw48zf::--><code>// React.memo 的简化实现逻辑\nfunction memo(Component, arePropsEqual) {\n  let lastProps = null;\n  let lastResult = null;\n  \n  return function MemoizedComponent(nextProps) {\n    // 使用默认的浅比较或自定义比较函数\n    const propsEqual = arePropsEqual \n      ? arePropsEqual(lastProps, nextProps)\n      : shallowEqual(lastProps, nextProps);\n    \n    if (propsEqual &amp;&amp; lastResult !== null) {\n      // props 未变化，返回缓存的结果\n      return lastResult;\n    }\n    \n    // props 变化了，重新渲染\n    lastProps = nextProps;\n    lastResult = Component(nextProps);\n    return lastResult;\n  };\n}</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      "<p>表现:缺少依赖导致过时闭包</p>",
      "<div class=\"language-jsx\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">jsx</span><pre><!--::markdown-it-async::mxty3q1db5cmxtyebnle1::--><code>function Timer() {\n  const [count, setCount] = useState(0);\n  \n  useEffect(() =&gt; {\n    const interval = setInterval(() =&gt; {\n      // ❌ 问题：这里的 count 始终是 0（初始值）\n      // 因为 useEffect 只在挂载时执行，闭包捕获了初始的 count\n      setCount(count + 1);\n      console.log(&#039;Count:&#039;, count); // 始终输出 0\n    }, 1000);\n    \n    return () =&gt; clearInterval(interval);\n  }, []); // ❌ 缺少 count 依赖\n  \n  return &lt;div&gt;计数: {count}&lt;/div&gt;;\n  // 组件首次渲染，count = 0\n  // useEffect 执行，创建定时器，回调函数捕获了此时的 count = 0\n  // 后续 count 更新，但 useEffect 不会重新执行（因为依赖数组为空）\n  // 定时器回调中访问的 count 始终是最初捕获的 0\n}\nfunction Chat() {\n  const [messages, setMessages] = useState([]);\n  const [input, setInput] = useState(&#039;&#039;);\n  \n  const sendMessage = useCallback(() =&gt; {\n    // ❌ 问题：这里的 messages 始终是初始的空数组\n    // 因为 useCallback 在依赖不变时返回缓存的函数\n    const newMessage = { text: input, timestamp: new Date() };\n    setMessages([...messages, newMessage]); // messages 始终是 []\n    setInput(&#039;&#039;);\n  }, [input]); // ❌ 缺少 messages 依赖\n  \n  return (\n    &lt;div&gt;\n      &lt;input value={input} onChange={(e) =&gt; setInput(e.target.value)} /&gt;\n      &lt;button onClick={sendMessage}&gt;发送&lt;/button&gt;\n    &lt;/div&gt;\n  );\n}</code></pre>\n</div>",
      "<p>缺少依赖的根本原因</p>",
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::4o82iv40yrp87ycjr1fiyq::--><code>Render 阶段（计算虚拟 DOM）\n        ↓\nDOM 更新（Commit 阶段）\n        ↓\nuseLayoutEffect（同步执行） 👈 页面还没绘制\n        ↓\n浏览器绘制（Repaint）\n        ↓\nuseEffect（异步执行） 👈 页面已经绘制</code></pre>\n</div>"
    ],
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-jsx\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">jsx</span><pre><!--::markdown-it-async::osnfch6wzt3f2f06md0id::--><code>type Fiber = {\n  type: any,             // 组件类型（函数/类/DOM标签）\n  stateNode: any,        // 对应的DOM实例或类组件实例\n  child: Fiber | null,   // 第一个子Fiber\n  sibling: Fiber | null, // 下一个兄弟Fiber\n  return: Fiber | null,  // 父Fiber\n  pendingProps: any,     // 新的props\n  memoizedState: any,    // 上一次渲染的state\n  alternate: Fiber | null, // 双缓存指针\n  flags: number,          // 标记需要执行的副作用\n  lanes: Lanes.HighPriority, // 任务优先级\n  ...\n}</code></pre>\n</div>",
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::r7bbrvlp4fq79urjke1nvk::--><code>  // 优先级从高到低\nImmediatePriority（用户输入）\nUserBlockingPriority（悬停、点击）\nNormalPriority（数据请求）\nLowPriority（分析日志）\nIdlePriority（非必要任务）</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<p>旧:</p>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::raz22ub6uweejz7137ffgl::--><code>update → render → commit\n         (整棵树一次性调和)</code></pre>\n</div>",
      "<p>新:</p>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::atdqcodm1jjr0h33m047a9::--><code>update → render(可被打断、分段) → commit(同步)</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::nwdx3yxpa24j56qa3bbip::--><code>type Hook = {\n  memoizedState: any,        // 保存副作用依赖数组\n  next: Hook | null          // 指向下一个 Hook\n}\n\ntype Effect = {\n  create: () =&gt; (() =&gt; void) | void  // 副作用函数\n  destroy: (() =&gt; void) | void       // 清理函数\n  deps: any[] | null                 // 依赖数组\n  tag: number                        // 副作用标记\n  next: Effect | null                // 形成循环链表\n}</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::pucjd50czsjv4tyay7q2e::--><code>function useState(initialState) {\n    return useReducer((state, action) =&gt; {\n        return typeof action === &#039;function&#039; ? action(state) : action;\n    }, initialState);\n}</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::7gsapctvng97blmf72aime::--><code>// Vue3 内部核心实现伪代码\nlet pending = false\nconst queue = []\n\nfunction queueFlush() {\n  if (!pending) {\n    pending = true\n    Promise.resolve().then(flushJobs) // 微任务\n  }\n}\n\nfunction flushJobs() {\n  pending = false\n  // 执行 watcher、渲染任务\n  ...\n  // 执行 nextTick 回调\n  flushPostFlushCbs()\n}\n\nexport function nextTick(cb) {\n  return cb ? Promise.resolve().then(cb) : Promise.resolve()\n}</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::bw0y4i39e6astma92g8dof::--><code>模板字符串 (template)\n       ↓\n[1] 解析（Parse） → 生成 AST\n       ↓\n[2] 转换（Transform） → 优化、静态标记、指令处理\n       ↓\n[3] 生成（Generate） → 输出可执行的 render 函数\n</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      ...
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::e3gu6dhyzz7lpc7dfrs7w::--><code>数据变化（Proxy.set）\n       ↓\n触发依赖（trigger）\n       ↓\n派发更新任务（scheduler → queueJob）\n       ↓\n进入异步任务队列（微任务）\n       ↓\n批量执行更新（flushJobs）\n       ↓\n重新渲染组件（patch → diff → DOM 更新）</code></pre>\n</div>",
  ...
  },
  {
    ...
    "answerHtml": [
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::lrs3txqd9u85bl7k3qdhrm::--><code>\n&lt;template&gt;\n  &lt;div&gt;\n    &lt;h2 v-once-directive&gt;{{ message }}&lt;/h2&gt;\n    &lt;button @click=&quot;message = &#039;更新后的消息&#039;&quot;&gt;修改 message&lt;/button&gt;\n  &lt;/div&gt;\n&lt;/template&gt;\n\n&lt;script setup&gt;\nimport { ref } from &#039;vue&#039;\n\nconst message = ref(&#039;初始内容&#039;)\n\n// 注册自定义 once 指令\nconst vOnceDirective = {\n  // 第一次挂载时（渲染一次）\n  mounted(el, binding) {\n    el._onceContent = el.innerHTML // 记录初次渲染内容\n  },\n  // 当数据变化时，会触发 updated 钩子\n  updated(el, binding) {\n    // 恢复初始内容，防止重新渲染\n    el.innerHTML = el._onceContent\n  }\n}\n&lt;/script&gt;\n\n&lt;script&gt;\nexport default {\n  directives: {\n    onceDirective: vOnceDirective\n  }\n}\n&lt;/script&gt;\n</code></pre>\n</div>",
      "<p>事件</p>",
      "<div class=\"language-\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\"></span><pre><!--::markdown-it-async::5h9s2syhhf4b854dk4r9h::--><code>\n&lt;template&gt;\n  &lt;button v-once-click=&quot;handleClick&quot;&gt;点击我一次&lt;/button&gt;\n&lt;/template&gt;\n\n&lt;script setup&gt;\nconst handleClick = () =&gt; {\n  alert(&#039;只执行一次&#039;)\n}\n\nconst vOnceClick = {\n  mounted(el, binding) {\n    const fn = (e) =&gt; {\n      binding.value(e)\n      el.removeEventListener(&#039;click&#039;, fn) // 移除监听\n    }\n    el.addEventListener(&#039;click&#039;, fn)\n  }\n}\n&lt;/script&gt;\n\n</code></pre>\n</div>",
      "<p>自定义指令有很多钩子可以选择</p>",
      "<div class=\"language-vue\"><button title=\"Copy Code\" class=\"copy\"></button><span class=\"lang\">vue</span><pre><!--::markdown-it-async::2q54ow56xp6gy6vtps7w4p::--><code>const myDirective = {\n  // 在绑定元素的 attribute 前\n  // 或事件监听器应用前调用\n  created(el, binding, vnode) {\n    // 下面会介绍各个参数的细节\n  },\n  // 在元素被插入到 DOM 前调用\n  beforeMount(el, binding, vnode) {},\n  // 在绑定元素的父组件\n  // 及他自己的所有子节点都挂载完成后调用\n  mounted(el, binding, vnode) {},\n  // 绑定元素的父组件更新前调用\n  beforeUpdate(el, binding, vnode, prevVnode) {},\n  // 在绑定元素的父组件\n  // 及他自己的所有子节点都更新后调用\n  updated(el, binding, vnode, prevVnode) {},\n  // 绑定元素的父组件卸载前调用\n  beforeUnmount(el, binding, vnode) {},\n  // 绑定元素的父组件卸载后调用\n  unmounted(el, binding, vnode) {}\n}</code></pre>\n</div>"
    ],
